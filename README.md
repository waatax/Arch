...
目前版本是 **V5.0**。產品、教學、統測覆蓋與技術的唯一總規格見 [`Arch-v5.md`](./Arch-v5.md)；[`Arch-v4.md`](./Arch-v4.md) 僅保留為歷史規格。可執行工作、驗收條件與目前缺口見 [`docs/implementation-plan.md`](./docs/implementation-plan.md)。
