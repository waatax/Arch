...
// ==========================================
export const englishS1Review: SemesterReviewData = {
  id: "english-s1",
  subjectSlug: "english",
  subjectTitle: "英語文",
  semesterCode: "s1",
...
// ==========================================
export const englishS2Review: SemesterReviewData = {
  id: "english-s2",
  subjectSlug: "english",
  subjectTitle: "英語文",
  semesterCode: "s2",
...
// ==========================================
export const englishS3Review: SemesterReviewData = {
  id: "english-s3",
  subjectSlug: "english",
  subjectTitle: "英語文",
  semesterCode: "s3",
...
// ==========================================
export const englishS4Review: SemesterReviewData = {
  id: "english-s4",
  subjectSlug: "english",
  subjectTitle: "英語文",
  semesterCode: "s4",
