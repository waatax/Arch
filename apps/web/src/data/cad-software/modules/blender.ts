...
export const blenderData: CadSoftware = {
  ...
  heroMetrics: [
    { label: '軟體授權成本', value: '$0 完全免費永久開源' },
    { label: 'OpenBIM 認證標準', value: 'IFC4 / ISO 16739 支援' },
    { label: '物理光追核心', value: 'Cycles 4.x 光譜真實感' },
    { label: '參數化幾何引擎', value: 'Geometry Nodes 節點運算' },
  ],
  architecturalApplications: [
    {
      ...
      deliverables: ['原生 IFC4 建築構件模型', 'COBie 營運維護資訊表', 'OpenBIM 結構碰撞檢核報告'],
    },
    {
      ...
      deliverables: ['參數化自適應建築立面', '立面開孔率分析數據雲圖', '工廠預鑄開模施工清冊'],
    },
    {
      ...
      deliverables: ['8K 超高畫質建築外觀競圖透視', '室內物理人工光照照度熱圖', '晝光採光係數 (DF) 視覺化圖面'],
    },
    {
      area: '歷史建築古蹟修復與數位雙生',
      ...
      deliverables: ['古蹟數位孿生模型 (LOD 400)', '榫接解構動態爆炸分解圖', '歷史建築立面正投影展開圖說'],
    },
  ],
  beginnerGuide: {
    introduction: 'Blender 4.x 已經全面現代化，只要記住左手掌握 G/R/S 三大變換鍵，右手點擊確認，搭配 Tab 鍵穿梭物體與編輯模式，即可快速進入建築三維殿堂。',
    viewportControls: [
      { action: '旋轉視角 (Orbit)', keyOrMouse: '按住滑鼠中鍵 (MMB) 拖曳', tip: '圍繞當前選取物件或場景中心旋轉' },
      { action: '平移視圖 (Pan)', keyOrMouse: 'Shift + 按住滑鼠中鍵', tip: '水平或垂直平移當前工作視窗' },
      { action: '縮放視圖 (Zoom)', keyOrMouse: '滾動滑鼠滾輪 或 Ctrl + 按住滑鼠中鍵', tip: '平滑推進或遠離模型細節' },
      { action: '正交三視圖切換', keyOrMouse: '數字小鍵盤 1(前), 3(右), 7(頂), 9(相反視角)', tip: '數字小鍵盤 5 切換正交投影與透視投影' },
    ],
    tenStepsSop: [
      { step: 1, title: '設定公制單位與比例', action: '進入 屬性 (Properties) → 場景 (Scene) → 單位 (Units)', keyPoint: 'Unit System 設為 Metric，長度設為 Millimeters，Unit Scale 設為 0.001' },
      { step: 2, title: '刪除預設立方體並歸零', action: '按 A 全選預設相機、立方體與光源，按 X 鍵確認刪除', keyPoint: '保持 Shift + C 將 3D 游標歸零至 (0,0,0) 絕對原點' },
      { step: 3, title: '建立平面並輸入尺寸', action: '按 Shift + A 選擇 Mesh → Plane，在左下角展開面板輸入尺寸', keyPoint: '輸入 X: 12000mm, Y: 8000mm 建立建築地基' },
      { step: 4, title: '進入編輯模式 (Edit Mode)', action: '選中地基網格，按鍵盤 Tab 鍵切換至編輯模式', keyPoint: '上方切換頂點 (1)、邊緣 (2)、表面 (3) 選取模式' },
      { step: 5, title: '擠出牆體高度 (Extrude)', action: '選取地基面，按 I (Inset) 向內偏移 240mm 形成外牆輪廓，選中環狀面按 E 鍵擠出', keyPoint: '按 E 後直接輸入 3600 並 Enter，牆體瞬間拔起 3.6 公尺' },
      { step: 6, title: '環切開門窗開口 (Loop Cut)', action: '按 Ctrl + R 滑鼠移至牆體，滾動滾輪新增分割線，定位門窗頂底標高', keyPoint: '按 G + G 可沿著邊線平滑滑動切割線而不變形' },
      { step: 7, title: '橋接挖洞 (Bridge Edge Loops)', action: '選中內外牆對應的兩個矩形面，按滑鼠右鍵選擇「Bridge Faces」', keyPoint: '系統自動挖空並縫合厚度面，產生乾淨門窗洞口' },
      { step: 8, title: '套用倒角修改器 (Bevel)', action: '切回物體模式，在修改器面板新增 Bevel 修改器', keyPoint: 'Amount 設為 5mm，Segments 設為 2，使建築棱角反射真實高光' },
      { step: 9, title: '配置天空陽光與相機', action: '在 World 面板 Surface 選擇 Sky Texture (Nishita 天空模型)', keyPoint: '按 Ctrl + Alt + 小鍵盤 0 將當前透視視角綁定給相機' },
      { step: 10, title: '啟動 Cycles 物理渲染', action: '在 Render 面板將 Engine 改為 Cycles，Device 改為 GPU Compute', keyPoint: '開啟 Denoise (OpenImageDenoise)，按 F12 產出第一張照片級建築效果圖' },
    ],
    shortcuts: [
      { key: 'Tab', command: '切換物體/編輯模式 (Toggle Edit Mode)', explanation: '在全體宏觀與網格微觀頂點之間切換的靈魂鍵', frequency: '必須秒按', mnemonic: 'Tab 進出編輯核心' },
      { key: 'G', command: '平移抓取 (Grab/Move)', explanation: '按 G 後接 X/Y/Z 可限定特定軸向移動，輸入數值精準定位', frequency: '必須秒按', mnemonic: 'G 移動抓取', contextModifier: '按 X/Y/Z 鎖軸，Shift+Z 鎖定水平面' },
      { key: 'R', command: '旋轉 (Rotate)', explanation: '按兩次 R 進入自由軌跡球旋轉模式', frequency: '必須秒按', mnemonic: 'R 旋轉視角', contextModifier: '連續按兩次 R 進入軌跡球旋轉' },
      { key: 'S', command: '縮放 (Scale)', explanation: '調整構件大小，按 S 鍵後輸入 0 可將頂點對齊至同一直線', frequency: '必須秒按', mnemonic: 'S 縮放大小', contextModifier: '按 S + Z + 0 頂點水平拉齊' },
      { key: 'E', command: '擠出幾何體 (Extrude Region)', explanation: '拉出新頂點、邊線或面的空間延展關鍵指令', frequency: '必須秒按', mnemonic: 'E 擠出立體' },
      { key: 'I', command: '內嵌面 (Inset Faces)', explanation: '在平面內向內收縮生成等厚度邊界（畫外牆與窗框必備）', frequency: '必須秒按', mnemonic: 'I 內嵌成厚度' },
      { key: 'Ctrl + R', command: '環狀切割 (Loop Cut and Slide)', explanation: '在柱梁與牆面上新增結構分割環線', frequency: '高頻常用', mnemonic: 'Ctrl+R 環形切開', contextModifier: '滾動滾輪增加切割段數' },
      { key: 'Shift + A', command: '新增圖元選單 (Add Object/Node)', explanation: '呼喚所有網格、曲線、燈光、相機與材質節點的起手式', frequency: '必須秒按', mnemonic: 'Shift+A 召喚萬物' },
      { key: 'Ctrl + B', command: '邊緣倒角 (Bevel)', explanation: '為建築模型銳利的邊緣增加物理真實倒角圓角', frequency: '高頻常用', mnemonic: 'Ctrl+B 倒角微反光' },
      { key: 'Alt + D', command: '關聯複製 (Linked Duplicate)', explanation: '複製構件但共享網格資料，一處修改所有實例全面連動', frequency: '高頻常用', mnemonic: 'Alt+D 實例連動複製' },
      { key: 'Ctrl + A', command: '套用變換 (Apply All Transforms)', explanation: '將目前縮放、旋轉數值凍結為 1.0，防止修改器計算扭曲', frequency: '工程利器', mnemonic: 'Ctrl+A 歸一化比例' },
      { key: 'M', command: '移至集合 (Move to Collection)', explanation: '將構件放入不同集合（等同建築標籤/圖層群組分類）', frequency: '高頻常用', mnemonic: 'M 收納進圖層集合' },
    ],
    fatalTraps: [
      {
    ...
    proTips: [
      { title: '啟用內建 Archimesh 與 Extra Objects 外掛', description: '在 Edit → Preferences → Add-ons 中搜尋並勾選「Archimesh」與「Add Mesh: Extra Objects」，即可一鍵生成具備真實參數的階梯、門、百葉窗與屋頂斜瓦。' },
      { title: 'Shift + ` (反引號) 啟用第一人稱 WASD 建築漫遊', description: '按下 Shift + ` 後，鍵盤 WASD 鍵控制前後左右走動，Q/E 控制升降，滑鼠轉向，宛如第一人稱遊戲般親歷漫遊建築室內檢視空間尺度。' },
      { title: '巧用 Nishita 物理天空模型快速模擬任何時刻日照', description: '世界材質中新增 Sky Texture 節點，選擇 Nishita 模型，直接輸入太陽仰角 (Sun Elevation)、旋轉方位角 (Sun Rotation) 與大氣塵埃量 (Dust/Air)，光影色彩極具大師級大氣層厚重感。' },
    ],
  },
  sevenIterations: [
    {
      ...
      advancedParameters: [
        { name: 'Viewport Clip Start', value: '10 mm (預設 0.1mm 會造成深度緩衝區精度下降)', purpose: '避免巨型建築場景深度 Z-fighting 破面' },
        { name: 'Viewport Clip End', value: '1,000,000 mm (1 公里)', purpose: '完整覆蓋基地全景都市紋理與山體' },
      ],
    ...
    },
    {
      ...
      advancedParameters: [
        { name: 'Crease Angle (折角門檻)', value: '135 度', purpose: '精準捕捉建築外凸稜角輪廓' },
        { name: 'Freestyle Line Thickness', value: '1.5 px (外圍主輪廓) / 0.5 px (內部材質線)', purpose: '落實建築製圖粗細線條階層' },
      ],
      practicalWalkthrough: [
    ...
    },
    {
      ...
      advancedParameters: [
        { name: 'Resample Curve Mode', value: 'Length: 1200 mm', purpose: '依照標準建築玻璃帷幕模矩均分結構柱跨距' },
        { name: 'Instance on Points - Pick Instance', value: 'True', purpose: '隨機或依權重派發不同造型之遮陽百葉單元' },
      ],
      practicalWalkthrough: [
    ...
    },
    {
      ...
      advancedParameters: [
        { name: 'Solidify Thickness', value: '12 mm (外牆鋁板標準厚度)', purpose: '精確賦予片狀曲面物理金屬厚度' },
        { name: 'Bevel Profiles', value: 'Custom Curve (自訂窗框凹線)', purpose: '實現外牆滴水線與壓條構造溝縫' },
      ],
      practicalWalkthrough: [
    ...
    },
    {
      ...
      advancedParameters: [
        { name: 'View Transform', value: 'AgX (取代傳統 Filmic)', purpose: '提供超寬動態範圍，完美重現高對比建築陽光陰影' },
        { name: 'Cycles Max Bounces - Diffuse', value: '4 次漫射反彈', purpose: '精準重現室內進深區域之二次間接反光暖調' },
        { name: 'Cycles Max Bounces - Glossy', value: '8 次鏡面反彈', purpose: '消除多層複層帷幕玻璃黑面假影' },
      ],
      practicalWalkthrough: [
    ...
    },
    {
      ...
      advancedParameters: [
        { name: 'IFC Schema Version', value: 'IFC4 Design Transfer View', purpose: '提供跨軟體幾何可編輯性' },
        { name: 'Classification Reference', value: 'Uniclass 2015 Pr / SS 體系', purpose: '國際營建工程構件標準化編碼' },
      ],
      practicalWalkthrough: [
    ...
    },
    {
      ...
      advancedParameters: [
        { name: 'Headless Thread Count', value: 'Threads: 0 (自動調用 CPU 所有執行緒)', purpose: '雲端批次腳本運算效能最大化' },
        { name: 'Gaussian Splatting Splat Budget', value: '2,000,000 splats', purpose: '在視埠流暢度與實景寫實度之間取得平衡' },
      ],
      practicalWalkthrough: [
  ...
  industryPipeline: {
    ...
    fileFormats: {
      import: ['.ifc', '.dwg', '.dxf', '.obj', '.fbx', '.ply', '.las', '.blend', '.svg', '.gltf'],
      export: ['.ifc', '.blend', '.fbx', '.obj', '.gltf', '.usd', '.ply', '.exr', '.png', '.svg'],
    },
    collaborationWith: ['Revit (經由 IFC4 交換)', 'Rhino (經由 OBJ/FBX 導入曲面)', 'QGIS (匯入地理地形資料)', 'Photoshop (EXR 多通道後期合成)'],
  },
};
