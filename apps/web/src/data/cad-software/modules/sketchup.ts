...
export const sketchupData: CadSoftware = {
  ...
  beginnerGuide: {
    ...
    tenStepsSop: [
      ...
      { step: 7, title: '製作窗戶元件', action: '繪製鋁窗框與玻璃面，全選後按 G 建立「元件 (Component)」', keyPoint: '勾選「切割開口 (Cut Opening)」與「貼附至垂直表面」' },
    ...
    shortcuts: [
      { key: '空白鍵 (Space)', command: '選取工具 (Select Tool)', explanation: '左手無名指隨時歸位的最重要的工具，結束任何命令', frequency: '必須秒按', mnemonic: '無事按空白，隨時好選取', contextModifier: 'Shift 加選 / Ctrl 減選' },
      { key: 'L', command: '線條工具 (Line)', explanation: '繪製基準線，配合鍵盤方向鍵鎖定紅綠藍軸', frequency: '必須秒按', mnemonic: 'L 接線走天下', contextModifier: '方向鍵鎖軸' },
      { key: 'R', command: '矩形工具 (Rectangle)', explanation: '繪製二維基準平面，輸入長寬', frequency: '必須秒按', mnemonic: 'R 畫基地框' },
      { key: 'P', command: '推拉工具 (Push/Pull)', explanation: '平面變立體之靈魂工具，雙擊可重複前次推拉深度', frequency: '必須秒按', mnemonic: 'P 推平起高樓', contextModifier: 'Ctrl 新增區段' },
      { key: 'M', command: '移動 / 複製 (Move/Copy)', explanation: '按一次 Ctrl 鍵切換為複製模式，輸入 *5 可等距陣列', frequency: '高頻常用', mnemonic: 'M 移動、Ctrl 複製、*N 陣列', contextModifier: 'Ctrl 切換複製' },
      { key: 'Q', command: '旋轉 / 陣列 (Rotate)', explanation: '按 Ctrl 複製旋轉，輸入角度與除號 /3 可均分角度', frequency: '高頻常用', mnemonic: 'Q 旋轉分扇區', contextModifier: 'Ctrl 旋轉複製' },
      { key: 'S', command: '比例縮放 (Scale)', explanation: '拉伸物件，按住 Shift 維持等比例，按住 Ctrl 以中心縮放', frequency: '高頻常用', mnemonic: 'S 縮放調尺寸', contextModifier: 'Shift 等比 / Ctrl 中心' },
      { key: 'F', command: '偏移工具 (Offset)', explanation: '繪製等厚度牆體、女兒牆、窗框凹槽必備', frequency: '必須秒按', mnemonic: 'F 等厚長外牆' },
      { key: 'T', command: '捲尺工具 (Tape Measure)', explanation: '拉出虛擬輔助參考線 (Guides) 與整體模型比例重新縮放', frequency: '高頻常用', mnemonic: 'T 量尺定基準' },
      { key: 'E', command: '橡皮擦 (Eraser)', explanation: '刪除線條；按住 Shift 點線可隱藏，按住 Ctrl 點線可平滑柔化', frequency: '工程利器', mnemonic: 'E 擦除、Ctrl 柔化', contextModifier: 'Ctrl 柔化邊線' },
      { key: 'B', command: '顏料桶 (Paint Bucket)', explanation: '打開材質面板指定木材、石材、混凝土與玻璃材質', frequency: '高頻常用', mnemonic: 'B 上色填質感' },
      { key: 'G', command: '建立元件 (Make Component)', explanation: '將選取物件封裝為可重複使用、一處改處處連動的組件', frequency: '必須秒按', mnemonic: 'G 成組免黏連' },
    ],
    fatalTraps: [
      {
  ...
  sevenIterations: [
    {
      ...
      advancedParameters: [
        { name: 'Length Snapping (長度鎖定)', value: '1.0 mm (關閉強制整數鎖定)', purpose: '防止微小尺度被四捨五入造成縫隙' },
        { name: 'Angle Units (角度單位)', value: '0.1 度', purpose: '斜交建築軸線精確捕捉' },
      ],
    ...
    },
    {
      ...
      advancedParameters: [
        { name: '01_STR (結構群組)', value: '顏色: 藍色 #0055FF', purpose: '柱梁承重結構隔離檢視' },
        { name: '02_WALL_EXT (外牆)', value: '顏色: 綠色 #00AA55', purpose: '立面外殼量體控制' },
        { name: '03_INTERIOR (內隔間)', value: '顏色: 橙色 #FF8800', purpose: '室內裝修平面出圖' },
      ],
      practicalWalkthrough: [
    ...
    },
    {
      ...
      advancedParameters: [
        { name: 'Line Weight (線條寬度)', value: '0.35 pt (主要剖面輪廓)', purpose: 'CNS 粗實線表現' },
        { name: 'Rendering Mode', value: 'Hybrid (混合)', purpose: '兼顧向量銳利邊線與光影陰影' },
        { name: 'Output Resolution', value: 'High (300 DPI)', purpose: 'A1 列印無鋸齒' },
      ],
      practicalWalkthrough: [
    ...
    },
    {
      ...
      advancedParameters: [
        { name: 'Field of View (視角)', value: '55 度 (人眼舒適廣角)', purpose: '防止立面嚴重拉伸變形' },
        { name: 'Sun Intensity (太陽強度)', value: '100,000 Lux (正午)', purpose: '模擬真實物理光照度' },
        { name: 'Glass IOR (玻璃折射率)', value: '1.52', purpose: '精準呈現建築玻璃反射與折射' },
      ],
      practicalWalkthrough: [
