      ...
      "worked_examples": [
        {
          ...
          "difficulty": "中等",
          "steps": [
            "**步驟 1**：進行力學受力分析（<span className='text-rose-600 font-bold'>自由體圖</span>）。電梯受向下重力 W = mg，向上鋼纜拉力 T。",
      ...
      "worked_examples": [
        {
          ...
          "difficulty": "基礎",
          "steps": [
            "**步驟 1**：依據<span className='text-indigo-600 font-bold'>能量守恆定律</span>。最高點<span className='text-rose-600 font-bold'>重力位能</span> Ep = mgh 轉換為最低點<span className='text-rose-600 font-bold'>動能</span> Ek。",
            "**步驟 2**：計算<span className='text-rose-600 font-bold'>動能</span> Ek。Ek = mgh = 50 kg × 9.8 m/s² × 10 m = 4900 焦耳 (J)。",
      ...
      "worked_examples": [
        {
          ...
          "difficulty": "中等",
          "steps": [
            "**步驟 1**：利用傅立葉<span className='text-rose-600 font-bold'>熱傳導</span>定律。傳熱功率 P = k · A · (T1 - T2) / d。",
