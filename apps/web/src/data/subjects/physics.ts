  ...
  "topics": [
      ...
      "concepts": [
        {
          ...
          "body": "物體運動狀態的改變源於外力作用。在建築結構工程中，牛頓第二定律 F = m·a 是地震工程學的基礎：當地面發生地震加速度 a 時，建築物自重質量 m 會產生相對應的水平慣性力 (Inertia Force)。台北101大樓頂層擺設的 660 公噸風阻尼器 (TMD)，即是利用慣性反向運動來吸收強風與地震造成的結構擺動能量。",
          "formula": "F = m · a\nF_inertia = - m · a_ground",
          "steps": [
            "牛頓第一定律 (慣性定律)：若物體不受外力或受合力為零，靜者恆靜，動者恆作等速度直線運動。",
            "牛頓第二定律 (運動定律)：加速度與合力成正比，與質量成反比。結構力學中地表加速度 PGA (Peak Ground Acceleration) 直接決定地震力大小。",
            "牛頓第三定律 (作用力與反作用力)：兩物體間的作用力與反作用力大小相等、方向相反且作用於同一直線上。例如建築物柱腳對基礎施加壓力，基礎反施加等大向上之支承反力。"
          ]
        },
        {
          "heading": "剛體靜力平衡條件 (Static Equilibrium of Rigid Bodies)",
          "body": "建築結構物（如樑、柱、桁架、板）於靜止狀態下必須滿足三維或二維靜力平衡。若合力或合力矩不為零，結構將發生剛體位移或旋轉倒塌。二維平面力系下，靜力平衡條件包含三個獨立代數方程式。",
          "formula": "ΣFx = 0 (水平合力為零)\nΣFy = 0 (垂直合力為零)\nΣM_O = 0 (對任意點 O 之合力矩為零)",
          "steps": [
            "繪製結構體之自由體圖 (Free Body Diagram, FBD)，明確標示所有外力、自重及支承反力。",
            "選定極點 (Pivot Point)，優先選擇未知力作用最多之節點計算矩平衡 ΣM = 0。",
            "解聯立方程求出未知支承反力 (Support Reactions)，並檢查平衡狀況。"
          ]
        },
        {
          "heading": "運動學公式與建築高空施工落體防護 (Kinematics & Fall Protection)",
          "body": "等加速度直線運動為描述物體落體與減震運動的基本數學模型。建築施工現場高空作業時，防墜網與安全帶的減震緩衝長度計算，均依據運動學與加速度限制規範，以防止作業人員承受過大衝擊 g 值。",
          "formula": "v = v₀ + a · t\ns = v₀ · t + ½ · a · t²\nv² = v₀² + 2 · a · s",
          "steps": [
        ...
        },
        {
          ...
          "body": "摩擦力為兩接觸面阻止相對滑動之阻力。建築無障礙斜坡、地下停車場車道鋪面以及樓梯踏階，必須滿足法規規定的靜摩擦係數 (μs)，以防止行人滑倒或車輛煞車失靈下滑。",
          "formula": "f_s ≤ f_s,max = μ_s · N\nf_k = μ_k · N",
          "table": {
            "headers": [
              "接觸界面材料與狀態",
              "靜摩擦係數 (μs)",
        ...
        },
        {
          ...
          "body": "建築結構受外力作用時，構件內部會產生剪力 V (Shear Force) 與彎矩 M (Bending Moment)。微分關係方程 dV/dx = -w(x) 及 dM/dx = V(x) 是繪製剪力圖與彎矩圖的力學基礎。在平面桁架中，利用節點法 (Method of Joints) 與剖面法 (Method of Sections) 可快速求解各桿件軸力 (拉力與壓力)。",
          "formula": "dV / dx = - w(x)\ndM / dx = V(x)\nΣ F_x,joint = 0, Σ F_y,joint = 0",
          "steps": [
            "第一步（求解整體支承反力）：選定整體結構作為自由體圖，運用 ΣFx=0, ΣFy=0, ΣM=0 解出各支承反力。",
            "第二步（斷面法求構件內力）：在構件任意位置 x 截開，繪製左端或右端自由體圖，寫出剪力 V(x) 與彎矩 M(x) 方程式。",
            "第三步（繪製 V-M 圖）：尋找剪力為零處 (V=0)，該處往往對應最大彎矩 M_max，為樑斷面尺寸設計的最關鍵位置。"
          ]
        },
        {
          "heading": "虎克定律與材料應力應變關係 (Hooke's Law & Stress-Strain Dynamics)",
          "body": "在彈性限度內，材料受拉伸或壓縮時，應力 σ (Stress) 與應變 ε (Strain) 成正比，比例常數為彈性模數 E (Young's Modulus)。材料受到軸向拉力時，橫向會發生收縮，橫向應變與縱向應變之比值即為波松比 ν (Poisson's Ratio)。",
        ...
        {
          "heading": "剛體轉動慣量與斷面幾何特性 (Moment of Inertia & Section Modulus)",
          "body": "樑與柱構件抗彎與抗挫屈的能力不僅取決於材料強弱，更取決於斷面幾何形狀。斷面二次矩 / 轉動慣量 I (Moment of Inertia) 描述斷面面積對於中立軸的分布狀況。斷面模數 Z = I / y_max 直接決定樑斷面彎曲應力 σ_max = M / Z。",
          "formula": "I_x = ∫ y² dA\nI_rectangle = (b · h³) / 12\nZ = I / (h / 2) = (b · h²) / 6\nσ_max = M / Z ≤ f_allowable",
          "steps": [
            "第一步（確定形心軸）：計算複雜截面（如 H 型鋼、箱型鋼）的中立軸 (Neutral Axis) 位置。",
            "第二步（平行軸定理）：若次圖形形心軸不與整體形心軸重合，採用平行軸定理 I = I_g + A · d² 疊加總轉動慣量。",
            "第三步（驗算彎曲應力）：將最大彎矩 M 代入 σ = M / Z，確保最大邊緣應力不超過材料允許抗彎應力。"
          ]
        }
      ],
      "practices": [
        {
          "difficulty": "基礎",
          "question": "一棟總質量 m = 12000 kg 的輕量鋼骨結構渡假小屋，在強烈地震中受地表加速度 a = 2.5 m/s² 的水平作用。請問該建築物基座所承受的水平基底剪力 (Base Shear Force) 為多少 kN？",
          "steps": [
            "找出物體質量 m = 12000 kg",
            "找出加速度 a = 2.5 m/s²",
        ...
        {
          "difficulty": "基礎",
          "question": "某一地下停車場坡道設計傾角為 15° (sin 15° ≈ 0.2588, cos 15° ≈ 0.9659)。一輛總重 1500 kg 的轎車停在斜坡上。若車輪與鋪面間的靜摩擦係數 μs = 0.60，重力加速度 g = 9.8 m/s²。試計算：(1) 車輪受到的平行斜面向下重力分力；(2) 斜面能提供的最大靜摩擦力 f_s,max 為多少 N？車輛是否會沿斜坡下滑？",
          "steps": [
        ...
        {
          "difficulty": "進階",
          "question": "一長度 L = 6 m 的外挑雨庇懸臂樑，受到樑端集中載重 P = 20 kN 及樑自重均佈載重 w = 5 kN/m 作用。試求解該懸臂樑固定端 A 點所承受的垂直支承反力 R_Ay 及抗彎矩反力 M_A。",
          "steps": [
            "計算均佈載重 w 之等效集中力 W_eq = w × L = 5 kN/m × 6 m = 30 kN，作用點位於樑中點離 A 點 3 m 處。",
            "根據垂直靜力平衡方程式 ΣFy = 0：R_Ay - W_eq - P = 0 => R_Ay = 30 + 20 = 50 kN。",
            "根據對 A 點之矩平衡方程式 ΣM_A = 0 (設順時針方向為正)：M_A - (W_eq × 3m) - (P × 6m) = 0。",
            "代入數值：M_A = (30 kN × 3 m) + (20 kN × 6 m) = 90 + 120 = 210 kN·m。"
          ],
          "answer": "垂直反力 R_Ay = 50 kN (向上)，固定端彎矩 M_A = 210 kN·m"
        },
        {
          "difficulty": "進階",
          "question": "一簡支樑跨度 L = 8 m，受一跨中集中載重 P = 40 kN。若樑斷面為矩形 (寬度 b = 200 mm，高度 h = 400 mm)。試求解：(1) 樑內最大彎矩 M_max；(2) 樑斷面之中立軸轉動慣量 I 及斷面模數 Z；(3) 樑內最大邊緣彎曲應力 σ_max 為多少 MPa？",
          "steps": [
            "計算簡支樑跨中集中載重之最大彎矩 M_max = (P · L) / 4 = (40 kN × 8 m) / 4 = 80 kN·m = 80 × 10⁶ N·mm。",
            "計算矩形斷面轉動慣量 I = (b · h³) / 12 = (200 × 400³) / 12 = 1.0667 × 10⁹ mm⁴。",
            "計算斷面模數 Z = (b · h²) / 6 = (200 × 400²) / 6 = 5.3333 × 10⁶ mm³。",
            "代入彎曲應力公式 σ_max = M_max / Z = (80 × 10⁶ N·mm) / (5.3333 × 10⁶ mm³) ≈ 15.0 MPa。"
          ],
          "answer": "(1) M_max = 80 kN·m；(2) Z ≈ 5.33×10⁶ mm³；(3) 最大彎曲應力 σ_max ≈ 15.0 MPa"
        },
        {
          "difficulty": "實務應用",
        ...
        {
          "difficulty": "實務應用",
          "question": "一鋼結構大樓的柱構件高度 L₀ = 4.0 m，截面積 A = 80 cm² (8000 mm²)，材料為結構鋼 (彈性模數 E = 200 GPa = 200,000 MPa)。在地震受壓時承受軸向壓力 P = 1600 kN (1.6 × 10⁶ N)。試計算：(1) 鋼柱內受到的平均壓應力 σ；(2) 鋼柱之軸向應變 ε 與彈性縮短量 ΔL 為多少 mm？",
          "steps": [
            "計算平均壓應力 σ = P / A = (1,600,000 N) / (8,000 mm²) = 200 N/mm² = 200 MPa。",
            "計算軸向應變 ε = σ / E = 200 MPa / 200,000 MPa = 0.001 (或 0.1%)。",
            "計算軸向彈性縮短量 ΔL = ε · L₀ = 0.001 × 4,000 mm = 4.0 mm。",
            "結論：在 1600 kN 壓重下，4m 高鋼柱彈性縮短 4.0 mm，應力未超過屈服強度 (325 MPa)，處於安全彈性範圍內。"
          ],
          "answer": "(1) 平均壓應力 σ = 200 MPa；(2) 應變 ε = 0.001，鋼柱縮短量 ΔL = 4.0 mm"
        }
      ],
      "practice": {
        "difficulty": "基礎",
    ...
    },
    {
      ...
      "concepts": [
        ...
        {
          "heading": "動能與重力位能 (Kinetic & Gravitational Potential Energy)",
          "body": "物體因運動而具有的能量稱為動能 (Ek = ½ m v²)；因位置高度而具有的能量稱為重力位能 (Ep = m g h)。高層建築屋頂高位水塔儲存大量位能，向下給水時位能轉換為動能與水壓（每 10 公尺水頭產生約 1 kgf/cm² 或 0.1 MPa 靜水壓）。",
          "formula": "E_k = ½ · m · v²\nE_p = m · g · h"
        },
        {
          "heading": "能量守恆定律與建築力能回收 (Law of Conservation of Energy)",
          "body": "在封閉系統中，能量既不能被創造，也不能被消滅，只能從一種形式轉換為另一種形式，總能量保持恆定。現代綠建築電梯配備再生煞車電力回饋系統 (Regenerative Braking)，將電梯下行或重載上行時減速的重力位能轉化為電能供大樓照明使用。",
          "formula": "E_total = E_k + E_p + W_loss = Constant"
        },
        {
          "heading": "熱功當量與綠建築節能 (Joule's Equivalent & Energy Conservation)",
          "body": "焦耳透過實驗證實機械功與熱能可以等量轉換，確立了熱功當量：1 cal ≒ 4.186 J。建築空調冷凍噸 (Refrigeration Ton, RT) 與千瓦 (kW) 的換算，是計算建築外殼耗能 (ENVLOAD) 與選擇高效能變頻主機的理學依據。",
          "formula": "1 cal = 4.186 J\n1 RT (美制冷凍噸) ≒ 3.517 kW ≒ 3024 kcal/h"
        },
        {
        ...
        },
        {
          ...
          "body": "在 HVAC 空調冰水與冰膽系統中，水泵與風機是主要耗能設備。水泵水功率 P_water = Q · ΔP (流量乘以壓差)。當調整馬達轉速 N 時，遵循風機水泵比例定律 (Affinity Laws)：流量與轉速成正比，揚程與轉速平方成正比，而消耗功率與轉速立方成正比 (P ∝ N³)。變頻控制 (VFD) 因此具有極高的節能效益。",
          "formula": "Q₂ / Q₁ = N₂ / N₁\nH₂ / H₁ = (N₂ / N₁)²\nP₂ / P₁ = (N₂ / N₁)³",
          "steps": [
        ...
        },
        {
          ...
          "formula": "m_counterweight = m_car + 0.45 · m_capacity\nΔF_net = (m_total_up - m_total_down) · g\nP_motor = (ΔF_net · v) / η",
          "table": {
            "headers": [
              "電梯運行狀況",
              "客廂側總重",
        ...
        {
          "heading": "冰蓄冷空調系統與潛熱儲能 (Thermal Energy Storage & Ice Storage)",
          "body": "冰蓄冷 (Ice Thermal Storage) 利用夜間離峰低價電力運轉冰水主機，將水結成冰儲存熔化潛熱 (Latent Heat of Fusion L_f ≈ 334 kJ/kg)。日間尖峰時段關閉或低速運轉冰水主機，融冰釋放冷量供建築空調使用，達成電力「移峰填谷」與降低契約容量負擔。",
          "formula": "Q_storage = m_ice · L_f + m_water · c_w · ΔT\n1 kg 冰融化可吸收 334 kJ 潛熱 (相當於將 1kg 水降溫 80°C)",
          "steps": [
      ...
      "practices": [
        {
          ...
          "steps": [
            "計算增加的重力位能 (即有效功 W_out)：W_out = m · g · h = 2000 kg × 9.8 m/s² × 30 m = 588,000 J = 588 kJ。",
        ...
        {
          "difficulty": "實務應用",
          "question": "一商業大樓採用冰蓄冷空調系統。蓄冰槽內含有 10 公噸 (10,000 kg) 的冰。日間空調尖峰時段將這些冰完全融化為 0°C 的水。(已知冰熔化潛熱 L_f = 334 kJ/kg，美制冷凍噸 1 RT ≒ 3.517 kW = 3.517 kJ/s)。試計算：(1) 10 公噸冰完全融化可釋放的總冷量為多少 MJ？ (2) 若這批冰在 5 小時內均勻融解完畢，相當於提供多少美制冷凍噸 (RT) 的冷房能力？",
          "steps": [
    ...
    },
    {
      ...
      "concepts": [
        {
          ...
          "formula": "Q_conduction / t = k · A · (T_hot - T_cold) / d\nQ_convection / t = h · A · ΔT\nQ_radiation / t = ε · σ · A · (T₁⁴ - T₂⁴)",
          "steps": [
            "熱傳導 (Conduction)：經由物質分子碰撞傳遞熱能。傳導熱流與導熱係數 k 及溫差成正比，與厚度 d 成反比。",
            "熱對流 (Convection)：經由流體（空氣或水）流動帶走熱能。分為自然對流與強制對流 (如空調送風)。",
            "熱輻射 (Radiation)：不需介質，以電磁波 (紅外線) 形式輻射能量。Low-E 低輻射玻璃可反射 90% 以上遠紅外線熱輻射。"
          ]
        },
        {
          "heading": "熱阻 R 值與熱傳透率 U 值 (Thermal Resistance & Transmittance)",
          "body": "建築外牆與屋頂由多層材料組合成。單一材料熱阻 R = d / k (厚度除以熱傳導率)。多層構造之總熱阻 ΣR 為各層熱阻與內外表面熱傳阻 (R_si, R_se) 之代數和。熱傳透率 U 值則為總熱阻之倒數 (U = 1 / ΣR)。U 值越低，代表構造之隔熱性能越佳。",
          "formula": "R = d / k\nΣR = R_se + Σ(d_i / k_i) + R_si\nU = 1 / ΣR\nQ = U · A · ΔT"
        },
        {
          "heading": "顯熱、潛熱與建築空調負荷 (Sensible Heat, Latent Heat & HVAC Load)",
          "body": "顯熱 (Sensible Heat) 會引致物質溫度改變而不改變其相態 (Q = m c ΔT)；潛熱 (Latent Heat) 則在物質發生相變（如水蒸發為水蒸氣或冰熔化）時吸收或釋放熱量，溫度保持不變 (Q = m L)。台灣夏季氣候高溫高濕，建築空調總熱負荷中包含龐大的潛熱除濕負荷。",
          "formula": "Q_sensible = m · c · ΔT\nQ_latent = m · L_v"
        },
        {
        ...
        },
        {
          ...
          "body": "建築工程常見之熱傳導率 k、熱阻 R、熱傳透率 U 及空調能力單位。",
          "table": {
            "headers": [
              "熱物理參數",
              "國際標準單位 (SI)",
            ...
            "rows": [
              ...
              [
                ...
                "kJ/kg",
                "kcal/kg",
                "水之蒸發潛熱 ≒ 2260 kJ/kg (540 kcal/kg)"
              ]
            ]
          }
        },
        {
          "heading": "濕空氣性質與焓濕圖分析 (Psychrometrics & Air Conditioning)",
          "body": "建築空調工程的核心在於濕空氣的狀態調節。空氣由乾空氣與水蒸氣組成。乾球溫度 (DBT)、濕球溫度 (WBT)、露點溫度 (DPT)、相對濕度 (RH%) 及含濕量 (Absolute Humidity x) 在焓濕圖 (Psychrometric Chart) 上唯一確定空氣狀態。當空氣降溫至露點以下時，水蒸氣凝結成水滴，此即空調除濕原理。",
          "formula": "RH% = (P_v / P_vsat) × 100%\nh = 1.006 · t + x · (2501 + 1.86 · t) (kJ/kg)",
          "steps": [
            "第一步（狀態定位）：根據乾球溫度與相對濕度在焓濕圖查出空氣比焓 h (kJ/kg) 與含濕量 x (g/kg)。",
            "第二步（冷卻除濕過程）：空氣流經冰水盤管，乾球溫度降低，達露點後沿飽和線 (100% RH) 下降析出冷凝水。",
            "第三步（送風焓差計算）：冷房負荷 Q_total = m_air · (h_room - h_supply)。"
          ]
        },
        {
          "heading": "冷凍循環與冰水主機性能指標 COP / EER / kW/RT",
          "body": "蒸汽壓縮式冷凍循環包含壓縮機、凝結器、膨脹閥與蒸發器四大元件。冰水主機性能指標包括：性能係數 (COP = Q_cool / W_elect)、能源效率比 (EER, BTU/h·W) 以及耗電率 (kW/RT)。卡諾逆循環決定了理論最高 COP = T_L / (T_H - T_L)。",
          "formula": "COP = Q_cooling (kW) / W_power (kW)\nkW / RT = 3.517 / COP\nEER (W/W) = COP = 3.412 · EER (BTU/h·W)",
          "table": {
            "headers": [
              "冰水主機類型",
              "冷卻方式",
        ...
        {
          "heading": "自然通風熱壓 (煙囪效應) 計算 (Stack Effect & Thermal Buoyancy)",
          "body": "高層建築管道間、中庭 (Atrium) 與採光井中，室內外溫差會導致空氣密度差異。熱空氣密度低而上升，由頂部排氣窗逸出，底部引進室外涼爽空氣，此現象稱為熱壓通風或煙囪效應 (Stack Effect)。",
          "formula": "ΔP_stack = ρ₀ · g · h · (1/T_out - 1/T_in) · T₀\nQ_stack = C_d · A · √( 2 · g · h · ΔT / T_in )",
          "steps": [
      ...
      "practices": [
        {
          "difficulty": "基礎",
          "question": "某建築外牆構造由外至內依次為：15 cm 厚鋼筋混凝土牆 (k1 = 1.5 W/m·K)、5 cm 厚保麗龍隔熱板 (k2 = 0.035 W/m·K) 以及 1.5 cm 厚石膏板 (k3 = 0.15 W/m·K)。設室內表面熱傳阻 R_si = 0.11 m²·K/W，室外表面熱傳阻 R_se = 0.04 m²·K/W。(1) 求該外牆構造之總熱阻 ΣR；(2) 求該外牆之熱傳透率 U 值。",
          "steps": [
            "計算各材料層熱阻 R = d / k：",
            "- 鋼筋混凝土層 R1 = 0.15 m / 1.5 = 0.10 m²·K/W",
            "- 保麗龍隔熱層 R2 = 0.05 m / 0.035 ≒ 1.429 m²·K/W",
            "- 石膏板層 R3 = 0.015 m / 0.15 = 0.10 m²·K/W",
            "計算總熱阻 ΣR = R_se + R1 + R2 + R3 + R_si = 0.04 + 0.10 + 1.429 + 0.10 + 0.11 = 1.779 m²·K/W。",
            "計算熱傳透率 U 值：U = 1 / ΣR = 1 / 1.779 ≒ 0.562 W/(m²·K)。"
          ],
          "answer": "總熱阻 ΣR ≒ 1.779 m²·K/W，熱傳透率 U ≒ 0.562 W/(m²·K)"
        },
        {
          "difficulty": "基礎",
          "question": "一間面積 40 m²、高 3 m 的會議室 (體積 120 m³)，室內空氣密度 ρ = 1.2 kg/m³，空氣比熱 c = 1.005 kJ/(kg·K)。若空調系統欲在 15 分鐘內將室內空氣溫度由 32°C 降低至 22°C (降溫 ΔT = 10 K)。(1) 降溫過程需吸收之顯熱量 Q_sensible 為多少 kJ？(2) 空調冷房顯熱功率為多少 kW？",
          "steps": [
            "計算室內空氣總質量 m = ρ × V = 1.2 kg/m³ × 120 m³ = 144 kg。",
            "計算所需顯熱 Q_sensible = m · c · ΔT = 144 kg × 1.005 kJ/(kg·K) × 10 K = 1447.2 kJ。",
            "計算冷房顯熱功率 P = Q / t：時間 t = 15 分鐘 = 900 秒。",
            "P = 1447.2 kJ / 900 s ≈ 1.608 kW。"
          ],
          "answer": "(1) 顯熱量 Q = 1447.2 kJ；(2) 顯熱冷房功率 P ≈ 1.608 kW"
        },
        {
          "difficulty": "進階",
        ...
        {
          "difficulty": "進階",
          "question": "一間 100 m³ 之空間，空氣密度 ρ = 1.2 kg/m³，空氣比熱 c = 1.005 kJ/(kg·K)。若新風換氣引入 20°C 溫差之熱空氣。(1) 將室內空氣降溫 10°C 所需吸收之顯熱量 Q_sensible 為多少 kJ？(2) 若同時需將 2 kg 蒸發水蒸氣冷凝除濕（水凝結潛熱 L_v = 2450 kJ/kg），則潛熱量 Q_latent 與總熱負荷 Q_total 為多少 kJ？",
          "steps": [
            "計算空氣質量 m = ρ × V = 1.2 kg/m³ × 100 m³ = 120 kg。",
            "計算顯熱 Q_sensible = m · c · ΔT = 120 kg × 1.005 kJ/(kg·K) × 10 K = 120.6 kJ。",
            "計算潛熱 Q_latent = m_water · L_v = 2 kg × 2450 kJ/kg = 4900 kJ。",
            "計算總熱負荷 Q_total = Q_sensible + Q_latent = 120.6 + 4900 = 5020.6 kJ。"
          ],
          "answer": "顯熱 Q_sensible = 120.6 kJ，潛熱 Q_latent = 4900 kJ，總熱負荷 Q_total = 5020.6 kJ"
        },
        {
          "difficulty": "實務應用",
          "question": "一商辦大樓選用一台額定冷凍能力 Q_cool = 100 RT (相當於 351.7 kW) 的水冷磁懸浮離心式冰水主機。已知該主機之 COP 性能係數為 6.50。(1) 該冰水主機全負載運轉時的輸入電功率 W_elect 為多少 kW？(2) 計算該主機的耗電率指標 (kW/RT) 為多少？",
          "steps": [
            "已知冷房能力 Q_cool = 351.7 kW，COP = 6.50。",
            "利用 COP 定義公式 COP = Q_cool / W_elect 求解輸入電功率 W_elect：",
            "W_elect = Q_cool / COP = 351.7 kW / 6.50 ≈ 54.11 kW。",
            "計算耗電率 kW/RT = W_elect / 冷動噸數 = 54.11 kW / 100 RT = 0.5411 kW/RT。",
            "或利用換算公式 kW/RT = 3.517 / COP = 3.517 / 6.50 ≈ 0.5411 kW/RT。"
          ],
          "answer": "(1) 輸入電功率 W_elect ≈ 54.11 kW；(2) 耗電率 ≈ 0.541 kW/RT (屬超一級節能主機)"
        },
        {
          "difficulty": "實務應用",
          "question": "一挑高 12 公尺的綠建築中庭 (Atrium)，頂部排氣窗與底部進風口高度差 h = 10 m。夏季室內平均氣溫 T_in = 28°C (301.15 K)，室外氣溫 T_out = 34°C (307.15 K)。若中庭開窗有效面積 A = 4 m²，流量係數 Cd = 0.65，重力加速度 g = 9.8 m/s²。試利用煙囪效應公式計算此中庭自然熱壓通風量 Q (m³/s) 為多少？",
          "steps": [
            "計算溫差 ΔT = T_out - T_in = 34 - 28 = 6 K。",
            "代入煙囪效應熱壓通風量公式 Q = Cd · A · √( (2 · g · h · ΔT) / T_in )：",
    ...
    },
    {
      ...
      "concepts": [
        {
          ...
          "formula": "v = 331 + 0.6 · t (m/s)\nv = f · λ"
        },
        {
          "heading": "聲強級與分貝 dB(A) 算術疊加 (Sound Level & Decibel Addition)",
          "body": "人耳對聲音強弱的感知呈對數關係。聲強級 L_p 以分貝 (dB) 標記。當多個獨立聲源同時發聲時，分貝數不能直接代數相加，必須將分貝轉換回能量強度相加後再求對數。兩個相同分貝的獨立聲源疊加，總聲壓級僅增加 3 dB。",
          "formula": "L_p = 10 · log₁₀(I / I₀) = 20 · log₁₀(P / P₀)\nL_total = 10 · log₁₀( Σ 10^(L_i / 10) )",
          "steps": [
        ...
        {
          "heading": "空間吸音與賽賓殘響時間公式 (Sabine's Reverberation Time RT60)",
          "body": "殘響時間 (RT60) 指聲源停止發聲後，室內聲能密度衰減 60 dB (至原能量之百萬分之一) 所需的時間。賽賓公式 (Sabine Formula) 為音樂廳、演講廳與教堂聲學設計的核心工具。殘響時間過長會降低言語清晰度，過短則使音樂顯得乾澀無生氣。",
          "formula": "RT₆₀ = 0.161 · V / A_total\nA_total = Σ (S_i · α_i)",
          "steps": [
            "V 為房間總體積 (m³)。",
        ...
        {
          "heading": "建築隔音與聲音透射損失 TL / STC rating",
          "body": "建築隔音主要阻止聲音穿透牆體或樓板。透射損失 (Transmission Loss, TL) 代表牆體減弱聲能的分貝數。單層牆體的隔音量遵循「質量定律」(Mass Law)：面密度 m (kg/m²) 或聲波頻率 f 增加一倍，隔音量約增加 6 dB。雙層分開構架隔音牆可突破質量定律限制。",
          "formula": "TL = 10 · log₁₀(1 / τ) (dB)\nTL_MassLaw ≒ 20 · log₁₀(m · f) - 48 (dB)"
        },
        {
          "heading": "聲學物理量與建築材料吸音/隔音參數對照表 (Acoustics Parameters)",
          "body": "建築常見聲學量度單位、吸音係數 α 與 STC 隔音等級對照。",
          "table": {
            "headers": [
              "聲學指標",
              "單位 / 符號",
        ...
        },
        {
          ...
          "body": "樓板衝擊音源於腳步聲、物品墜落等直接撞擊結構引致的固體傳播聲 (Structure-borne Noise)。台灣建築法規規定分戶樓板連同鋪面衝擊音降低量需達 17 dB 以上 (或 L'n,w ≤ 58 dB)。浮動地板 (Floating Floor) 透過在結構樓板與水泥砂漿壓造型層之間鋪設高彈性防音墊 (如 EVA、橡膠防音墊)，阻斷振動能量傳遞。",
          "formula": "ΔL_w = L'n,w,bare - L'n,w,floating ≥ 17 dB",
          "steps": [
        ...
        },
        {
          ...
          "formula": "L_p(r₂) = L_p(r₁) - 20 · log₁₀(r₂ / r₁) (點聲源)\nL_p(r₂) = L_p(r₁) - 10 · log₁₀(r₂ / r₁) (無限長線聲源)",
          "table": {
            "headers": [
              "聲源幾何類型",
              "波前幾何形狀",
        ...
        },
        {
          ...
          "formula": "f_mode = (v / 2) · √[ (n_x / L)² + (n_y / W)² + (n_z / H)² ]",
          "steps": [
      ...
      "practices": [
        {
          "difficulty": "基礎",
          "question": "某道路邊施工現場有一台打樁機產生 85 dBA 噪音，同時旁邊有一台挖掘機產生 85 dBA 噪音。(1) 若兩台機器同時全速運作，臨街建築物接領處測得之總聲壓級為多少 dBA？(2) 若在 15°C 的空氣中（聲速 340 m/s），打樁機發出頻率 85 Hz 的低頻振動聲，其聲波波長 λ 為多少公尺？",
          "steps": [
            "兩相同分貝聲源相加公式：L_total = L + 10 log₁₀(2) = 85 + 3.01 = 88.01 dBA ≒ 88 dBA。",
            "代入波速公式 v = f · λ 求解波長：λ = v / f = 340 m/s / 85 Hz = 4.0 m。"
          ],
          "answer": "總聲壓級約 88 dBA，低頻聲波波長 λ = 4.0 m"
        },
        {
          "difficulty": "基礎",
          "question": "某一厚度的單層防音玻璃牆對 500 Hz 聲波之聲波透射係數 τ = 0.001 (即只有 0.1% 的聲能穿透)。(1) 求解該玻璃牆對 500 Hz 聲波之透射損失 TL (dB)；(2) 若頻率增加一倍至 1000 Hz，依據質量定律，其透射損失 TL 理論上會增加多少 dB？",
          "steps": [
            "代入透射損失公式 TL = 10 · log₁₀(1 / τ)：",
            "TL = 10 × log₁₀(1 / 0.001) = 10 × log₁₀(1000) = 10 × 3 = 30 dB。",
            "依據質量定律，當頻率 f 增加一倍時，隔音量 TL 增加 20 · log₁₀(2) ≈ 6.02 dB ≈ 6 dB。"
          ],
          "answer": "(1) 透射損失 TL = 30 dB；(2) 頻率加倍後 TL 增加約 6 dB (達到 36 dB)"
        },
        {
          "difficulty": "進階",
          "question": "一中學演講廳長 20 m、寬 10 m、高 5 m (體積 V = 1000 m³)。經量測室內總吸音面積 A_total = 200 m²-Sabine。(1) 該演講廳目前的殘響時間 RT60 為多少秒？(2) 若理想演講廳之 RT60 應為 0.8 秒，則需額外增加多少 m²-Sabine 的總吸音量？",
          "steps": [
            "利用賽賓公式 RT60 = 0.161 · V / A_total 計算當前殘響時間：",
        ...
        {
          "difficulty": "進階",
          "question": "離一條繁忙高架橋公路（視為無限長線聲源）距離 r₁ = 10 公尺處的住宅大樓低樓層，測得車流交通噪音聲壓級 L_p1 = 75 dBA。(1) 若新建大樓退縮至距離高架橋 r₂ = 40 公尺處，其高樓層測得的噪音聲壓級 L_p2 為多少 dBA？(2) 若該高架橋附近有一台單一大型冷卻水塔（點聲源），在 10 公尺處亦為 75 dBA，則退縮至 40 公尺處時，水塔噪音降為多少 dBA？",
          "steps": [
        ...
        {
          "difficulty": "實務應用",
          "question": "一輕質隔間牆之聲波透射係數 τ = 0.0001（即僅有萬分之一的聲能穿透牆體）。(1) 求該隔間牆之聲透射損失 TL 值為多少 dB？(2) 若相鄰會議室發出 85 dB 之談話聲，穿透該牆體後進入安靜辦公室之聲壓級為多少 dB？",
          "steps": [
            "代入透射損失公式 TL = 10 · log₁₀(1 / τ)：",
            "TL = 10 × log₁₀(1 / 0.0001) = 10 × log₁₀(10000) = 10 × 4 = 40 dB。",
            "穿透後之聲壓級 L_passed = L_source - TL = 85 dB - 40 dB = 45 dB。"
          ],
          "answer": "透射損失 TL = 40 dB，穿透後聲壓級為 45 dB"
        },
        {
          "difficulty": "實務應用",
    ...
    },
    {
      ...
      "concepts": [
        ...
        },
        {
          ...
          "body": "採光係數 (DF) 指全陰天條件下，室內某一點的照度 E_in 與室外無遮蔽水平面總全天空照度 E_out 之百分比。台灣綠建築標章規定的居室採光標準，要求主要居住空間採光係數 DF ≥ 2%。Low-E 複層玻璃能在維持高可見光透射率 (VLT > 60%) 的同時，阻絕太陽熱輻射 (SHGC < 0.4)。",
          "formula": "DF = (E_in / E_out) × 100%"
        },
        {
        ...
        },
        {
          ...
          "formula": "UGR = 8 · log₁₀ [ (0.25 / L_b) · Σ (L² · Ω / p²) ]",
          "steps": [
        ...
        },
        {
          ...
          "formula": "LPD = P_total_lighting (W) / A_floor (m²) ≤ LPD_baseline (如 9.0 W/m²)"
        }
      ],
      "practices": [
        {
    ...
    },
    {
      ...
      "concepts": [
        ...
        },
        {
          ...
          "formula": "S = V · I (單相視在功率, VA)\nP = V · I · cos(φ) (單相實功率, W)\nP_3phase = √3 · V_line · I_line · cos(φ) (三相實功率, W)"
        },
        {
          ...
          "formula": "I_trip ≥ 1.25 · I_continuous (NFB 額定容量選擇原則)"
        },
        {
        ...
        },
        {
          ...
          "formula": "V_line = √3 · V_phase\nP_total_3phase = √3 · V_line · I_line · cos(φ)",
          "steps": [
        ...
        },
        {
          ...
          "formula": "S_generator (kVA) = (Σ P_load / η) / cos(φ) · K_safety (K_safety ≒ 1.25)",
          "table": {
            "headers": [
              "電力設備種類",
              "切換響應時間",
