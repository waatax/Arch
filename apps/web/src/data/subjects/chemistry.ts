  ...
  "topics": [
    {
      ...
      "concepts": [
        {
          ...
          "steps": [
            "第一步（成分確定）：判斷物質是否有單一固定化學式 (如 CaCO₃ 為純物質化合物)。",
            "第二步（相態分析）：混凝土由水泥石、砂石與水相混合，屬非均相懸浮膠體混合物。"
          ]
        },
        {
        ...
        {
          "heading": "奈米二氧化鈦 (TiO₂) 光觸媒催化空氣淨化與自潔化學",
          "body": "奈米級銳鈦礦型二氧化鈦 (TiO₂) 在波長 < 387 nm 的近紫外光照射下，電子由價帶躍遷至導帶形成電子-電洞對 (e⁻/h⁺)。電洞水解生成具有強氧化性的羥基自由基 (·OH)，能將空氣中的甲醛 (HCHO) 與苯系物降解為二氧化碳與水，同能賦予塗膜超親水性 (Super-hydrophilicity) 達成雨水自潔效應。",
          "formula": "TiO₂ + hν (UV) → e⁻ + h⁺\nh⁺ + H₂O → ·OH + H⁺\nHCHO + 4 ·OH → CO₂ + 3 H₂O",
          "steps": [
            "第一步（光子吸收）：紫外光光子激發奈米 TiO₂ 電子躍遷。",
            "第二步（自由基生成）：電洞氧化吸附的水分子產生超強氧化劑 ·OH 自由基。",
            "第三步（污染物礦化）：·OH 自由基無差別氧化有機 VOCs，最終產物為無毒的 CO₂ 與 H₂O。"
          ]
        },
        {
          "heading": "氣體擴散與室內 TVOC 濃度隨時間衰減一階動力學模型",
          "body": "建築塗料施工後，室內 TVOC 氣體濃度遵循一階衰減動力學 (First-Order Decay Kinetics)。濃度衰減速率取決於塗料化學成分揮發常數 k 與建築通風換氣率 (ACH, Air Changes per Hour)。",
      ...
      "practices": [
        ...
        {
          "difficulty": "基礎",
          "question": "某建材所含鋼筋組件化學元素分析顯示：鐵原子核內含有 26 個質子與 30 個中子。(1) 該鐵原子的原子序 Z 與質量數 A 分別為何？ (2) 鐵金屬原子之間主要依靠何種化學鍵結合，因而具備優良延展性？",
          "steps": [
            "原子序 Z 等於質子數，故 Z = 26 (代表第 26 號元素 鐵 Fe)。",
            "質量數 A = 質子數 Z + 中子數 N = 26 + 30 = 56。",
            "鐵金屬內部金屬原子釋放出價電子形成自由電子海 (Sea of Electrons)，與金屬陽離子間形成「金屬鍵 (Metallic Bond)」，賦予鋼材高強度與延展性。"
          ],
          "answer": "(1) 原子序 Z = 26，質量數 A = 56；(2) 主要依靠「金屬鍵」結合"
        },
        {
          "difficulty": "進階",
        ...
        {
          "difficulty": "進階",
          "question": "一面積 30 m² 的牆面塗佈奈米光觸媒 TiO₂ 塗層。若光觸媒受紫外光照射後，每小時可催化分解 0.005 mol 的游離甲醛 (HCHO，莫耳質量 30 g/mol)。完全反應化學式為：HCHO + O₂ → CO₂ + H₂O。(1) 運轉 10 小時可分解多少公克甲醛？ (2) 反應將生成多少 L 的 CO₂ 氣體 (25°C, 1 atm 下每莫耳 24.5 L)？",
          "steps": [
            "計算 10 小時內分解的甲醛總莫耳數：n = 0.005 mol/h × 10 h = 0.05 mol。",
            "計算分解甲醛質量 m = 0.05 mol × 30 g/mol = 1.50 克。",
            "根據反應式係數比 1:1，1 mol HCHO 生成 1 mol CO₂，故生成 CO₂ 莫耳數 n(CO₂) = 0.05 mol。",
        ...
        {
          "difficulty": "實務應用",
          "question": "一間 100 m³ 之剛裝修辦公室，剛刷完漆時測得 TVOC 初始濃度 C₀ = 8.0 mg/m³。若開啟機械通風換氣系統，使換氣率 ACH = 1.5 h⁻¹ (即每小時換氣 1.5 次)。假設塗料氣體揮發常數 k = 0.05 h⁻¹。利用一階衰減公式 C(t) = C₀ · e^(-(k+ACH)t)，求：(1) 通風運轉 2 小時後，室內 TVOC 濃度降低為多少 mg/m³？ (2) 室內 TVOC 濃度若要降至綠建築健康標準 0.6 mg/m³ 以下，需持續通風約幾小時？(ln(0.075) ≈ -2.59)",
          "steps": [
    ...
    },
    {
      ...
      "concepts": [
        ...
        {
          "heading": "石膏 (CaSO₄·2H₂O) 調節凝結化學與鈣礬石 (Ettringite) 形成",
          "body": "未添加石膏的水泥在加水時，C₃A 會在幾分鐘內迅速水化並結晶，導致混凝土發生「快凝 (Flash Set)」無法施工。研磨水泥時摻入約 3%~5% 石膏，石膏中的硫酸根 SO₄²⁻ 與 C₃A 及水反應在顆粒表面覆蓋一層緻密的鈣礬石 (Ettringite, 3CaO·Al₂O₃·3CaSO₄·32H₂O) 薄膜，可延緩 C₃A 水化達到適當的施工工作時間 (1~2 小時)。",
          "formula": "C₃A + 3 (CaSO₄·2H₂O) + 26 H₂O → C₃A·3CaSO₄·32H₂O (Ettringite 鈣礬石)"
        },
        {
          "heading": "巨體積混凝土絕熱溫升 ΔT_adiab 化學計算與溫差裂縫預防",
          "body": "每克普通卜特蘭水泥完全水化放熱約 350~500 J。混凝土比熱 c ≈ 1.0 kJ/(kg·K)。在大體積混凝土中，內部累積的水化放熱幾乎無法散逸，絕熱溫升 ΔT 升幅可達 30°C~50°C。若內部與表面溫差 ΔT > 20°C，熱應力將超過混凝土拉伸強度，導致裂縫 (Thermal Cracking)。",
      ...
      "practices": [
        ...
        },
        {
          ...
          "steps": [
            "計算 CaCO₃ 莫耳數：質量 m = 100 kg = 100,000 g。n = 100,000 g / 100 g/mol = 1000 mol。",
        ...
        {
          "difficulty": "進階",
          "question": "混凝土中加入飛灰 (Fly Ash) 進行二次波左蘭反應：Ca(OH)₂ (74.1 g/mol) + SiO₂ (60.1 g/mol) + H₂O → C-S-H 膠體。若水泥水化產生了 37.05 kg 的氫氧化鈣 Ca(OH)₂，理論上需多少 kg 的活性二氧化矽 SiO₂ 才能將其完全反應轉化為 C-S-H 膠體？",
          "steps": [
            "計算 Ca(OH)₂ 莫耳數：n = 37,050 g / 74.1 g/mol = 500 mol。",
            "波左蘭反應中，Ca(OH)₂ 與活性 SiO₂ 莫耳消耗比為 1 : 1。",
            "需要活性 SiO₂ 莫耳數 n(SiO₂) = 500 mol。",
        ...
        {
          "difficulty": "實務應用",
          "question": "一高樓筏基厚 2.0 公尺的巨體積混凝土澆置工程，每立方米混凝土含有 350 kg 的水泥。假設水泥累計水化放熱量 Q = 360 J/g (360 kJ/kg)，混凝土比熱 c = 1.0 kJ/(kg·K)，混凝土密度 ρ = 2400 kg/m³。若在絕熱狀態下，(1) 每立方米混凝土水化累積釋放總熱量為多少 kJ？ (2) 該巨體積混凝土內部的絕熱溫升 ΔT 為多少 °C (K)？",
          "steps": [
          ...
          "answer": "(1) 釋放總熱量 = 126,000 kJ/m³；(2) 絕熱溫升 ΔT = 52.5 °C"
        },
        {
          "difficulty": "實務應用",
    ...
    },
    {
      ...
      "concepts": [
        ...
        {
          "heading": "地下水硫酸鹽侵蝕 (Sulfate Attack) 與結晶膨脹破壞",
          "body": "土壤與地下水中的硫酸鹽離子 (SO₄²⁻) 滲入混凝土內部，與水泥水化產生的 Ca(OH)₂ 及水化鋁酸鈣 (C-S-A) 反應，生成遲延型鈣礬石 (Delayed Ettringite) 或石膏 (Gypsum)。結晶生成過程伴隨 2~3 倍的固體體積膨脹，引發混凝土內部產生巨大張應力，導致混凝土開裂崩解。",
        ...
        },
        {
          ...
          "body": "二氧化碳在混凝土孔隙中的擴散過程符合費克第一定律 (Fick's First Law)。中性化碳化深度 x 與大氣暴露時間 t 的平方根成正比 (x = k · √t)。碳化速率係數 k 受水灰比 (W/C)、環境相對濕度 (RH 50%~70% 時碳化最快) 及保護層緻密性控制。",
          "formula": "x = k · √t\nk = f(W/C, RH%, [CO₂])",
          "steps": [
            "第一步（酚酞指示劑測試）：於新鮮混凝土切面噴灑 1% 酚酞試液，未碳化強鹼區呈紫色，已碳化中性化區不變色 (無色)。",
      ...
      "practices": [
        ...
        {
          "difficulty": "基礎",
          "question": "將 0.1 M 的鹽酸 (HCl) 水溶液 100 mL 與 0.1 M 的氫氧化鈉 (NaOH) 水溶液 50 mL 混合。(1) 混合後剩餘的 H⁺ 莫耳數為多少 mol？ (2) 混合溶液總體積為 150 mL 時，溶液的 pH 值大約為何？(已知 log 3 ≈ 0.48)",
          "steps": [
            "計算初始 H⁺ 莫耳數 n(H⁺) = 0.1 M × 0.1 L = 0.01 mol。",
            "計算初始 OH⁻ 莫耳數 n(OH⁻) = 0.1 M × 0.05 L = 0.005 mol。",
            "發生酸鹼中和反應 H⁺ + OH⁻ → H₂O，剩餘 H⁺ 莫耳數 = 0.01 - 0.005 = 0.005 mol。",
        ...
        {
          "difficulty": "進階",
          "question": "古蹟建築大理石雕刻外牆 (主要成分 CaCO₃ 100 g/mol) 長年受酸雨 (含 H₂SO₄ 98 g/mol) 侵蝕，發生化學反應：CaCO₃ + H₂SO₄ → CaSO₄ + CO₂↑ + H₂O。若某一地區每年降下酸雨帶給該外牆 9.8 kg 的純 H₂SO₄。(1) 每年因酸雨侵蝕損耗的大理石 CaCO₃ 質量為多少 kg？ (2) 每年反應釋放出的 CO₂ 氣體在 25°C, 1 atm 下為多少 L (莫耳體積 24.5 L/mol)？",
          "steps": [
            "計算 H₂SO₄ 的莫耳數：n(H₂SO₄) = 9,800 g / 98 g/mol = 100 mol。",
        ...
        {
          "difficulty": "實務應用",
          "question": "某一沿海建築梁構件保護層厚度 x_cover = 35 mm (3.5 cm)。實測經過 9 年的大氣暴露後，酚酞測試顯示碳化深度已達到 x₁ = 15 mm (1.5 cm)。假設碳化遵從平方根公式 x = k · √t。(1) 求解該混凝土之碳化速率係數 k (mm/年^0.5)；(2) 預估再過多少年，中性化碳化界面會接觸到鋼筋表面 (即 x = 35 mm)？",
          "steps": [
        ...
        {
          "difficulty": "實務應用",
          "question": "某一化工廠廢水池混凝土牆受到 0.05 M 的硫酸 (H₂SO₄) 廢水侵蝕。已知硫酸解離出 H⁺ 離子與 SO₄²⁻ 離子。(1) 試計算該 0.05 M H₂SO₄ 水溶液的 pH 值 (假設完全解離)；(2) 分析其對混凝土結構雙重化學破壞機制。",
          "steps": [
    ...
    },
    {
      ...
      "concepts": [
        ...
        {
          "heading": "異種金屬電位差腐蝕 (Galvanic Corrosion) 與工程隔離對策",
          "body": "當兩種標準電位差異較大的金屬（如鋁與碳鋼、銅與鐵）在電解質（如雨水、潮濕空氣）存在下直接接觸時，電位較負的活潑金屬將成為陽極並發生急劇加速腐蝕，此現象稱為電位差腐蝕 (Galvanic Corrosion)。",
        ...
        {
          "heading": "鋼構熱浸鍍鋅 (Hot-Dip Galvanizing) 雙重化學保護機制",
          "body": "熱浸鍍鋅是將鋼構件浸入 450°C 熔融鋅液中。鋅與鐵表面發生擴散反應生成多層鋅鐵合金層 (Gamma, Delta, Zeta 相) 及純鋅外層 (Eta 相)。",
          "table": {
            "headers": [
              "鍍鋅保護層階段",
              "保護化學機制",
      ...
      "practices": [
        ...
        {
          "difficulty": "進階",
          "question": "一地下鋼管採用鎂塊 (Magnesium Anode，原子量 24.31 g/mol) 作為犧牲陽極。鎂在電化學保護過程中發生氧化解離：Mg → Mg²⁺ + 2e⁻。若保護系統維持 0.50 A 的保護電流持續運行 1 年 (365 天 = 31,536,000 秒)。(已知法拉第常數 F = 96,500 C/mol)。求：(1) 1 年內鎂陽極流過總電量 Q (C)；(2) 1 年內消耗的鎂金屬質量為多少 kg？",
          "steps": [
            "計算 1 年流過總電量 Q = I × t = 0.50 A × 31,536,000 s = 15,768,000 庫侖 (C)。",
            "計算釋放電子的莫耳數 n(e⁻) = Q / F = 15,768,000 / 96,500 ≈ 163.40 mol e⁻。",
            "由反應式可知 1 mol Mg 釋放 2 mol e⁻，故消耗 Mg 莫耳數 n(Mg) = 163.40 / 2 = 81.70 mol。",
        ...
        {
          "difficulty": "實務應用",
          "question": "某一鋼結構廠房塗佈熱浸鍍鋅層，鍍鋅量為 600 g/m² (雙面，單面厚度約 85 μm)。若在工業污染大氣環境下，鋅金屬腐蝕速率為每 m² 每年損失 15 g 鋅 (相當於約 2.1 μm/年)。(1) 該熱浸鍍鋅層理論上可在該環境下防銹保護多少年？ (2) 鍍鋅層保護鋼材的主要化學機制為何？",
          "steps": [
            "計算單面鍍鋅量 m_single = 600 / 2 = 300 g/m²。",
            "計算保護年限 t = 300 (g/m²) / 15 (g/m²·年) = 20 年。",
            "鍍鋅層化學機制：兼具屏障隔離 (生成緻密 ZnCO₃ 絕緣膜) 與犧牲陽極 (鋅電位較負，優先腐蝕供給電子供給鋼材) 雙重保護。"
          ],
          "answer": "(1) 可理論防銹保護 20 年；(2) 兼具「屏障隔離」與「犧牲陽極陰極保護」雙重化學機制"
        }
      ],
      "practice": {
        "difficulty": "基礎",
    ...
    },
    {
      ...
      "concepts": [
        ...
        },
        {
          ...
          "body": "現代建築給排水與地暖系統廣泛採用塑膠高分子管材替代傳統金屬管，以防範生銹與結垢。",
          "table": {
            "headers": [
              "管材名稱",
              "化學結構與名稱",
        ...
        {
          "heading": "阻燃劑化學 (Flame Retardants) 與建築高分子防火等級",
          "body": "有機高分子建材具易燃性。添加阻燃劑可提高極限氧指數 (LOI > 26)。阻燃化學機制包括：\n1. 吸熱冷凝機制：氫氧化鋁 Al(OH)₃ 或氫氧化鎂 Mg(OH)₂ 受熱分解釋放水蒸氣並吸收大量熱能。\n2. 膨脹炭化層機制：磷氮系阻燃劑受熱形成緻密多孔焦炭層 (Char Layer)，隔絕氧氣與熱量傳導。",
      ...
      "practices": [
        ...
        {
          "difficulty": "基礎",
          "question": "聚氯乙烯 (PVC，單體為氯乙烯 C₂H₃Cl，莫耳質量 62.5 g/mol) 是常用排水管材料。(1) 氯乙烯合成 PVC 的反應屬於加成聚合還是縮合聚合？ (2) 若某一 PVC 排水管片段平均聚合度 n = 2000，則該高分子鏈的平均莫耳質量為多少 g/mol (及 kg/mol)？",
          "steps": [
            "氯乙烯單體含 C=C 雙鍵，開環加成結合形成高分子，反應過程無小分子脫去，屬於「加成聚合反應」。",
            "計算平均莫耳質量 M = n × M_monomer = 2000 × 62.5 g/mol = 125,000 g/mol = 125 kg/mol。"
          ],
          "answer": "(1) 屬於加成聚合反應；(2) 平均莫耳質量 M = 125,000 g/mol (125 kg/mol)"
        },
        {
          "difficulty": "進階",
        ...
        {
          "difficulty": "進階",
          "question": "聚氨酯 (PU) 防水塗料由二異氰酸酯 (TDI，化學式 C₉H₆N₂O₂，莫耳質量 174 g/mol) 與聚二醇 (Polyol，莫耳質量 2000 g/mol) 加成聚合而成。已知 174 kg TDI 與 2000 kg Polyol 恰好完加成反應生成 2174 kg PU 彈性體。(1) 計算此加成聚合反應的原子經濟性 (Atom Economy %)；(2) 若 PU 防水膜施工中遇水，TDI 會與水發生產生 CO₂ 氣泡發泡，寫出反應危害。",
          "steps": [
            "加成聚合反應無任何副產物生成，期望產物質量等於所有反應物質量之和 (2174 kg / 2174 kg)。",
        ...
        {
          "difficulty": "實務應用",
          "question": "某防火高分子隔熱板中添加了 39% 重量的氫氧化鋁 Al(OH)₃ (莫耳質量 78 g/mol) 作為無煙阻燃劑。當火災發生達 250°C 時，Al(OH)₃ 發生熱分解：2 Al(OH)₃ → Al₂O₃ + 3 H₂O↑ (每分解 1 mol 吸收 105 kJ 熱量)。若 10 kg 的此防火板受熱分解：(1) 板內含有多少 kg 的 Al(OH)₃ (及莫耳數)？ (2) 完全分解可吸收多少 kJ 的火場熱量？",
          "steps": [
            "計算板內 Al(OH)₃ 質量 m = 10 kg × 39% = 3.9 kg = 3,900 g。",
            "計算 Al(OH)₃ 莫耳數 n = 3,900 g / 78 g/mol = 50 mol。",
    ...
    },
    {
      ...
      "concepts": [
        ...
        },
        {
          ...
          "body": "傳統氟氯碳化物 (CFCs / HCFCs 如 R-22) 逸散至平流層後，受紫外光照射釋放氯自由基 (Cl·)，強烈催化破壞臭氧層 (Cl· + O₃ → ClO· + O₂)。現代綠建築空調全面改用臭氧破壞潛勢 ODP = 0 且全球暖化潛勢低 (Low GWP) 的新一代冷媒 (如 R-32, R-1234yf)。",
          "table": {
            "headers": [
              "冷媒代號",
              "化學成分與類型",
        ...
        {
          "heading": "建築生命週期評估 (LCA) 雙指標：隱含碳 (Embodied) vs 營運碳 (Operational)",
          "body": "建築總生命週期碳排放包含興建階段的「隱含碳」與數十年使用期的「營運碳」。隨著空調與照明能源效率提升，隱含碳佔建築全生命週期碳排的比重已由原本的 20% 升至 50% 以上。推動低碳建材與預鑄工法 (Off-site Construction) 成為建築減碳關鍵。",
      ...
      "practices": [
        ...
        {
          "difficulty": "實務應用",
          "question": "一間剛完工的辦公室使用水性光觸媒 (TiO₂) 塗料進行空氣淨化。已知塗料中含有 50 g 的奈米 TiO₂ 顆粒。若光觸媒在日照下可穩定將甲醛催化分解：HCHO (30 g/mol) + O₂ → CO₂ + H₂O。若室內每天源源不絕釋放出 0.60 g 的甲醛氣體，理論上每天需要光觸媒分解多少莫耳的甲醛？",
          "steps": [
            "計算每天釋放甲醛莫耳數 n(HCHO) = 0.60 g / 30 g/mol = 0.02 mol/天。",
            "光觸媒本身作為催化劑，在反應前後質量不變且不被消耗 (50g 顆粒維持不變)。",
            "只要提供足夠的紫外光/可見光照射，每天催化分解 0.02 mol 即可維持室內空氣清潔。"
          ],
          "answer": "每天需催化分解 0.02 mol 甲醛 (光觸媒催化劑本身不被消耗)"
        },
        {
          "difficulty": "實務應用",
          "question": "某一總建築面積 10,000 m² 的商辦大樓進行 LCA 全生命週期碳足跡評估。(1) 若建材興建階段隱含碳強度為 500 kg CO₂e/m²，求總隱含碳為多少 ton CO₂e？ (2) 若該大樓年營運耗電量為每 m² 100 kWh (電力碳排係數 0.50 kg CO₂e/kWh)，求該大樓營運 50 年的總營運碳為多少 ton CO₂e？隠含碳佔 50 年總碳排的百分之幾？",
          "steps": [
            "計算總隱含碳 Embodied Carbon = 10,000 m² × 500 kg CO₂e/m² = 5,000,000 kg = 5,000 ton CO₂e。",
            "計算年營運碳 = 10,000 m² × 100 kWh/m²·年 × 0.50 kg/kWh = 500,000 kg = 500 ton CO₂e/年。",
            "計算 50 年總營運碳 Operational Carbon = 500 ton CO₂e/年 × 50 年 = 25,000 ton CO₂e。",
            "計算 50 年生命週期總碳排 = 5,000 + 25,000 = 30,000 ton CO₂e。",
            "計算隱含碳佔比 = (5,000 / 30,000) × 100% ≈ 16.67%。"
          ],
          "answer": "(1) 總隱含碳 = 5,000 ton CO₂e；(2) 50 年總營運碳 = 25,000 ton CO₂e (隱含碳佔比約 16.67%)"
        }
      ],
      "practice": {
        "difficulty": "基礎",
