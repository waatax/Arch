  ...
  "topics": [
    {
      ...
      "concepts": [
        {
          ...
          "table": {
            ...
            "rows": [
              [
                "受壓挫屈 (Euler Buckling)",
                "細長受壓構件失穩側向折斷，屬於無塑性預警之突發性破壞",
                "加拿大魁北克大橋懸臂桁架壓桿挫屈倒塌",
                "限制細長比 λ = KL/r；臨界載重 P_cr = π²EI/(KL)²"
              ],
              [
                "剪力脆性破壞 (Shear Failure)",
                "主拉應力超過混凝土抗拉強度，形成 45° 交叉斜裂縫瞬間剪斷",
                "台灣 921 地震沿街騎樓軟弱底層 (Soft Story) 與短柱剪斷",
                "強剪弱彎原則；密排箍筋圍束 V_s ≥ (V_u/φ - V_c)"
              ],
              [
                "動態氣動共振 (Flutter)",
                "卡門渦街頻率與結構自振頻率吻合產生共振放大",
                "美國塔科馬海峽吊橋 (Tacoma Narrows Bridge) 扭轉撕裂",
                "增加斷面開孔透風、設置調諧質量阻尼器 (TMD，如台北 101 風阻尼球)"
              ],
              [
                "疲勞與應力集中 (Fatigue)",
                "反覆交變載重使幾何突變處微裂紋擴展並無預警斷裂",
                "橋樑鋼結構銲道與螺栓接頭疲勞破壞",
                "避免截面急遽變化，落實非破壞檢驗 (NDT)，設定安全係數 FS ≥ 1.5~2.0"
              ]
            ]
          }
        },
      ...
      "worked_examples": [
        ...
        {
          "question": "【統測耐震破壞例題】某沿街騎樓挑高 RC 柱截面 50 cm × 50 cm，淨高 H = 3.6 m，因兩側加裝窗台矮牆使自由變形淨高縮短為 H' = 1.2 m（短柱效應）。已知水平地震側移量 Δ = 1.5 cm，試問：(1) 短柱化後的側向剛度 k' 為原長度柱剛度 k 的幾倍？(2) 若柱之容許剪力 V_allow = 180 kN，原本長柱受剪力 V = 20 kN，短柱化後該柱承受剪力是否會超過容許值而發生脆性剪力破壞？",
          "steps": [
            "步驟 1：計算柱側向剛度比例。柱兩端視為固定端時，側向剛度 k = 12EI / H³，剛度與長度三次方成反比。k' / k = (H / H')³ = (3.6 / 1.2)³ = 3³ = 27 倍。 ｜為什麼：結構力學中構件剛度與長度三次方呈反比，長度減半剛度增為 8 倍，長度減至 1/3 剛度暴增為 27 倍。",
            "步驟 2：計算短柱承受之地震剪力。剪力 V = k · Δ，在相同側移量 Δ 下，短柱剪力 V' = 27 × V = 27 × 20 kN = 540 kN。 ｜為什麼：結構橫向地震剪力依各柱剛度比例分配，剛度越大的短柱吸收越多剪力。",
            "步驟 3：安全性檢核與破壞判定。V' = 540 kN > V_allow = 180 kN（超過容許值 3 倍），柱身將產生 45 度 X 型脆性剪力裂縫而瞬間破壞。 ｜為什麼：剪力大幅超過混凝土與箍筋之剪力強度，屬於無延性預警之危險脆性破壞。"
          ],
          "answer": "(1) 短柱剛度為原柱的 27 倍；(2) 短柱剪力劇增至 540 kN，遠大於容許剪力 180 kN，會發生致命的脆性剪力破壞。",
          "difficulty": "進階",
          "hints": [
            "柱側向剛度與高度三次方成反比 k ∝ 1/H³",
            "相同側移下剪力與剛度成正比"
          ],
          "commonMistake": "誤以為剛度與高度成反比（誤算為 3 倍而非 27 倍），嚴重低估短柱剪力集中程度。",
          "eliteShortcut": "短柱秒殺口訣：高度變 1/n，剪力暴增 n³ 倍！高度變 1/3，剪力直接乘 27！"
        }
      ],
      "practices": [
        {
    ...
    },
    {
      ...
      "worked_examples": [
        {
          "question": "【步驟化例題】均布載重簡支梁：簡支梁跨距 6 m，全跨受 4 kN/m 均布載重，兩端反力各為多少？",
          "difficulty": "統測核心",
          "steps": [
            "步驟 1：求全跨等值集中力。<span className=\"text-rose-600 font-bold\">W = 4 × 6 = 24 kN</span>，作用於跨中 (x = 3 m)。",
            "步驟 2：由對稱性直接判定兩端反力。系統左右對稱，所以 <span className=\"text-indigo-600 font-bold\">R_A = R_B = W / 2 = 12 kN</span>。",
            "步驟 3：力矩檢核驗算。對 A 點取力矩 ∑M_A = 24 × 3 - R_B × 6 = 72 - 72 = 0，完全閉合平衡。"
          ],
          "answer": "R_A = R_B = 12 kN (向上)",
          "hints": [
            "分析題目核心條件與工程力學規範/定理",
            "列出對應計算式或幾何平衡條件求解"
          ],
          "commonMistake": "容易在正負號方向、單位換算 (如 MPa = N/mm²) 或圖例符號代入時產生計算失誤。",
          "eliteShortcut": "平行力系解題心法：合力大小等於代數和，合力位置利用合力矩定理 (Varignon) 對基準點取矩秒殺。"
        },
        {
          "question": "【統測三角形載重例題】一長度 L = 6 m 之簡支梁 AB，A 端為鉸支承、B 端為滾支承。梁上承受一三角形分布載重，A 端載重強度為 0，向右線性增加至 B 端最大值 w₀ = 18 kN/m。試求解：(1) 等值集中合力 W 之大小與其作用線距 A 端之距離 x_W；(2) A 端支承反力 R_A 與 B 端支承反力 R_B。",
          "difficulty": "進階",
          "steps": [
            "步驟 1：計算等值集中合力大小。三角形載重等值合力 W = (1/2) × 底 × 高 = (1/2) × 6 m × 18 kN/m = 54 kN。 ｜為什麼：分布載重的等值集中力等於載重幾何圖形之總面積。",
            "步驟 2：定位等值力作用線位置。三角形形心位於距大端 (B端) L/3 = 6/3 = 2 m 處，即距尖端 (A端) 距離 x_W = 2L/3 = (2/3) × 6 = 4 m 處。 ｜為什麼：直角三角形幾何形心恆位於距垂直直角高 1/3 底長處。",
            "步驟 3：對 A 點取力矩求 B 端反力 R_B。∑M_A = 0 ⇒ R_B × 6 - W × 4 = 0 ⇒ 6 R_B = 54 × 4 = 216 ⇒ R_B = 36 kN (向上)。 ｜為什麼：以 A 為取矩點消去未知數 R_A，一條力矩平衡方程式直接求解 R_B。",
            "步驟 4：由垂直平衡求解 A 端反力 R_A。∑F_y = 0 ⇒ R_A + R_B - W = 0 ⇒ R_A + 36 - 54 = 0 ⇒ R_A = 18 kN (向上)。 ｜為什麼：同平面平行力系滿足垂直力總和為零之平衡條件。"
          ],
          "answer": "(1) 等值合力 W = 54 kN，作用於距 A 端 4 m 處；(2) 支承反力 R_A = 18 kN (向上)，R_B = 36 kN (向上)",
          "hints": [
            "三角形載重面積為 (1/2) · w · L",
            "形心偏向大端，距尖端 2L/3、距大端 L/3"
          ],
          "commonMistake": "極高頻陷阱：誤將三角形形心當作中點 (L/2 = 3m)，導致力矩算錯反力全滅！",
          "eliteShortcut": "秒殺分力法則：三角形載重反力，大端反力恆佔總載重 2/3 (54 × 2/3 = 36 kN)，小端反力恆佔 1/3 (54 × 1/3 = 18 kN)！"
        }
      ],
      "practices": [
        {
          ...
          "difficulty": "統測核心",
          "steps": [
            "載重圖面積 <span className=\"text-rose-600 font-bold\">R = 12 × 3 / 2 = 18 kN</span>。",
            "三角形形心距大端 <span className=\"text-indigo-600 font-bold\">L/3</span>。"
          ],
        ...
        },
        {
          ...
          "difficulty": "進階",
          "steps": [
            "<span className=\"text-rose-600 font-bold\">R = 10 + 20 = 30 kN</span>。",
            "位置公式：<span className=\"text-indigo-600 font-bold\">x_R = (10×1 + 20×4) / 30 = 3 m</span>。"
          ],
          "answer": "x = 3 m",
          "hints": [
            "分析題目核心條件與工程力學規範/定理",
        ...
        },
        {
          ...
          "difficulty": "觀念",
          "steps": [
            "辨識題目屬於**平面平行力系**，先畫出<span className='text-indigo-600 font-bold'>自由體圖 (FBD)</span> 或整理已知量。",
            "確認 <span className='text-rose-600 font-bold'>合力與原力系的總力及總力矩等值</span> 成立後再代入公式。"
          ],
        ...
        },
        {
          ...
          "steps": [
            "逐項檢查輸入單位是否一致。",
            "結果應以 **力用 kN、位置用 m、力矩用 kN·m** 表達；不符時不可只改單位符號，須回推計算過程。"
          ],
        ...
        },
        {
          ...
          "difficulty": "易錯題",
          "steps": [
            "回到原先設定的<span className=\"text-indigo-600 font-bold\">正方向</span>或轉向。",
            "負號僅表示<span className=\"text-rose-600 font-bold\">實際方向與假設相反</span>，不代表答案必然錯誤。"
          ],
        ...
        },
        {
          ...
          "difficulty": "進階",
          "steps": [
            "使用<span className=\"text-indigo-600 font-bold\">未參與主要求解的獨立關係</span>重新計算。",
            "同時檢查極端情況、方向與<span className=\"text-rose-600 font-bold\">有效數字</span>合理性。"
          ],
    ...
    },
    {
      ...
      "worked_examples": [
        {
          "question": "【步驟化例題】簡支梁支承反力：鉸支承 A 與滾支承 B 相距 4 m，跨中受向下 8 kN 垂直力，求兩端反力。",
          "difficulty": "統測核心",
          "steps": [
            "步驟 1：對鉸支承 A 取力矩求 B 端垂直反力 B_y。<span className=\"text-indigo-600 font-bold\">∑M_A = 0</span> ⇒ 4 B_y - 8 × 2 = 0 ⇒ 4 B_y = 16 ⇒ <span className=\"text-rose-600 font-bold\">B_y = 4 kN (向上)</span>。 ｜為什麼：取矩點穿過 A 點未知反力作用線，直接消去 A_x 與 A_y 簡化計算。",
            "步驟 2：利用垂直力平衡求 A 端垂直反力 A_y。<span className=\"text-indigo-600 font-bold\">∑F_y = 0</span> ⇒ A_y + B_y - 8 = 0 ⇒ A_y + 4 - 8 = 0 ⇒ <span className=\"text-rose-600 font-bold\">A_y = 4 kN (向上)</span>。 ｜為什麼：剛體垂直方向合力為零。",
            "步驟 3：利用水平力平衡求 A 端水平反力 A_x。<span className=\"text-indigo-600 font-bold\">∑F_x = 0</span> ⇒ 無水平外力，故 <span className=\"text-rose-600 font-bold\">A_x = 0</span>。 ｜為什麼：滾支承 B 無水平約束，所有水平外力皆由鉸支承 A 承擔。"
          ],
          "answer": "A_x = 0, A_y = 4 kN (向上), B_y = 4 kN (向上)",
          "hints": [
            "分析題目核心條件與工程力學規範/定理",
            "列出對應計算式或幾何平衡條件求解"
          ],
          "commonMistake": "容易在正負號方向、單位換算 (如 MPa = N/mm²) 或圖例符號代入時產生計算失誤。",
          "eliteShortcut": "非共點力系解題心法：優先以未知力交點為取矩點 (∑M = 0)，單一方程式直接求解未知反力。"
        },
        {
          "question": "【統測斜向力與力偶綜合題】梁 AB 長 L = 6 m，A 端為鉸支承，B 端為滾支承。在距 A 端 2 m 處受一斜向力 P = 10 kN（與水平夾角 37°，cos 37° = 0.8, sin 37° = 0.6，指向右下方），在跨中 3 m 處受一順時針外加力偶 M₀ = 12 kN·m。試求：(1) A 端水平反力 A_x；(2) B 端垂直反力 B_y；(3) A 端垂直反力 A_y。",
          "difficulty": "進階",
          "steps": [
            "步驟 1：正交分解斜向力 P。水平分力 P_x = P · cos 37° = 10 × 0.8 = 8 kN (向右)；垂直分力 P_y = P · sin 37° = 10 × 0.6 = 6 kN (向下)。 ｜為什麼：非共點力系計算首要步驟是將所有斜向力正交分解為 X, Y 分力。",
            "步驟 2：利用水平力平衡求解 A_x。∑F_x = 0 ⇒ A_x + P_x = 0 ⇒ A_x + 8 = 0 ⇒ A_x = -8 kN（大小 8 kN，向左）。 ｜為什麼：鉸支承 A 必須提供等值反向水平力抵消 P_x。",
            "步驟 3：對 A 點取力矩求解 B 端反力 B_y。∑M_A = 0 (逆時針為正 +) ⇒ R_B × 6 - P_y × 2 - M₀ = 0 ⇒ 6 R_B - (6 × 2) - 12 = 0 ⇒ 6 R_B - 24 = 0 ⇒ R_B = 4 kN (向上)。 ｜為什麼：外加力偶 M₀ 在平面內任何一點取矩均為純力矩 12 kN·m (順時針為負力矩)。",
            "步驟 4：利用垂直平衡求解 A_y。∑F_y = 0 ⇒ A_y + R_B - P_y = 0 ⇒ A_y + 4 - 6 = 0 ⇒ A_y = 2 kN (向上)。 ｜為什麼：系統垂直分力代數和必須為零。"
          ],
          "answer": "(1) A_x = 8 kN (向左)；(2) B_y = 4 kN (向上)；(3) A_y = 2 kN (向上)",
          "hints": [
            "斜向力先分解：P_x = 8 kN (向右), P_y = 6 kN (向下)",
            "力偶 M₀ 與取矩點距離無關，直接代入 ±12 kN·m"
          ],
          "commonMistake": "極高頻陷阱：誤將外加力偶 M₀ 乘以距離 (12 × 3)，力偶本身即為力矩，絕不可重複乘距離！",
          "eliteShortcut": "力偶秒殺秘訣：力偶是自由向量，取矩時直接代入數值 (順時針減、逆時針加)，千萬不要乘長度！"
        }
      ],
      "practices": [
        {
          ...
          "difficulty": "統測核心",
          "steps": [
            "合力大小 <span className=\"text-rose-600 font-bold\">R = √(6² + 8²) = 10 kN</span>。",
            "方向角 <span className=\"text-indigo-600 font-bold\">θ = tan⁻¹(8/6) = 53.13°</span>。"
          ],
        ...
        },
        {
          ...
          "difficulty": "觀念",
          "steps": [
            "辨識題目屬於**非共點非平行力系**，先畫出<span className='text-indigo-600 font-bold'>自由體圖 (FBD)</span> 或整理已知量。",
            "確認 <span className='text-rose-600 font-bold'>ΣF_x、ΣF_y、ΣM 三式同時成立</span> 成立後再代入公式。"
          ],
        ...
        },
        {
          ...
          "steps": [
            "逐項檢查輸入單位是否一致。",
            "結果應以 **力用 kN、力矩用 kN·m** 表達；不符時不可只改單位符號，須回推計算過程。"
          ],
    ...
    },
    {
          ...
          "table": {
            ...
            "rows": [
              ...
              [
                ...
                "τ_avg = V / (bh)",
                "τ_max = 1.5 · (V/A)",
                "最大剪應力發生於中性軸 (NA)，為平均值 1.5 倍"
              ],
              [
                "實心圓形截面 (直徑 d)",
                "τ_avg = V / (πr²)",
                "τ_max = (4/3) · (V/A)",
                "最大剪應力為平均值 4/3 倍 (約 1.33 倍)"
              ],
              [
                "薄壁圓管 (厚度 t)",
                "τ_avg = V / A",
      ...
      "worked_examples": [
        {
          "question": "【步驟化例題】螺栓單剪計算：直徑 10 mm 鋼螺栓承受 12 kN 之單剪剪力，求其平均剪應力 τ_avg。",
          "difficulty": "統測核心",
          "steps": [
            "步驟 1：審題與計算螺栓單個剪切截面積。<span className=\"text-rose-600 font-bold\">A = π · d² / 4 = π × 10² / 4 ≒ 78.54 mm²</span>。 ｜為什麼：螺栓受橫向垂直剪力時，其抵抗破壞之有效截面積為圓形橫斷面。",
            "步驟 2：換算剪力單位並代入直接剪應力公式。V = 12 kN = 12,000 N，<span className=\"text-indigo-600 font-bold\">τ_avg = V / A = 12000 / 78.54 ≒ 152.8 N/mm² (MPa)</span>。 ｜為什麼：平均剪應力定義為總剪力除以抗剪截面積，力學單位 1 N/mm² 等於 1 MPa。",
            "步驟 3：工程安全係數與雙剪對比檢核。若接頭構造改為「雙剪 (Double Shear)」，則有效受剪面數加倍 (2A)，平均剪應力將驟降為 152.8 / 2 = 76.4 MPa，大幅提高螺栓連接之安全裕度與耐震可靠度。 ｜為什麼：鋼結構接頭設計中，雙剪配置能對稱受力避免偏心彎矩，並使容許承載剪力翻倍。"
          ],
          "answer": "平均剪應力約 152.8 MPa",
          "hints": [
            "分析題目核心條件與工程力學規範/定理",
            "列出對應計算式或幾何平衡條件求解"
          ],
          "commonMistake": "容易在正負號方向、單位換算 (如 MPa = N/mm²) 或圖例符號代入時產生計算失誤。",
          "eliteShortcut": "剪應力分析心法：釐清受剪面數 (單剪 A / 雙剪 2A)，結合截面形狀係數 (矩形 1.5, 圓形 4/3) 快速定案。"
        },
        {
          "question": "【統測梁截面橫向剪應力例題】一矩形截面木梁（寬度 b = 120 mm，高度 h = 200 mm），承受垂直橫向剪力 V = 36 kN。試計算：(1) 該截面之平均剪應力 τ_avg；(2) 中性軸 (NA) 處之最大橫向剪應力 τ_max。",
          "difficulty": "進階",
          "steps": [
            "步驟 1：計算矩形截面積。A = b × h = 120 mm × 200 mm = 24,000 mm²。 ｜為什麼：截面總面積為平均剪應力之分母基準。",
            "步驟 2：計算平均剪應力 τ_avg。τ_avg = V / A = 36,000 N / 24,000 mm² = 1.5 N/mm² = 1.5 MPa。 ｜為什麼：平均剪應力假設剪力均勻分布於整個斷面。",
            "步驟 3：應用矩形截面剪應力形狀係數求 τ_max。矩形截面橫向剪應力呈拋物線分布，中性軸處達到最大值 τ_max = 1.5 · τ_avg = 1.5 × 1.5 MPa = 2.25 MPa。 ｜為什麼：依據橫向剪應力公式 τ = VQ/(It)，矩形截面中性軸處 Q 最大，推導得 τ_max = (3/2)·(V/A)。"
          ],
          "answer": "(1) 平均剪應力 τ_avg = 1.5 MPa；(2) 最大橫向剪應力 τ_max = 2.25 MPa",
          "hints": [
            "矩形截面最大剪應力位於中性軸 (NA)",
            "最大值為平均值的 1.5 倍 (3/2)"
          ],
          "commonMistake": "常有考生誤將最大剪應力當作平均剪應力 (答 1.5 MPa 而漏乘 1.5 倍)！",
          "eliteShortcut": "秒殺形狀係數：矩形 × 1.5、實心圓 × 4/3 (1.33)、薄壁圓管 × 2.0，看到矩形直接 1.5 倍秒殺！"
        }
      ],
      "practices": [
        {
          ...
          "difficulty": "統測核心",
          "steps": [
            "雙剪有效面積為 <span className=\"text-rose-600 font-bold\">2A</span>。",
            "剪應力 <span className=\"text-indigo-600 font-bold\">τ = 12000 / (2 × 78.54)</span>。"
          ],
          "answer": "約 76.4 MPa",
          "hints": [
            "分析題目核心條件與工程力學規範/定理",
        ...
        },
        {
          ...
          "difficulty": "觀念",
          "steps": [
            "辨識題目屬於**剪力與剪應力**，先畫出<span className='text-indigo-600 font-bold'>自由體圖 (FBD)</span> 或整理已知量。",
            "確認 <span className='text-rose-600 font-bold'>先分辨剪力 V、剪切面數與有效面積</span> 成立後再代入公式。"
          ],
        ...
        },
        {
          ...
          "steps": [
            "逐項檢查輸入單位是否一致。",
            "結果應以 **剪力用 N 或 kN、剪應力用 MPa** 表達；不符時不可只改單位符號，須回推計算過程。"
          ],
    ...
    },
    {
      ...
      "examHitRate": 4,
      "step0Prerequisites": [
        "向量合成與分解：Fx = F·cosθ, Fy = F·sinθ",
        "單位換算：1 kN = 10³ N，1 MPa = 1 N/mm² = 10⁶ N/m²",
        "向量內積與外積：A·B = |A||B|cosθ，外積大小為平行四邊形面積"
      ],
      "fatalTraps": [
        {
          "wrongThinking": "向量分解時直接將水平分力當作 F·cosθ，未確認角度 θ 是與水平軸還是鉛垂軸夾角。",
          "correctThinking": "永遠觀察直角三角形幾何：與角度相鄰之邊用 cos，與角度對向之邊用 sin；若夾角為與鉛垂線夾角，則水平分力為 F·sinθ。",
          "trapDescription": "角度基準線認錯導致水平與鉛垂分力顛倒，後續所有平衡方程式全錯。"
        },
        {
          "wrongThinking": "計算應力或力矩時直接將 kN 與 cm、m 混合相乘除，未統一單位系統。",
          "correctThinking": "統測力學解題一律第一時間將單位換算至標準工程制：力以 N 為準 (1 kN = 1000 N)，長度以 mm 為準 (1 m = 1000 mm)，應力即自動為 MPa (N/mm²)。",
          "trapDescription": "SI 單位倍率混淆（如 GPa、MPa、m、cm、mm），導致計算結果出現 10³ 或 10⁶ 倍的數量級失誤。"
        }
      ],
      "eliteMentalModels": [
        {
          "technique": "正交投影座標拆解模型 (Orthogonal Projection Decomposition)",
          "explanation": "將空間或平面任意斜向力，立即投影至互相垂直的直角座標軸 (X, Y)，以純代數運算 ∑Fx 與 ∑Fy 取代複雜的幾何三角函數，簡化合成運算。"
        }
      ],
      "covered_question_ids": [
        "111-1-16",
      ...
      "worked_examples": [
        {
          ...
          "commonMistake": "容易在正負號方向、單位換算 (如 MPa = N/mm²) 或圖例符號代入時產生計算失誤。",
          "eliteShortcut": "向量運算心法：力以 N、長度以 mm 統一標準量綱；直角投影 ∑Fx 與 ∑Fy 徹底消滅三角函數死背。"
        },
        {
          "question": "【統測兩力合成與合力方向角例題】作用於同一點的兩個共面共點力 F₁ = 30 kN (水平向右) 與 F₂ = 40 kN (垂直向上)。若另有一力 F₃ = 50 kN 與水平夾角 37° (指向第三象限，左下方)。試求解：(1) F₁ 與 F₂ 的合力 R₁₂ 之大小與方向角；(2) 三力之總合力向量 R_total 之水平分量 R_x、垂直分量 R_y 與總大小 R。",
          "difficulty": "中等",
          "steps": [
            "步驟 1：求解 F₁ 與 F₂ 之合力。因兩力正交垂直，R₁₂ = √(F₁² + F₂²) = √(30² + 40²) = 50 kN。方向角 θ = tan⁻¹(40/30) = 53.13° (第一象限)。 ｜為什麼：3-4-5 直角三角形畢氏定理特性。",
            "步驟 2：正交分解第三力 F₃。F₃_x = - F₃ · cos 37° = - 50 × 0.8 = -40 kN (向左)；F₃_y = - F₃ · sin 37° = - 50 × 0.6 = -30 kN (向下)。 ｜為什麼：第三象限力向量水平與垂直分量皆為負值。",
            "步驟 3：求三力總合力分量與大小。R_x = F₁_x + F₂_x + F₃_x = 30 + 0 - 40 = -10 kN；R_y = F₁_y + F₂_y + F₃_y = 0 + 40 - 30 = 10 kN。總合力 R = √((-10)² + 10²) = 10√2 ≒ 14.14 kN。 ｜為什麼：平面多力系合力等於各力正交分量之代數和。"
          ],
          "answer": "(1) R₁₂ = 50 kN, θ = 53.13°；(2) R_x = -10 kN, R_y = 10 kN, 總合力 R = 10√2 ≒ 14.14 kN (指向第二象限 135°)",
          "hints": [
            "正交分力直接代入代數和 ∑Fx 與 ∑Fy",
            "注意正負號與象限方向"
          ],
          "commonMistake": "常將第三象限分力符號搞錯（忘記加負號），導致合力計算產生極大偏差。",
          "eliteShortcut": "3-4-5 三角形速算：50 kN 斜向力 (37°) 分解必為 40 kN (水平) 與 30 kN (垂直)，無需計算機即可心算秒殺！"
        }
      ],
      "illustrations": [
      ...
      "practices": [
        {
          ...
          "steps": [
            "求 x 方向合力分量：∑Fx = F1 · cos(0°) + F2 · cos(90°) = 60 × 1 + 80 × 0 = 60 N。",
            "求 y 方向合力分量：∑Fy = F1 · sin(0°) + F2 · sin(90°) = 60 × 0 + 80 × 1 = 80 N。",
            "利用畢氏定理計算合力大小：F_R = √((∑Fx)² + (∑Fy)²) = √(60² + 80²) = √(3600 + 6400) = √10000 = 100 N。",
            "計算方向角 θ：θ = tan⁻¹(∑Fy / ∑Fx) = tan⁻¹(80 / 60) = tan⁻¹(4/3) ≒ 53.13°。"
          ],
        ...
        },
        {
          ...
          "steps": [
            "求點 A 至點 B 的空間位移向量：r_AB = (3 - 0)i + (4 - 0)j + (12 - 0)k = (3i + 4j + 12k) m。",
            "計算鋼索長度 L：L = √(3² + 4² + 12²) = √(9 + 16 + 144) = √169 = 13 m。",
            "求沿 AB 方向的單位向量 λ_AB：λ_AB = r_AB / L = (3/13)i + (4/13)j + (12/13)k。",
            "由作用於 B 點拉回 A 點的方向 (方向為 -λ_AB)，求作用於 B 點的各分力大小：\n- Tx = 130 × (-3 / 13) = -30 kN (向 -x 方向)\n- Ty = 130 × (-4 / 13) = -40 kN (向 -y 方向)\n- Tz = 130 × (-12 / 13) = -120 kN (向下下拉)",
            "驗證合力大小：F = √((-30)² + (-40)² + (-120)²) = √(900 + 1600 + 14400) = √16900 = 130 kN。"
          ],
        ...
        },
        {
          ...
          "steps": [
            "正交分力計算：Fx = 200 × cos(60°) = 100 N；Fy = 200 × sin(60°) = 173.2 N。",
            "非正交分解：繪製向量三角形，力 F (200N) 為合力，斜向分力 Fu 與 +x 夾 30°，Fv 沿 +y 軸 (垂直)。",
            "在向量三角形中，F 與 u 軸夾 30°，與 v 軸夾 30°。由正弦定理：Fu / sin(60°) = F / sin(90°)。",
            "Fu = 200 × (√3/2) / 1 = 100√3 N ≒ 173.2 N。"
          ],
    ...
    },
    {
      ...
      "step0Prerequisites": [
        "共點力系平衡方程式：∑Fx = 0, ∑Fy = 0",
        "拉密定理 (Lami Theorem)：三力共點平衡時，各力與其餘二力夾角之正弦成正比：F₁/sinα = F₂/sinβ = F₃/sinγ",
        "自由體圖 (FBD) 隔離體法：切開邊界並補上所有外力與接觸反力"
      ],
      "fatalTraps": [
        {
          "wrongThinking": "只要看到三個力平衡就盲目套用拉密定理，未確認三力是否為「共點力系」。",
          "correctThinking": "拉密定理僅適用於「三力共點且剛體處於平衡」之情況；若三力平行或不交於一點，產生力偶或力矩，不可使用拉密定理。",
          "trapDescription": "誤將非共點力系套用拉密定理，忽略力矩平衡方程式 ∑M = 0 之存在。"
        },
        {
          "wrongThinking": "繪製自由體圖 (FBD) 時，將物體內力（如桁架桿件內部張力）畫在整體隔離體上。",
          "correctThinking": "自由體圖只標示「作用於該隔離體邊界之外力」與「支承接觸反力」；內部構件互作用力在整體系統中成對抵消，不得重複標示。",
          "trapDescription": "自由體圖受力定義混淆，誤加內力或漏畫支承反力導致方程式多未知數。"
        }
      ],
      "eliteMentalModels": [
        {
          "technique": "三力共點交會模型 (Three-Force Concurrency)",
          "explanation": "剛體受三個非平行力作用而平衡時，此三力之作用線必共點交於同一位置；利用幾何交點求得力之方向線，再以閉合力三角形或拉密定理秒殺未知力。"
        }
      ],
      "covered_question_ids": [
        "111-1-15",
      ...
      "worked_examples": [
        {
          ...
          "commonMistake": "容易在正負號方向、單位換算 (如 MPa = N/mm²) 或圖例符號代入時產生計算失誤。",
          "eliteShortcut": "共點力平衡心法：三力平衡首選力三角形閉合或拉密定理；多力平衡採正交分解 ∑Fx=0, ∑Fy=0。"
        },
        {
          "question": "【統測拉密定理秒殺例題】一重 W = 600 N 之吊燈懸掛於點 C。繩索 AC 綁於天花板且與水平夾角為 60°，繩索 BC 水平拉向右側牆面保持平衡。試利用拉密定理 (Lami's Theorem) 或力平衡條件求解：(1) 斜向繩索 AC 之張力 T_AC；(2) 水平繩索 BC 之張力 T_BC。",
          "difficulty": "統測核心",
          "steps": [
            "步驟 1：分析結點 C 之三力夾角。垂直向下重力 W = 600 N 與水平繩 BC 夾角為 90°；繩 AC 與水平繩 BC 夾角為 180° - 60° = 120°；繩 AC 與垂直重力線夾角為 90° + 60° = 150°。 ｜為什麼：三共面力平衡共點時，各力對邊夾角滿足拉密定理正弦比例關係。",
            "步驟 2：列出拉密定理方程式。T_AC / sin(90°) = T_BC / sin(150°) = W / sin(120°)。 ｜為什麼：拉密定理指出每力大小與其餘兩力夾角之正弦值成正比。",
            "步驟 3：計算繩索張力 T_AC。T_AC = W · sin(90°) / sin(120°) = 600 × 1.0 / (√3 / 2) = 1200 / √3 = 400√3 ≒ 692.8 N。 ｜為什麼：sin 120° = sin 60° = √3 / 2。",
            "步驟 4：計算繩索張力 T_BC。T_BC = W · sin(150°) / sin(120°) = 600 × 0.5 / (√3 / 2) = 600 / √3 = 200√3 ≒ 346.4 N。 ｜為什麼：sin 150° = sin 30° = 0.5。"
          ],
          "answer": "(1) T_AC = 400√3 ≒ 692.8 N；(2) T_BC = 200√3 ≒ 346.4 N",
          "hints": [
            "三共面力平衡優先使用拉密定理或 30°-60°-90° 直角三角形",
            "T_AC · sin 60° = W, T_AC · cos 60° = T_BC"
          ],
          "commonMistake": "誤將繩索 AC 視為水平分力或角度算錯（忘記外角與內角轉換）。",
          "eliteShortcut": "力三角形秒殺法：W(垂直) : T_BC(水平) : T_AC(斜邊) = √3 : 1 : 2，故 T_AC = 2W/√3、T_BC = W/√3，10 秒心算破題！"
        }
      ],
      "illustrations": [
      ...
      "practices": [
        ...
        },
        {
          ...
          "steps": [
            "繪製節點 C 之 FBD，列出 x 與 y 方向平衡：",
            "∑Fx = -TA·cos(30°) + TB·cos(60°) = 0 ⇒ TB·(1/2) = TA·(√3/2) ⇒ TB = √3 TA。",
            "∑Fy = TA·sin(30°) + TB·sin(60°) - 100 = 0 ⇒ 0.5 TA + (√3 TA)·(√3/2) = 100 ⇒ 0.5 TA + 1.5 TA = 100 ⇒ 2 TA = 100 ⇒ TA = 50 N。",
            "代回得 TB = 50√3 N ≒ 86.6 N。"
          ],
        ...
        },
        {
          ...
          "steps": [
            "對木桿取 A 點力矩平衡 ∑M_A = 0：\nT · (4 sin 45°) - 120 · (2 cos 45°) = 0 ⇒ 4 T sin 45° = 240 cos 45° ⇒ 4 T = 240 ⇒ T = 60 N。",
            "由 ∑Fx = 0 得 R_Ax = T = 60 N (向右)；由 ∑Fy = 0 得 R_Ay = 120 N (向上)。",
            "A 點總反力 R_A = √(60² + 120²) = √(3600 + 14400) = √18000 = 60√5 N ≒ 134.16 N。"
          ],
    ...
    },
    {
      ...
      "examHitRate": 4,
      "step0Prerequisites": [
        "一階面積矩（靜矩）：Qx = ∫ y dA = A · ȳ，Qy = ∫ x dA = A · x̄",
        "組合截面形心公式：x̄ = ∑(Ai·xi) / ∑Ai，ȳ = ∑(Ai·yi) / ∑Ai",
        "扣除挖空截面時，挖空面積視為負面積：A_hole = -A"
      ],
      "fatalTraps": [
        {
          "wrongThinking": "計算挖空圖形（如帶孔平板或空心箱型梁）形心時，將挖空部分面積當作正面積相加。",
          "correctThinking": "組合形心公式中，挖空部分之面積與一階矩必須取「負號」：ȳ = (A₁y₁ - A_hole·y_hole) / (A₁ - A_hole)。",
          "trapDescription": "挖空截面正負號錯誤，造成形心計算偏向挖空側的荒謬結果。"
        },
        {
          "wrongThinking": "計算組合截面形心時，每個基本圖形的形心座標未採用同一個基準原點。",
          "correctThinking": "計算前必須先在圖面建立統一且固定的直角座標基準原點（通常選在最左側或最下底邊），所有 xi, yi 必須嚴格相對於同一原點度量。",
          "trapDescription": "局部座標與全域基準原點混淆，導致一階矩累加錯誤。"
        }
      ],
      "eliteMentalModels": [
        {
          "technique": "面積矩正負疊加模型 (Negative Area Superposition)",
          "explanation": "任何複雜有孔截面均拆解為「實心大矩形」減去「挖空小圖形」；以同基準線建立算表：欄位依序為分部、面積 A、形心距離 y、一階矩 Ay，表底求和 ȳ = ∑Ay / ∑A，零錯誤率。"
        }
      ],
      "covered_question_ids": [
        "111-1-14",
      ...
      "worked_examples": [
        {
          ...
          "commonMistake": "容易在正負號方向、單位換算 (如 MPa = N/mm²) 或圖例符號代入時產生計算失誤。",
          "eliteShortcut": "形心速算心法：組合截面拆解為基本幾何圖形，建立 ∑Ay/∑A 算表；挖空部分面積與一階矩一律帶負號。"
        },
        {
          "question": "【統測組合截面開孔形心例題】一寬度 B = 200 mm、高度 H = 300 mm 之實心矩形均質鋼板，在左下方挖除一寬 b = 100 mm、高 h = 100 mm 之正方形孔洞（孔洞底邊貼齊鋼板底邊，左邊貼齊鋼板左邊）。試以鋼板左下角為坐標原點 (0, 0)，計算殘餘截面之形心坐標 (X̄, Ȳ)。",
          "difficulty": "統測核心",
          "steps": [
            "步驟 1：建立完整矩形 A₁ 與挖除孔洞 A₂ 之幾何參數。大矩形 A₁ = 200 × 300 = 60,000 mm²，形心 x₁ = 100 mm, y₁ = 150 mm；挖除正方形 A₂ = 100 × 100 = 10,000 mm²，形心 x₂ = 50 mm, y₂ = 50 mm。 ｜為什麼：利用負面積法 (Negative Area Method) 將開孔視為負面積計算面積一次矩。",
            "步驟 2：計算殘餘截面淨面積 A_net。A_net = A₁ - A₂ = 60,000 - 10,000 = 50,000 mm²。 ｜為什麼：總面積為兩部分代數差。",
            "步驟 3：計算形心 X̄ 坐標。X̄ = (A₁·x₁ - A₂·x₂) / A_net = (60,000 × 100 - 10,000 × 50) / 50,000 = (6,000,000 - 500,000) / 50,000 = 5,500,000 / 50,000 = 110 mm。 ｜為什麼：面積對 Y 軸一次力矩之差除以淨面積等於 X̄。",
            "步驟 4：計算形心 Ȳ 坐標。Ȳ = (A₁·y₁ - A₂·y₂) / A_net = (60,000 × 150 - 10,000 × 50) / 50,000 = (9,000,000 - 500,000) / 50,000 = 8,500,000 / 50,000 = 170 mm。 ｜為什麼：面積對 X 軸一次力矩之差除以淨面積等於 Ȳ。"
          ],
          "answer": "形心坐標 (X̄, Ȳ) = (110 mm, 170 mm)",
          "hints": [
            "開孔採用負面積扣除法：A_net = A₁ - A₂",
            "大矩形與孔洞之形心坐標皆由同一個基準原點 (左下角) 起算"
          ],
          "commonMistake": "孔洞形心坐標搞錯起算點，或忘記在分子與分母扣除孔洞面積（誤用加法）。",
          "eliteShortcut": "形心偏移直覺檢核：左下挖空後，殘餘形心必向右上方偏移（X̄ > 100, Ȳ > 150），秒殺荒謬選項！"
        }
      ],
      "illustrations": [
    ...
    },
    {
      ...
      "worked_examples": [
        {
          ...
          "commonMistake": "容易在正負號方向、單位換算 (如 MPa = N/mm²) 或圖例符號代入時產生計算失誤。",
          "eliteShortcut": "摩擦力判別心法：先以靜力平衡求靜摩擦力，再與臨界最大靜摩擦力 Fmax = μs·N 比較以判定是否滑動。"
        },
        {
          "question": "【統測斜面摩擦與推力例題】一重 W = 200 N 之物體置於與水平夾角 θ = 30° 之斜面上。物體與斜面間之靜摩擦係數 μ_s = 0.4。若欲沿斜面向上施加一平行斜面之拉力 P，使物體「恰欲沿斜面向上滑動」，試計算：(1) 斜面對物體之正向力 N；(2) 最大靜摩擦力 f_s(max)；(3) 臨界向上拉力 P_crit。",
          "difficulty": "統測核心",
          "steps": [
            "步驟 1：建立沿斜面 (X') 與垂直斜面 (Y') 坐標系並分解重力 W。垂直斜面分量 W_y = W · cos 30° = 200 × (√3 / 2) = 100√3 ≒ 173.2 N；沿斜面向下分量 W_x = W · sin 30° = 200 × 0.5 = 100 N。 ｜為什麼：斜面力學分析以平行/垂直斜面為坐標軸能簡化計算。",
            "步驟 2：由垂直斜面平衡求解正向力 N。∑F_y' = 0 ⇒ N - W_y = 0 ⇒ N = 100√3 ≒ 173.2 N。 ｜為什麼：垂直斜面方向無加速度，正向力平衡重力垂直分量。",
            "步驟 3：計算最大靜摩擦力 f_s(max)。物體恰欲向上滑動，摩擦力方向必定「沿斜面向下」。f_s(max) = μ_s · N = 0.4 × 173.2 = 69.28 N。 ｜為什麼：摩擦力恆與物體即將運動之相對趨勢方向相反。",
            "步驟 4：由沿斜面方向平衡求解臨界拉力 P_crit。∑F_x' = 0 ⇒ P - W_x - f_s(max) = 0 ⇒ P = W_x + f_s(max) = 100 + 69.28 = 169.28 N。 ｜為什麼：向上拉力必須同時克服重力下滑分力與最大靜摩擦阻力。"
          ],
          "answer": "(1) 正向力 N ≒ 173.2 N；(2) 最大靜摩擦力 f_s(max) ≒ 69.28 N (沿斜面向下)；(3) 臨界向上拉力 P_crit ≒ 169.3 N",
          "hints": [
            "物體「向上滑動」時，摩擦力方向「向下」",
            "P = W · sinθ + μ_s · W · cosθ"
          ],
          "commonMistake": "誤將摩擦力方向搞反（誤用減法 P = W_x - f_s，那是物體即將向下滑動時阻止下滑的最小支撐力）。",
          "eliteShortcut": "斜面秒殺公式：向上拉 P_up = W(sinθ + μ cosθ)；防下滑維持平衡 P_down = W(sinθ - μ cosθ)！"
        }
      ],
      "illustrations": [
      ...
      "practices": [
        ...
        },
        {
          ...
          "steps": [
            "水平推動：N = W = 500 N，P_min = fs_max = μs N = 0.4 × 500 = 200 N。",
            "斜向 30° 拉動：列出平衡方程式：\n- ∑Fy = N + P_pull sin(30°) - 500 = 0 ⇒ N = 500 - 0.5 P_pull。\n- ∑Fx = P_pull cos(30°) - fs_max = 0 ⇒ P_pull cos(30°) = μs (500 - 0.5 P_pull)。",
            "代入數值：0.866 P_pull = 0.4 × (500 - 0.5 P_pull) = 200 - 0.2 P_pull。",
            "1.066 P_pull = 200 ⇒ P_pull = 200 / 1.066 ≒ 187.6 N。"
          ],
        ...
        },
        {
          ...
          "steps": [
            "歐拉纜繩摩擦公式：T2 = T1 · e^(μ · β)。",
            "代入 β = π ≒ 3.1416，μ = 0.2：",
            "μ · β = 0.2 × 3.1416 = 0.6283。",
            "e^(0.6283) ≒ 1.8745。",
            "T2 = 100 × 1.8745 ≒ 187.5 N。"
          ],
          "answer": "T2 ≒ 187.5 N",
          "hints": [
            "分析題目核心條件與工程力學規範/定理",
    ...
    },
    {
      ...
      "examHitRate": 4,
      "step0Prerequisites": [
        "桁架三大假設：構件均為二力桿（僅受軸向拉/壓力）、節點均為理想無摩擦鉸接、載重僅施加於節點上",
        "靜定判定條件：m + r = 2j（m 為桿件數，r 為支承反力數，j 為節點數）",
        "節點法 (∑Fx = 0, ∑Fy = 0) 與剖面法 (∑M = 0, ∑Fy = 0)"
      ],
      "fatalTraps": [
        {
          "wrongThinking": "看到節點有兩桿成一直線、第三桿非共線，不論該節點有無外力，就直接斷定第三桿為零桿。",
          "correctThinking": "零桿判定第一準則前提為「該節點無外力且無支承反力」！若該節點受有外載重或反力，第三桿必受力以平衡外力，絕非零桿。",
          "trapDescription": "忽略「節點無外力」之先決條件，誤判零桿導致後續桿件內力連環算錯。"
        },
        {
          "wrongThinking": "使用剖面法求指定桿件內力時，切斷四根以上且作用線不共點的桿件。",
          "correctThinking": "剖面法僅有三個獨立平衡方程式 (∑Fx = 0, ∑Fy = 0, ∑M = 0)，切割截面最多只能切斷三根未知桿件；若切斷四根以上將無法直接求解。",
          "trapDescription": "剖面切割桿件數超標，引入過多未知數導致方程式無法封閉求解。"
        }
      ],
      "eliteMentalModels": [
        {
          "technique": "零桿三大幾何目視快篩法 (Zero-Force Member T/L/K Rules)",
          "explanation": "(1) 兩桿共節點且無外力：兩桿均為零桿；(2) 三桿共節點、兩桿成一直線且無外力：非共線第三桿必為零桿；(3) 四桿成兩對共線且無外力：各對向桿內力相等。剖面法取距交點 ∑M_O = 0 一式秒殺指定桿件。"
        }
      ],
      "covered_question_ids": [
        "111-1-8",
      ...
      "worked_examples": [
        {
          ...
          "commonMistake": "容易在正負號方向、單位換算 (如 MPa = N/mm²) 或圖例符號代入時產生計算失誤。",
          "eliteShortcut": "桁架速解心法：先用 T 型與 L 型節點準則目視秒殺零桿；求特定內部桿件內力時直接以剖面法取矩求解。"
        },
        {
          "question": "【統測截面法求桁架桿件軸力經典例題】某 Pratt 鋼桁架跨度 L = 12 m、高度 h = 3 m，由 A、B、C、D、E 節點組成。在中央頂點 D 承受一向下集中載重 P = 60 kN。試求中央上弦桿 BD 之桿件軸力大小及受力狀態（拉力或壓力）。",
          "difficulty": "進階",
          "steps": [
            "步驟 1：求解支承反力。系統左右對稱，向下總載重 P = 60 kN，由對稱性得 A、E 端反力 R_A = R_E = P / 2 = 30 kN (向上)。 ｜為什麼：對稱結構外力居中，支承反力各半。",
            "步驟 2：選定切割剖面 1-1。通過上弦桿 BD、斜腹桿 CD 及下弦桿 AC 切開桁架，取左側隔離體分析。 ｜為什麼：截面法每次切割不超過 3 根未知桿件，可直接列平衡方程式求解。",
            "步驟 3：選取最佳取矩點求解 F_BD。觀察未知力 F_CD 與 F_AC 皆交會於下弦節點 C，對節點 C 取力矩平衡 ∑M_C = 0 (逆時針為正 +)。 ｜為什麼：取矩於兩未知力交點，直接消去 F_CD 與 F_AC，一條方程式即可解出 F_BD。",
            "步驟 4：列力矩方程式並求解。假設 F_BD 為拉力 (向右)。∑M_C = 0 ⇒ - R_A × 6 + F_BD × 3 = 0 ⇒ 3 F_BD = 30 × 6 = 180 ⇒ F_BD = 60 kN (若為向左之壓力，則反力矩為順時針平衡，故 F_BD = -60 kN，即 60 kN 壓力)。 ｜為什麼：簡支梁受向下外力時，上弦桿必受壓 (C)，下弦桿必受拉 (T)。"
          ],
          "answer": "F_BD = 60 kN (受壓, C)",
          "hints": [
            "截面法取矩點選在「其餘兩未知桿之交點」",
            "簡支桁架上弦受壓 (C)、下弦受拉 (T)"
          ],
          "commonMistake": "拉壓符號混淆（誤將上弦受壓算成受拉），或取矩時忘記乘截面高度 h = 3 m。",
          "eliteShortcut": "等效彎矩法秒殺：跨中等效彎矩 M = R_A × 6 = 180 kN·m，上弦軸力 F_BD = M / h = 180 / 3 = 60 kN (壓)，5 秒直接心算完成！"
        }
      ],
      "illustrations": [
        "truss-context.webp",
    ...
    },
    {
      ...
      "examHitRate": 4,
      "step0Prerequisites": [
        "微積分微分與積分關係：w(x) = -dV/dx，dM/dx = V(x)",
        "剪力圖與彎矩圖關係：彎矩圖任兩點之差值 ΔM = ∫ V(x)dx（剪力圖面積）",
        "梁的最大彎矩 Mmax 必發生在剪力為零 (V = 0) 或剪力符號改變（過零點）的位置"
      ],
      "fatalTraps": [
        {
          "wrongThinking": "繪製剪力圖遇到集中力矩時，剪力圖產生突波跳躍。",
          "correctThinking": "集中力矩 M₀ 僅會在「彎矩圖 (BMD)」產生數值垂直突波（順時針向上或向下依約定），剪力圖 (SFD) 僅在受到「垂直集中力」時才會產生突變！",
          "trapDescription": "混淆集中力矩與集中力對剪力圖與彎矩圖之影響特徵。"
        },
        {
          "wrongThinking": "懸臂梁自由端受向下集中力時，誤將固定端彎矩符號寫為正彎矩（使梁下凹變形）。",
          "correctThinking": "懸臂梁在向下載重下梁頂受拉、梁底受壓，截面產生負彎矩（凸形變形）；正負號判別必須依據「上拉下壓為負、上壓下拉為正」之工程標準。",
          "trapDescription": "梁內力正負號約定混淆，造成配筋受拉區誤判的重大工程隱患。"
        }
      ],
      "eliteMentalModels": [
        {
          "technique": "微積分幾何面積連鎖繪圖模型 (Calculus Area Integration Method)",
          "explanation": "載重圖面積 = 剪力圖增量；剪力圖面積 = 彎矩圖增量。剪力線斜率看載重強度，彎矩線斜率看剪力數值；剪力過零處斜率為零，彎矩必達極值 (Mmax)，三圖對齊一氣呵成。"
        }
      ],
      "covered_question_ids": [
        "111-1-1",
      ...
      "worked_examples": [
        {
          "question": "【步驟化例題】簡支梁集中載重最大彎矩：跨距 L = 10 m 的簡支梁，承受中央集中載重 P = 40 kN，求最大彎矩 M_max。",
          "difficulty": "基礎",
          "steps": [
            "步驟 1：求支承反力。因對稱，兩端反力 R_A = R_B = P / 2 = 20 kN (向上)。 ｜為什麼：結構左右對稱且外力居中，支承反力各半。",
            "步驟 2：繪製剪力圖 (SFD)。左半跨剪力為 +20 kN，跨中集中載重使剪力突降 40 kN 變為 -20 kN，右半跨為 -20 kN。 ｜為什麼：集中載重作用點處剪力圖發生等值向下跳躍。",
            "步驟 3：計算最大正彎矩。剪力由正變負之剪力零點位於跨中 (x = 5 m)，彎矩極值 M_max = 左半跨剪力圖矩形面積 = 20 kN × 5 m = 100 kN·m（或直接套公式 M_max = PL/4 = 40 × 10 / 4 = 100 kN·m）。 ｜為什麼：彎矩圖之增量等於剪力圖之定積分面積，剪力為零處彎矩達到極值。"
          ],
          "answer": "最大正彎矩 M_max = 100 kN·m (發生於跨中 x = 5 m)",
          "hints": [
            "簡支梁中央集中載重公式：M_max = PL / 4",
            "剪力為 0 處對應彎矩極值"
          ],
          "commonMistake": "容易在正負號方向、單位換算 (如 MPa = N/mm²) 或圖例符號代入時產生計算失誤。",
          "eliteShortcut": "靜定梁繪圖心法：載重圖面積為剪力差、剪力圖面積為彎矩差；剪力過零處斜率為零，彎矩必達極值。"
        },
        {
          "question": "【統測懸臂梁複合載重例題】一長 L = 4 m 之懸臂梁，左端 A 為固定端，右端 B 為自由端。全跨受均布向下載重 w = 15 kN/m，自由端受一集中向下載重 P = 20 kN。試求解：(1) 固定端 A 之垂直支承反力 R_A；(2) 固定端 A 之最大負彎矩 M_max。",
          "difficulty": "統測核心",
          "steps": [
            "步驟 1：由垂直力平衡求固定端反力 R_A。∑F_y = 0 ⇒ R_A - (w · L) - P = 0 ⇒ R_A = (15 × 4) + 20 = 60 + 20 = 80 kN (向上)。 ｜為什麼：固定端垂直反力承擔懸臂梁上全部豎向載重。",
            "步驟 2：由固定端力矩平衡求解固定端反力矩 M_A。∑M_A = 0 ⇒ M_A - (w · L) × (L / 2) - P · L = 0 ⇒ M_A = (15 × 4) × 2 + 20 × 4 = 120 + 80 = 200 kN·m (逆時針抗力矩)。 ｜為什麼：均布載重等值力 60 kN 位於距固定端 2 m 處，自由端力 20 kN 位於距固定端 4 m 處。",
            "步驟 3：判定彎矩正負號與最大彎矩。懸臂梁在向下載重作用下，梁頂受拉、梁底受壓，依力學正負號約定為「負彎矩」，最大負彎矩發生於固定端 M_max = -200 kN·m。 ｜為什麼：懸臂梁上表面受拉為負彎矩，自由端彎矩為 0，固定端彎矩絕對值最大。"
          ],
          "answer": "(1) 固定端反力 R_A = 80 kN (向上)；(2) 最大負彎矩 M_max = -200 kN·m (發生於固定端)",
          "hints": [
            "懸臂梁均布載重彎矩公式：wL² / 2",
            "懸臂梁集中載重彎矩公式：P · L",
            "兩者疊加：M_fixed = - (wL²/2 + PL)"
          ],
          "commonMistake": "極高頻陷阱：均布載重力矩算成 wL²/8（那是簡支梁跨中正彎矩公式，懸臂梁固定端力臂為 L/2，公式為 wL²/2）！",
          "eliteShortcut": "懸臂秒殺疊加法：均布 (15 × 16 / 2 = 120) + 集中 (20 × 4 = 80) = 200 kN·m (負彎矩)，10 秒寫出答案！"
        },
        {
          "question": "【統測外伸梁反彎點例題】外伸梁 ABC 全長 8 m，A 點 (x=0) 為鉸支承，B 點 (x=6m) 為滾支承，BC 段為 2 m 懸臂段。在自由端 C 點受向下集中載重 P = 30 kN，跨度 AB 段 (0~6m) 受均布向下載重 w = 10 kN/m。試求解：(1) B 點支承反力 R_B；(2) 跨內正彎矩最大值 M_pos；(3) 懸臂根部 B 點之負彎矩 M_B。",
          "difficulty": "進階",
          "steps": [
            "步驟 1：對 A 點取力矩求解 B 端反力 R_B。∑M_A = 0 ⇒ (10 × 6) × 3 + 30 × 8 - 6 R_B = 0 ⇒ 180 + 240 - 6 R_B = 0 ⇒ 6 R_B = 420 ⇒ R_B = 70 kN (向上)。 ｜為什麼：均布載重等值力 60 kN 位於 3 m 處，自由端力 30 kN 位於 8 m 處。",
            "步驟 2：由垂直平衡求 A 端反力 R_A。∑F_y = 0 ⇒ R_A + R_B - (10 × 6) - 30 = 0 ⇒ R_A + 70 - 90 = 0 ⇒ R_A = 20 kN (向上)。 ｜為什麼：系統垂直合力為零。",
            "步驟 3：求 AB 跨內剪力為零點與最大正彎矩。剪力方程式 V(x) = R_A - w · x = 20 - 10 x。令 V(x) = 0 ⇒ x = 2 m。剪力圖三角形面積 M_pos = (1/2) × 2 m × 20 kN = 20 kN·m。 ｜為什麼：跨內最大正彎矩位於剪力為零處 (x = 2 m)。",
            "步驟 4：從右側自由端 C 向左求 B 點彎矩。M_B = - P × 2 m = - 30 × 2 = -60 kN·m。 ｜為什麼：外伸懸臂段受端點載重，B 點彎矩直接由右向左切開計算，無需考慮左側反力。"
          ],
          "answer": "(1) R_B = 70 kN (向上), R_A = 20 kN (向上)；(2) 最大正彎矩 M_pos = 20 kN·m (在 x = 2 m 處)；(3) B 點負彎矩 M_B = -60 kN·m",
          "hints": [
            "外伸端負彎矩直接由自由端回推：M_B = - P · L_cantilever",
            "跨內剪力為 0 處對應正彎矩極值"
          ],
          "commonMistake": "求 B 點負彎矩時從左側一路積分，容易因反力小數點計算繁複而算錯，從右側懸臂端回推只需一步！",
          "eliteShortcut": "外伸梁局部秒殺法：懸臂端 B 點負彎矩直接心算 M_B = -30 × 2 = -60 kN·m，秒殺 50% 題目！"
        }
      ],
      "illustrations": [
        "beam-context.webp",
      ...
      "concepts": [
        ...
        },
        {
          ...
          "diagram": {
            "title": "簡支梁集中載重剪力圖 (SFD) 與彎矩圖 (BMD) 微分面積連鎖對應",
            "caption": "剪力面積 ΔM = ∫V dx，剪力過零點 (V=0) 處彎矩達最大值 M_max = PL/4",
            "svg": "<svg viewBox='0 0 540 200' className='w-full h-auto' fill='none' xmlns='http://www.w3.org/2000/svg'><rect x='40' y='20' width='300' height='8' fill='#94a3b8'/><polygon points='40,28 32,42 48,42' fill='#0d9488'/><polygon points='340,28 332,40 348,40' fill='#0d9488'/><circle cx='336' cy='43' r='2' fill='#0f766e'/><circle cx='344' cy='43' r='2' fill='#0f766e'/><line x1='190' y1='2' x2='190' y2='18' stroke='#e11d48' stroke-width='2'/><polygon points='190,18 186,10 194,10' fill='#e11d48'/><text x='190' y='-1' fill='#be123c' font-size='9' font-family='monospace' font-weight='bold' text-anchor='middle'>P=40kN</text><line x1='40' y1='85' x2='340' y2='85' stroke='#94a3b8' stroke-width='1'/><polygon points='40,85 40,65 190,65 190,85' fill='rgba(37,99,235,0.15)' stroke='#2563eb' stroke-width='1.5'/><polygon points='190,85 190,105 340,105 340,85' fill='rgba(225,29,72,0.15)' stroke='#e11d48' stroke-width='1.5'/><text x='115' y='78' fill='#1d4ed8' font-size='9' font-family='monospace' font-weight='bold' text-anchor='middle'>+V = +20 kN</text><text x='265' y='98' fill='#be123c' font-size='9' font-family='monospace' font-weight='bold' text-anchor='middle'>-V = -20 kN</text><text x='350' y='88' fill='#64748b' font-size='9' font-family='monospace'>SFD</text><line x1='40' y1='145' x2='340' y2='145' stroke='#94a3b8' stroke-width='1'/><polygon points='40,145 190,185 340,145' fill='rgba(147,51,234,0.15)' stroke='#9333ea' stroke-width='2'/><text x='190' y='178' fill='#7e22ce' font-size='9' font-family='monospace' font-weight='bold' text-anchor='middle'>M_max = +100 kN·m (PL/4)</text><text x='350' y='148' fill='#64748b' font-size='9' font-family='monospace'>BMD</text><circle cx='190' cy='85' r='3' fill='#f59e0b'/><text x='198' y='82' fill='#d97706' font-size='8' font-family='monospace' font-weight='bold'>V=0</text></svg>"
          }
        },
        {
        ...
        },
        {
          ...
          "body": "在結構力學中，掌握經典載重模式（如簡支梁均佈載重 M_max = wL²/8、中央集中載重 M_max = PL/4、懸臂梁 M_max = wL²/2）之解析閉合解，能讓工程師在不用重繪完整剪力彎矩圖的情況下，迅速判定危險斷面之最大應力，並作為結構梁斷面配筋與型鋼初估尺寸的核心依據。",
          "table": {
            "headers": [
              "載重與樑類型",
              "最大剪力 (V_max)",
      ...
      "practices": [
        ...
        },
        {
          ...
          "steps": [
            "固定端剪力 V_max = (w · L) + P = (15 × 4) + 20 = 60 + 20 = 80 kN。",
            "固定端彎矩 M_max = - [ (w · L²) / 2 + P · L ] = - [ (15 × 4²) / 2 + 20 × 4 ] = - [ 120 + 80 ] = - 200 kN·m。"
          ],
        ...
        },
        {
          ...
          "steps": [
            "集中載重 M_max = (P · L) / 4 = (120 × 6) / 4 = 180 kN·m。",
            "改為均佈載重：M_max = (w · L²) / 8 = 180 ⇒ (w × 6²) / 8 = 180 ⇒ 36 w / 8 = 180 ⇒ 4.5 w = 180 ⇒ w = 40 kN/m。"
          ],
    ...
    },
    {
      ...
      "worked_examples": [
        {
          "question": "【步驟化例題】鋼筋軸向拉應力與伸長量：一根直徑 16 mm (截面積 A ≒ 201 mm²)、長度 L = 2 m 之鋼筋，彈性模數 E = 200 GPa，承受軸向拉力 P = 50 kN。試求解：(1) 鋼筋內部之軸向正應力 σ；(2) 鋼筋之總伸長變形量 ΔL。",
          "difficulty": "統測核心",
          "steps": [
            "步驟 1：單位換算與正應力計算。P = 50 kN = 50,000 N，截面積 A ≒ 201.06 mm²。正應力 σ = P / A = 50,000 / 201.06 ≒ 248.7 N/mm² (MPa)。 ｜為什麼：正應力定義為軸向內力除以垂直截面積。",
            "步驟 2：換算彈性模數與長度。E = 200 GPa = 200,000 MPa (N/mm²)，長度 L = 2 m = 2000 mm。 ｜為什麼：計算應變量時長度必須與應力使用同一長度單位 (mm)。",
            "步驟 3：應用虎克定律求軸向伸長量 ΔL。ΔL = (P · L) / (A · E) = (50,000 × 2000) / (201.06 × 200,000) = 100,000,000 / 40,212,000 ≒ 2.487 mm。 ｜為什麼：一維虎克定律在彈性限度內滿足 ΔL = PL / AE。"
          ],
          "answer": "(1) 正應力 σ ≒ 248.7 MPa (拉)；(2) 總伸長量 ΔL ≒ 2.49 mm",
          "hints": [
            "正應力公式：σ = P / A",
            "伸長量公式：ΔL = PL / (AE)",
            "注意 GPa = 10³ MPa = 10³ N/mm²"
          ],
          "commonMistake": "容易在正負號方向、單位換算 (如 MPa = N/mm²) 或圖例符號代入時產生計算失誤。",
          "eliteShortcut": "應力應變核心心法：統一單位為 N 與 mm (MPa)；變形量 δ = PL/(AE) 直接用剛度比或柔度比心算。"
        },
        {
          "question": "【統測受阻熱應力經典例題】一長度 L = 3 m 之實心結構鋼柱，截面積 A = 2500 mm²，鋼材線膨脹係數 α = 1.2 × 10⁻⁵ /°C，彈性模數 E = 200 GPa。兩端完全被剛性剛壁夾緊固定（無任何伸縮間隙）。若環境溫度上升 ΔT = 40 °C，試求解：(1) 鋼柱因受阻而產生之熱應力 σ_T 大小與受力性質（受拉或受壓）；(2) 兩端剛壁承受之熱推力 P_T。",
          "difficulty": "進階",
          "steps": [
            "步驟 1：分析自由熱膨脹量與拘束協調條件。若自由膨脹，鋼柱伸長 ΔL_th = α · ΔT · L；因兩端剛性固定，總變形量必須為零 (ΔL_total = 0)，故剛壁對鋼柱施加等值壓縮變形 ΔL_mech = (P · L) / (A · E) 予以抵消。 ｜為什麼：熱應力產生的先決條件是「熱膨脹變形受到外部幾何約束拘束」。",
            "步驟 2：推導受阻熱應力公式並計算數值。由 α · ΔT · L = (σ_T / E) · L 可消去長度 L，得 σ_T = E · α · ΔT = (200 × 10³ MPa) × (1.2 × 10⁻⁵ /°C) × 40 °C = 200,000 × 0.00048 = 96 MPa。 ｜為什麼：完全受阻桿件之熱應力與桿件長度 L 無關，僅由 E、α 與 ΔT 決定！",
            "步驟 3：判別受力性質與剛壁推力。溫度上升使材料欲膨脹，兩端受壓迫，故為「壓應力 (Compression)」。剛壁推力 P_T = σ_T · A = 96 N/mm² × 2500 mm² = 240,000 N = 240 kN。 ｜為什麼：壓應力乘以截面積等於壁面承受之軸向擠壓力。"
          ],
          "answer": "(1) 熱應力 σ_T = 96 MPa (受壓)；(2) 剛壁推力 P_T = 240 kN",
          "hints": [
            "熱應力公式：σ_T = E · α · ΔT (與長度 L 無關)",
            "溫度「上升」產生「壓應力」，溫度「下降」產生「拉應力」"
          ],
          "commonMistake": "極高頻陷阱：誤將長度 L 代入熱應力公式計算，或將溫度上升產生的應力誤判為拉應力！",
          "eliteShortcut": "熱應力秒殺公式：σ_T = E·α·ΔT = 200,000 × 1.2e-5 × 40 = 96 MPa (溫升必受壓)，5 秒直接心算！"
        },
        {
          "question": "【統測分段軸力與階梯桿變形例題】一由銅段與鋁段組成的階梯圓桿，兩端自由。銅段長 L₁ = 1 m、截面積 A₁ = 400 mm²、E₁ = 100 GPa；鋁段長 L₂ = 1.5 m、截面積 A₂ = 200 mm²、E₂ = 70 GPa。在銅段左端受向左拉力 P₁ = 40 kN，在銅鋁交接處受向右力 P₂ = 10 kN，在鋁段右端受向右拉力 P₃ = 30 kN (整體處於平衡)。試求：(1) 銅段與鋁段內部各自之軸向內力；(2) 該階梯桿之總伸長量 ΔL_total。",
          "difficulty": "進階",
          "steps": [
            "步驟 1：分段切開求軸力。取銅段切開分析，內力 N₁ = 40 kN (拉力為正 +40 kN)；取鋁段切開分析，內力 N₂ = 30 kN (拉力為正 +30 kN)。 ｜為什麼：由自由端分別向內切開，各段軸力等於該側所有外力代數和。",
            "步驟 2：計算銅段伸長量 ΔL₁。ΔL₁ = (N₁ · L₁) / (A₁ · E₁) = (40,000 × 1000) / (400 × 100,000) = 40,000,000 / 40,000,000 = 1.0 mm。 ｜為什麼：各分段變形量適用個別截面尺寸與彈性模數。",
            "步驟 3：計算鋁段伸長量 ΔL₂。ΔL₂ = (N₂ · L₂) / (A₂ · E₂) = (30,000 × 1500) / (200 × 70,000) = 45,000,000 / 14,000,000 ≒ 3.214 mm。 ｜為什麼：鋁段材料與截面獨立變形。",
            "步驟 4：疊加求解總伸長量。ΔL_total = ΔL₁ + ΔL₂ = 1.0 + 3.214 = 4.214 mm。 ｜為什麼：軸向串聯桿件之總變形量等於各分段變形量之代數和。"
          ],
          "answer": "(1) 銅段軸力 N₁ = 40 kN (拉), 鋁段軸力 N₂ = 30 kN (拉)；(2) 總伸長量 ΔL_total ≒ 4.21 mm",
          "hints": [
            "分段畫出軸力圖 (AFD)",
            "總變形量 ΔL = ∑ (N_i · L_i) / (A_i · E_i)"
          ],
          "commonMistake": "誤將交接處外力 10 kN 直接算在整個系統上，忽略了不同分段軸力不同。",
          "eliteShortcut": "分段軸力秒殺：左側拉 40、右側拉 30，銅段軸力就是 40 kN，鋁段軸力就是 30 kN！"
        }
      ],
      "illustrations": [
      ...
      "practices": [
        ...
        },
        {
          ...
          "steps": [
            "P = 100,000 N, L = 2,000 mm, A = 500 mm², E = 200,000 N/mm²。",
            "δ = (P · L) / (A · E) = (100,000 × 2,000) / (500 × 200,000) = 2.0 mm。",
            "應變 ε = δ / L = 2.0 / 2,000 = 0.001 (或 1 × 10⁻³)。"
          ],
        ...
        },
        {
          ...
          "steps": [
            "熱應力公式：σ_T = E · α · ΔT。",
            "代入數值：σ_T = (200,000 MPa) × (1.2 × 10⁻⁵) × 50 = 200,000 × 0.0006 = 120 MPa。",
            "因為溫度上升受兩端固定限制膨脹，故產生壓應力 (Compression)。"
          ],
    ...
    },
    {
      ...
      "examHitRate": 4,
      "step0Prerequisites": [
        "空間向量方向餘弦：λx = cosα, λy = cosβ, λz = cosγ，滿足 cos²α + cos²β + cos²γ = 1",
        "空間力向量表徵：F = F(λx i + λy j + λz k)",
        "空間力矩計算：M_O = r × F 行列式運算",
        "空間剛體平衡六大方程式：∑Fx = 0, ∑Fy = 0, ∑Fz = 0, ∑Mx = 0, ∑My = 0, ∑Mz = 0"
      ],
      "fatalTraps": [
        {
          "wrongThinking": "計算位置向量 r_AB 時，將「起點座標減去終點座標」。",
          "correctThinking": "位置向量 r_AB 永遠是「終點座標減去起點座標」：r_AB = (xB - xA)i + (yB - yA)j + (zB - zA)k。",
          "trapDescription": "位置向量頭尾顛倒，導致所有力矩方向外積結果正負號全部相反。"
        },
        {
          "wrongThinking": "計算空間某軸之投影力矩時，直接將該力與軸的空間斜距相乘。",
          "correctThinking": "空間對軸之力矩必須先求對軸上一點之力矩向量 M_O = r × F，再將 M_O 與該軸之單位向量 u 取內積：M_L = M_O · u；若力與軸平行或相交，對該軸之矩必為零。",
          "trapDescription": "空間力矩幾何概念薄弱，忽略「力與軸平行或相交時對該軸力矩為零」的重要力學特性。"
        }
      ],
      "eliteMentalModels": [
        {
          "technique": "空間三軸投影片區投影法 (Orthogonal Axis View Projection)",
          "explanation": "空間力系求解時，優先選取包含未知力最多的軸線取力矩方程式 (∑M_L = 0)，因通過該軸或與該軸平行的未知力對軸力矩均為零，可直接消去 3~4 個未知數，單一方程式直接解出目標未知力。"
        }
      ],
      "covered_question_ids": [
        "110-1-5",
      ...
      "worked_examples": [
        {
          ...
          "commonMistake": "容易在正負號方向、單位換算 (如 MPa = N/mm²) 或圖例符號代入時產生計算失誤。",
          "eliteShortcut": "空間力系求解心法：以終點減起點建立位置向量與單位向量；選未知力最多的軸線取矩直接消去未知數。"
        },
        {
          "question": "【統測空間共點力系平衡例題】一重物 W = 1200 N 懸掛於頂點 P(0, 0, 4) m。由三根對稱配置之鋼索 PA、PB、PC 懸吊於地面。地面三錨定點分別為 A(3, 0, 0)、B(-1.5, 2.598, 0)、C(-1.5, -2.598, 0)（三錨定點在水平面成正三角形，距原點半徑均為 3 m）。試求解各鋼索所承受之軸向拉力 T。",
          "difficulty": "進階",
          "steps": [
            "步驟 1：計算每根鋼索長度 L。L = √(3² + 0² + 4²) = √(9 + 16) = √25 = 5 m。 ｜為什麼：三維空間距離公式 d = √(Δx² + Δy² + Δz²)。",
            "步驟 2：分析鋼索垂直方向分力比例。每根鋼索之垂直 Z 軸分力 F_z = T × (Δz / L) = T × (4 / 5) = 0.8 T。 ｜為什麼：三鋼索在水平 X-Y 面對稱分布，水平分力自然相互抵消平衡。",
            "步驟 3：列出空間 Z 軸靜力平衡方程式。∑F_z = 0 ⇒ 3 × (0.8 T) - W = 0 ⇒ 2.4 T = 1200 ⇒ T = 1200 / 2.4 = 500 N。 ｜為什麼：空間共點對稱系統，豎向合力由三根鋼索之垂直分量共同均分抵消重力 W。"
          ],
          "answer": "每根鋼索張力 T = 500 N",
          "hints": [
            "利用三維對稱性簡化水平力平衡",
            "每根鋼索長度 3-4-5 直角三角形為 5 m",
            "垂直分力佔 4/5 = 0.8"
          ],
          "commonMistake": "誤將水平分量單獨列三元一次聯立方程，耗費大量時間，善用對稱性可直接由 Z 軸一式秒殺！",
          "eliteShortcut": "對稱三腳架秒殺法：T = W / (3 × cos γ_z) = 1200 / (3 × 0.8) = 500 N，10 秒搞定！"
        }
      ],
      "illustrations": [
        "units-vectors-context.webp",
    ...
    },
    {
      ...
      "examHitRate": 4,
      "step0Prerequisites": [
        "平面應力轉換方程式：σx' = (σx + σy)/2 + ((σx - σy)/2)cos2θ + τxy·sin2θ",
        "莫耳圓中心與半徑：中心座標 C = ((σx + σy)/2, 0)，半徑 R = √(((σx - σy)/2)² + τxy²)",
        "主應力公式：σ₁,₂ = (σx + σy)/2 ± R；最大剪應力 τmax = R = (σ₁ - σ₂)/2"
      ],
      "fatalTraps": [
        {
          "wrongThinking": "在實體單元中旋轉 θ 角度，在莫耳圓上也只旋轉 θ 角度找新應力點。",
          "correctThinking": "莫耳圓的角度為實體單元的「兩倍角 (2θ)」！實體單元逆時針旋轉 θ 度，莫耳圓上應由參考點沿同向旋轉 2θ 度。",
          "trapDescription": "忽略實體與莫耳圓之兩倍角幾何對應關係，角度算錯一半導致計算結果全毀。"
        },
        {
          "wrongThinking": "求三維最大剪應力時，直接認定 τmax = (σ₁ - σ₂)/2，忽略面外應力 σ₃ = 0 之存在。",
          "correctThinking": "在平面應力狀態下，垂直於板面的主應力 σ₃ = 0；若 σ₁ 與 σ₂ 同為拉應力 (均大於 0)，則真正絕對最大剪應力為 τmax,abs = (σ₁ - 0)/2 = σ₁/2。",
          "trapDescription": "統測試題常出同號主應力的最大剪應力陷阱題，考生漏檢驗面外 σ₃=0 而失分。"
        }
      ],
      "eliteMentalModels": [
        {
          "technique": "莫耳圓圓心半徑直觀幾何模型 (Mohr Circle Geometry Shortcut)",
          "explanation": "莫耳圓橫軸為正應力 σ，縱軸為剪應力 τ。解題三步：(1) 定圓心 C = (σx+σy)/2；(2) 算半徑 R = √(Δσ² + τ²)；(3) 主應力立即為 C ± R，主剪應力即為 R。幾何直球秒殺，免背繁瑣三角函數代數公式。"
        }
      ],
      "covered_question_ids": [
        "110-1-15",
      ...
      "worked_examples": [
        {
          ...
          "difficulty": "基礎",
          "steps": [
            "步驟 1：求莫耳圓圓心 C。σ_avg = (σx + σy) / 2 = (80 + 20) / 2 = 50 MPa。圓心座標 C(50, 0)。",
            "步驟 2：求莫耳圓半徑 R（兼最大剪應力 τmax）。R = √[((σx - σy) / 2)² + τxy²] = √[((80 - 20) / 2)² + 40²] = √[30² + 40²] = √[900 + 1600] = √2500 = 50 MPa。",
            "步驟 3：計算主應力 σ1, σ2。σ1 = σ_avg + R = 50 + 50 = 100 MPa (拉)；σ2 = σ_avg - R = 50 - 50 = 0 MPa；平面最大剪應力 τmax = R = 50 MPa。"
          ],
          ...
          "commonMistake": "容易在正負號方向、單位換算 (如 MPa = N/mm²) 或圖例符號代入時產生計算失誤。",
          "eliteShortcut": "莫耳圓秒殺心法：圓心橫座標為 (σx+σy)/2，半徑為 √((Δσ/2)²+τ²)；主應力即為圓心加減半徑。"
        },
        {
          "question": "【統測主應力方向角與純剪切例題】某鋼構件在一點處之應力狀態為：σ_x = 60 MPa (拉), σ_y = -20 MPa (壓), τ_xy = 30 MPa。試求解：(1) 主應力平面之方向角 2θ_p；(2) 最大主應力 σ₁ 與最小主應力 σ₂ 之大小。",
          "difficulty": "進階",
          "steps": [
            "步驟 1：計算主應力旋轉角公式 tan(2θ_p)。tan(2θ_p) = (2 · τ_xy) / (σ_x - σ_y) = (2 × 30) / (60 - (-20)) = 60 / 80 = 0.75。 ｜為什麼：主應力平面上剪應力為零，對應莫耳圓與水平軸交點。",
            "步驟 2：求旋轉角 θ_p。2θ_p = tan⁻¹(0.75) ≒ 36.87° ⇒ θ_p1 ≒ 18.43°，θ_p2 = θ_p1 + 90° = 108.43°。 ｜為什麼：兩相互正交之主平面在實體中相差 90°，在莫耳圓中相差 180°。",
            "步驟 3：計算平均應力與莫耳圓半徑 R。σ_avg = (60 + (-20)) / 2 = 20 MPa；R = √[((60 - (-20))/2)² + 30²] = √[40² + 30²] = 50 MPa。 ｜為什麼：3-4-5 直角三角形特性速算半徑 R = 50 MPa。",
            "步驟 4：求主應力大小。σ₁ = σ_avg + R = 20 + 50 = 70 MPa (拉)；σ₂ = σ_avg - R = 20 - 50 = -30 MPa (壓)。 ｜為什麼：主應力為莫耳圓最右端與最左端之正應力值。"
          ],
          "answer": "(1) 2θ_p ≒ 36.87° (θ_p ≒ 18.43°)；(2) σ₁ = 70 MPa (拉), σ₂ = -30 MPa (壓)",
          "hints": [
            "tan(2θ_p) = 2τ_xy / (σ_x - σ_y)",
            "注意 σ_y 為壓應力時代入負值 (-20 MPa)"
          ],
          "commonMistake": "分母計算 (σ_x - σ_y) 時忘記負負得正 (60 - (-20) = 80)，誤算為 60 - 20 = 40！",
          "eliteShortcut": "莫耳圓 3-4-5 秒殺：(σ_x - σ_y)/2 = 40, τ = 30，半徑 R 必為 50，σ₁ = 20 + 50 = 70，心算即得！"
        }
      ],
      "illustrations": [
        "units-vectors-context.webp",
