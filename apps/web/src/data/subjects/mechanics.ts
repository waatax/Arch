      ...
      "worked_examples": [
        {
          ...
          "difficulty": "統測核心",
          "steps": [
            "步驟 1：計算螺栓單個剪切截面積。<span className=\"text-rose-600 font-bold\">A = π · d² / 4 = π × 10² / 4 ≒ 78.54 mm²</span>。 ｜為什麼：依據工程力學核心規範與力學幾何定理演算。",
            "步驟 2：換算剪力單位並代入公式。V = 12 kN = 12,000 N，<span className=\"text-indigo-600 font-bold\">τ_avg = V / A = 12000 / 78.54 ≒ 152.8 N/mm² (MPa)</span>。 ｜為什麼：依據工程力學核心規範與力學幾何定理演算。"
          ],
