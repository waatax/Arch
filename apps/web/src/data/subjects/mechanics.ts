  ...
  "topics": [
    {
      ...
      covered_question_ids: ['111-1-4', '112-1-4', '113-1-6', '114-1-7', '115-1-6'],
      concepts: [
        {
          ...
          table: {
            headers: ['結構破壞模式', '力學機制與破壞特徵', '真實經典災難案例', '防禦設計準則與關鍵公式'],
            rows: [
              ['受壓挫屈 (Euler Buckling)', '細長受壓構件失穩側向折斷，屬於無塑性預警之突發性破壞', '加拿大魁北克大橋懸臂桁架壓桿挫屈倒塌', '限制細長比 λ = KL/r；臨界載重 P_cr = π²EI/(KL)²'],
              ['剪力脆性破壞 (Shear Failure)', '主拉應力超過混凝土抗拉強度，形成 45° 交叉斜裂縫瞬間剪斷', '台灣 921 地震沿街騎樓軟弱底層 (Soft Story) 與短柱剪斷', '強剪弱彎原則；密排箍筋圍束 V_s ≥ (V_u/φ - V_c)'],
              ['動態氣動共振 (Flutter)', '卡門渦街頻率與結構自振頻率吻合產生共振放大', '美國塔科馬海峽吊橋 (Tacoma Narrows Bridge) 扭轉撕裂', '增加斷面開孔透風、設置調諧質量阻尼器 (TMD，如台北 101 風阻尼球)'],
              ['疲勞與應力集中 (Fatigue)', '反覆交變載重使幾何突變處微裂紋擴展並無預警斷裂', '橋樑鋼結構銲道與螺栓接頭疲勞破壞', '避免截面急遽變化，落實非破壞檢驗 (NDT)，設定安全係數 FS ≥ 1.5~2.0']
            ]
          }
        },
        {
      ...
      worked_examples: [
        ...
        },
        {
          ...
          difficulty: '進階',
          hints: ['柱側向剛度與高度三次方成反比 k ∝ 1/H³', '相同側移下剪力與剛度成正比'],
    ...
    },
    {
      ...
      "covered_question_ids": ["111-1-1", "112-1-1", "113-1-3", "114-1-3", "115-1-4"],
      "concepts": [
        {
          "heading": "等值合力與作用點",
      ...
      "worked_examples": [
        {
          ...
          "difficulty": "統測核心",
          "steps": [
            "步驟 1：求全跨等值集中力。<span className=\"text-rose-600 font-bold\">W = 4 × 6 = 24 kN</span>，作用於跨中 (x = 3 m)。 ｜為什麼：依據工程力學核心規範與力學幾何定理演算。",
            "步驟 2：由對稱性直接判定兩端反力。系統左右對稱，所以 <span className=\"text-indigo-600 font-bold\">R_A = R_B = W / 2 = 12 kN</span>。 ｜為什麼：依據工程力學核心規範與力學幾何定理演算。",
            "步驟 3：力矩檢核驗算。對 A 點取力矩 ∑M_A = 24 × 3 - R_B × 6 = 72 - 72 = 0，完全閉合平衡。 ｜為什麼：依據工程力學核心規範與力學幾何定理演算。"
          ],
    ...
    },
    {
      ...
      "covered_question_ids": ["111-1-15", "112-1-3", "113-1-4", "114-1-6", "115-1-2"],
      "concepts": [
        {
          "heading": "三個獨立平衡條件",
    ...
    },
    {
      ...
      "covered_question_ids": ["111-1-11", "112-1-10", "113-1-13", "114-1-12", "115-1-9"],
      "concepts": [
        {
          "heading": "直接剪應力",
      ...
      "worked_examples": [
        {
          ...
          "difficulty": "基礎",
          "steps": [
            "步驟 1：求莫耳圓圓心 C。σ_avg = (σx + σy) / 2 = (80 + 20) / 2 = 50 MPa。圓心座標 C(50, 0)。 ｜為什麼：依據工程力學核心規範與力學幾何定理演算。",
            "步驟 2：求莫耳圓半徑 R（兼最大剪應力 τmax）。R = √[((σx - σy) / 2)² + τxy²] = √[((80 - 20) / 2)² + 40²] = √[30² + 40²] = √[900 + 1600] = √2500 = 50 MPa。 ｜為什麼：依據工程力學核心規範與力學幾何定理演算。",
            "步驟 3：計算主應力 σ1, σ2。σ1 = σ_avg + R = 50 + 50 = 100 MPa (拉)；σ2 = σ_avg - R = 50 - 50 = 0 MPa；平面最大剪應力 τmax = R = 50 MPa。 ｜為什麼：依據工程力學核心規範與力學幾何定理演算。"
          ],
