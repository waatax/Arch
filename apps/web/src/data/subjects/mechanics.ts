  ...
  topics: [
    {
      ...
      practice: {
        difficulty: '基礎',
        question: '在平面笛卡兒座標系中，有一共點力系受到兩力作用：F1 = 60 N (方向沿正 +x 軸)，F2 = 80 N (方向沿正 +y 軸)。求合力大小 F_R 為何？',
        steps: [
          '∑Fx = 60 N, ∑Fy = 80 N',
          'F_R = √(60² + 80²) = √10000 = 100 N'
        ],
        answer: 'F_R = 100 N'
      }
    },
    {
      ...
      practice: {
        ...
        steps: [
          '繪製節點平衡之自由體圖，建立 x-y 座標系。',
          'TAx = -TA cos(30°), TBx = TB cos(60°) ⇒ TB = √3 TA。',
          'TA sin(30°) + TB sin(60°) = 100 ⇒ 0.5 TA + 1.5 TA = 100 ⇒ 2 TA = 100'
        ],
        answer: 'TA = 50 N'
      }
    },
    {
      ...
      practices: [
        ...
        {
          difficulty: '進階',
          question: '（臺北101巨柱算例簡化）承上題之對稱工字型截面 (翼板 200×20 mm，腹板 20×160 mm)，試利用平行軸定理求此截面對其中性軸 (過總形心 Y = 100 mm 之水平軸 X_bar) 的總慣性矩 Ix。',
          steps: [
            '總形心位置 Y_bar = 100 mm。對各基元分別求解對形心軸之慣性矩：',
            '【腹板 (中)】：自身 Ix2 = (b · h³) / 12 = (20 × 160³) / 12 = (20 × 4,096,000) / 12 = 6,826,666.67 mm⁴。\n- 腹板自身形心 y2 = 100 mm，與總形心重合，故距離 d2 = |100 - 100| = 0。\n- 腹板貢獻 Ix2_total = 6,826,666.67 mm⁴。',
            '【頂翼板 (上)】：自身 Ix1 = (b · h³) / 12 = (200 × 20³) / 12 = (200 × 8,000) / 12 = 133,333.33 mm⁴。\n- 頂翼板形心 y1 = 190 mm，距總形心距離 d1 = |190 - 100| = 90 mm。\n- 依平行軸定理：Ix1_total = Ix1 + A1 · d1² = 133,333.33 + 4000 × (90)² = 133,333.33 + 32,400,000 = 32,533,333.33 mm⁴。',
            '【底翼板 (下)】：與頂翼板完全對稱，自身 Ix3 = 133,333.33 mm⁴，d3 = |10 - 100| = 90 mm。\n- 底翼板貢獻 Ix3_total = 32,533,333.33 mm⁴。',
            '【總慣性矩 Ix】：Ix = Ix1_total + Ix2_total + Ix3_total = 32,533,333.33 + 6,826,666.67 + 32,533,333.33 = 71,893,333.33 mm⁴ ≒ 7.189 × 10⁷ mm⁴。'
          ],
    ...
    },
    {
      ...
      practice: {
        difficulty: '困難',
        question: '有一個 L 型的三桿桁架，節點 C 為直角，受到水平向右 10 kN 的外力。AC桿長 3m (直立)，BC桿長 4m (水平)。求斜桿 AB 的軸力？',
        steps: [
          'AB桿長 L_AB = √(3² + 4²) = 5m。',
          '由整體支承條件求解反力後，利用節點法或剖面法分析各桿內力。'
        ],
        answer: '需先解出支承反力再推導內力'
      }
    },
    {
      slug: 'beam',
    ...
    },
    {
      ...
      concepts: [
        ...
        {
          heading: '工程實例：臺北101巨柱鋼材 SN490 應力變形與高程預補償 (Pre-camber) 設計',
      ...
      practice: {
        ...
        steps: [
          ...
          'δ = (P L) / (A E) = (100,000 × 2,000) / (500 × 200,000) = 2 mm'
        ],
        answer: 'δ = 2 mm'
      }
    }
