      ...
      concepts: [
        {
          ...
          table: {
            headers: ['物理量', '國際標準單位 (SI)', '工程常用單位', '單位換算關係'],
            rows: [
              ['長度 (Length, L)', 'm (公尺)', 'mm, cm', '1 m = 1000 mm'],
              ['質量 (Mass, m)', 'kg (公斤)', 't (公噸)', '1 t = 1000 kg'],
              ['力 (Force, F)', 'N (牛頓)', 'kN (千牛頓)', '1 kN = 1000 N = 10³ N'],
              ['應力 (Stress, σ)', 'Pa (帕斯卡)', 'MPa (N/mm²)', '1 MPa = 1 N/mm² = 10⁶ Pa'],
              ['力矩 (Moment, M)', 'N·m (牛頓米)', 'kN·m, N·mm', '1 kN·m = 10⁶ N·mm']
            ]
          }
        },
        {
          ...
          table: {
            ...
            rows: [
              ['純量 (Scalar)', '僅有數值大小與單位', '質量 m, 體積 V, 面積 A, 能量 U', '遵循代數加減法規則'],
              ['向量 (Vector)', '同時具備大小、方向與作用點', '力 F, 位移 d, 力矩 M, 加速度 a', '遵循平行四邊形定律與平行分解']
            ]
          }
        },
        {
      ...
      concepts: [
        ...
        },
        {
          ...
          table: {
            ...
            rows: [
              ['正交分力法 (∑Fx=0, ∑Fy=0)', '任意 2D 共點力系', '2 個代數方程', '通用性高，適合多力合成'],
              ['拉密定理 (Lami\'s Theorem)', '僅限 2D 三力共點平衡', '1 個比例式', '無需分解分力，幾何三角求解極快'],
              ['封閉力三角形法', '2D 三力共點平衡', '向量幾何圖形', '直觀展示力的向量閉合圖樣']
            ]
          }
        },
        {
        ...
        },
        {
          ...
          table: {
            ...
            rows: [
              ...
              ['圓形 (半徑 r)', 'π · r²', 'y = r, x = r', '(π · r⁴) / 4'],
              ['半圓形 (半徑 r)', '(π · r²) / 2', 'y = 4r / (3π)', '0.1098 · r⁴ (對形心水平軸)']
            ]
          }
        },
        {
      ...
      concepts: [
        ...
        },
        {
          ...
          table: {
            ...
            rows: [
              ['兩桿接頭 (L-Joint)', '節點上無任何外力或支承反力', '兩桿均為零桿 (F1 = 0, F2 = 0)', '兩不共線桿件相交之自由端'],
              ['三桿接頭 (T-Joint)', '兩桿共線，第三桿斜交，且節點無外力', '不共線之第三桿必為零桿', '主弦桿與垂直腹板交會處']
            ]
          }
        },
        {
      ...
      concepts: [
        {
          ...
          table: {
            ...
            rows: [
              ['簡支樑 (Simply Supported Beam)', '一端鉸支承 (Pin) + 一端滾支承 (Roller)', 'r = 3 (2+1)', '兩端支承彎矩為 0，中央彎矩最大'],
              ['懸臂樑 (Cantilever Beam)', '一端固定端 (Fixed) + 一端自由端 (Free)', 'r = 3 (3+0)', '固定端負彎矩與剪力最大，自由端為 0'],
              ['外伸樑 (Overhanging Beam)', '簡支樑一端或兩端向外延伸自由端', 'r = 3 (2+1)', '支承處產生負彎矩，跨中產生正彎矩']
            ]
          }
        },
        {
        ...
        },
        {
          ...
          table: {
            headers: ['載重與樑類型', '最大剪力 (V_max)', '最大彎矩 (M_max)', '最大彎矩發生位置'],
            rows: [
              ['簡支樑 + 中央集中載重 P', 'P / 2', '(P · L) / 4', '樑中央跨中點 (x = L / 2)'],
              ['簡支樑 + 全跨均佈載重 w', '(w · L) / 2', '(w · L²) / 8', '樑中央跨中點 (x = L / 2)'],
              ['懸臂樑 + 自由端集中載重 P', 'P', 'P · L (負彎矩)', '固定端處 (x = 0)']
            ]
          }
        },
        {
      ...
      concepts: [
        {
          ...
          table: {
            headers: ['物理量', '符號', '定義公式', 'SI/工程常用單位'],
            rows: [
              ['正應力 (Normal Stress)', 'σ (Sigma)', 'σ = P / A', 'MPa (N/mm²)'],
              ['剪應力 (Shear Stress)', 'τ (Tau)', 'τ = V / A', 'MPa (N/mm²)'],
              ['正應變 (Normal Strain)', 'ε (Epsilon)', 'ε = δ / L', '無單位 (mm/mm)'],
              ['剪應變 (Shear Strain)', 'γ (Gamma)', 'γ = Δπ/2', 'rad (弧度)']
            ]
          }
        },
        {
        ...
        },
        {
          ...
          table: {
            headers: ['工程材料名稱', '屈服強度 f_y (MPa)', '彈性模數 E (GPa)', '常用設計許用應力 σ_allow'],
            rows: [
              ['結構用鋼 (A36 / SN400)', '250 MPa', '200 GPa', '150 MPa (SF ≒ 1.67)'],
              ['高強鋼筋 (SD420)', '420 MPa', '200 GPa', '250 MPa (SF ≒ 1.68)'],
              ['結構混凝土 (C280 / 28MPa)', 'f\'c = 28 MPa', '25 GPa', '12.6 MPa (抗壓設計)']
            ]
          }
        },
        {
        ...
        },
        {
          ...
          table: {
            headers: ['幾何/應力參數', '莫耳圓定義公式', '物理意義與工程應用'],
            rows: [
              ['莫耳圓圓心 C', '(σx + σy) / 2', '代表平均正向應力 (Average Normal Stress)'],
              ['莫耳圓半徑 R', '√[ ((σx - σy) / 2)² + τxy² ]', '等於平面最大剪應力 τ_max'],
              ['主應力 σ₁, σ₂', 'C ± R', '剪應力為零之切面上的最大與最小正向應力'],
              ['主平面角度 θp', '0.5 · tan⁻¹[ 2τxy / (σx - σy) ]', '確定鋼筋混凝土裂縫或脆性材料破壞面方向']
            ]
          }
        },
        {
