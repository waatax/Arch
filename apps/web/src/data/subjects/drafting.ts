...
export const draftingData: SubjectData = {
  ...
  "topics": [
          ...
          "table": {
            ...
            "rows": [
              ...
              [
                "LOD 400 (預製加工)",
                "鋼構接頭、鋼筋彎鉤、預鑄混凝土加工細節",
                "製造加工編號、吊裝排程 (4D)、精確成本 (5D)",
                "工廠加工製造圖 (Shop Drawings)、現場組裝"
              ],
              [
                "LOD 500 (竣工運維)",
                "現場驗收完工之實際位置與幾何現況 (As-Built)",
                "設備型號、維護週期、保固期限、操作手冊",
                "智慧建築設施管理 (FM/7D)、數位雙生 (Digital Twin)"
              ]
            ]
          }
        },
          ...
          "table": {
            ...
            "rows": [
              [
                "建蔽率 (BCR)",
                "(建築面積 / 基地面積) × 100%",
                "保留地面空地，確保通風、採光、日照與都市防災",
                "最大建築面積 = 基地面積 × 法定建蔽率（分母為基地面積）"
              ],
              [
                "容積率 (FAR)",
                "(總容積樓地板面積 / 基地面積) × 100%",
                "控制都市人口密度、交通量與公共設施總承載力",
                "最大總樓地板面積 = 基地面積 × 法定容積率"
              ],
              [
                "極限樓層數估算",
                "最大層數 = 法定容積率 / 實際規劃建蔽率",
                "垂直量體向上發展，騰出地面綠化空間",
                "例：FAR 240% / 建蔽 50% = 4.8 層（蓋滿建蔽率時最多 4 整層）"
              ],
              [
                "免計容積項目",
                "建築技術規則第 162 條",
                "鼓勵停車、避難與公共設施",
                "陽台 ≤ 該層 10%、地下避難/機電、法定梯廳免計容積"
              ]
            ]
          }
        },
    ...
    },
    {
      ...
      "examHitRate": 4,
      "step0Prerequisites": [
        "CNS 11567 建築製圖規範標準圖紙尺寸 (A0~A4)",
        "工程圖面標題欄、會簽欄與圖號管理編碼"
      ],
      "fatalTraps": [
        {
          "wrongThinking": "折疊圖紙時隨意對折，未將標題欄保留在折疊後的最上方外側。",
          "correctThinking": "CNS 規定圖紙折疊後必須為 A4 尺寸，且右下角的「標題欄」必須完整顯露於折疊封面最上方外側，便於查閱歸檔。",
          "trapDescription": "工程圖紙折疊歸檔標準作業程序 (SOP) 實務常考陷阱。"
        }
      ],
      "eliteMentalModels": [
        {
          "technique": "工程圖紙空間層級與圖框坐標定位模型",
          "explanation": "由全區配置圖到單元詳圖，圖名、比例尺與指北針形成自帶空間坐標的三位一體導航系統，任何圖紙閱讀皆先對齊圖框坐標。"
        }
      ],
      "illustrations": [
        "context.webp",
      ...
      "worked_examples": [
        {
          ...
          "difficulty": "統測核心",
          "steps": [
            "步驟 1：理解圖紙歸檔折疊之 CNS 規範目標。依據 CNS 11567 建築製圖規範，大尺寸圖紙（如 A1、A0）折疊歸檔至 A4 活頁夾時，必須達成「免展開圖面即可直接檢閱圖名、工程名稱與修訂版次」。 ｜為什麼：提升工程檔案檢索效率，避免頻繁攤開大圖造成紙張磨損破裂。",
            "步驟 2：分析標題欄 (Title Block) 原始繪製位置。在標準圖紙規劃中，標題欄永遠固定繪製於圖紙之「正面右下角」，並預留標準邊界留白。 ｜為什麼：統一的圖頭位置符合人體工程學翻閱習慣與法定圖紙歸檔標準。",
            "步驟 3：歸納手風琴式折疊 (Accordion Fold) 幾何結果。按照標準折疊程序（先橫向手風琴折再縱向對折），標題欄剛好完好顯露在折疊後 A4 單元「正面之右下角」。 ｜為什麼：依據 CNS 建築製圖折圖標準步驟與幾何對應關係。"
          ],
          "answer": "折後正面右下方",
          "hints": [
            "分析題目核心條件與建築製圖規範/定理",
      ...
      "practices": [
        ...
        },
        {
          ...
          "difficulty": "觀念",
          "steps": [
            "辨識題目屬於**製圖基本觀念**，先畫出<span className='text-indigo-600 font-bold'>自由體圖 (FBD)</span> 或整理已知量。",
            "確認 <span className='text-rose-600 font-bold'>圖名、圖號、比例與版次可追溯</span> 成立後再代入公式。"
          ],
        ...
        },
        {
          ...
          "steps": [
            "逐項檢查輸入單位是否一致。",
            "結果應以 **圖紙尺寸用 mm、比例為無因次** 表達；不符時不可只改單位符號，須回推計算過程。"
          ],
    ...
    },
    {
      ...
      "examHitRate": 4,
      "step0Prerequisites": [
        "建築與土木結構圖說跨專業分工 (A-圖、S-圖、C-圖)",
        "平面、立面、剖面三度空間投影相互對照法"
      ],
      "fatalTraps": [
        {
          "wrongThinking": "閱讀結構剖面圖時，將建築裝修完成面標高 (FL) 直接當成結構混凝土頂面標高 (SL)。",
          "correctThinking": "結構平面圖標註為結構混凝土標高 (SL)；建築平面圖標註為地坪完成面標高 (FL)，兩者通常存在地坪裝修粉刷層厚度差（約 5~10 cm）。",
          "trapDescription": "工地放樣與模板組立若未區分 FL 與 SL，將導致樓層淨高與門窗安裝高度嚴重失誤。"
        }
      ],
      "eliteMentalModels": [
        {
          "technique": "建築空間三維切片投射模型",
          "explanation": "將平面圖視為 1.2m 高處的水平剖切片、立面圖為從正向外殼的投影片、剖面圖為穿透梁柱垂直切片，大腦自動重構 3D 空間立體。"
        }
      ],
      "illustrations": [
        "context.webp",
      ...
      "concepts": [
        {
          ...
          "table": {
            ...
            "rows": [
              [
                "建築圖 (Architectural)",
                "A 圖 (A1 平面, A2 立面, A3 剖面, A4 詳圖)",
                "水平 X-Y 隔間、門窗編號、垂直 Z 淨高、裝修材",
                "空間機能與法規依 A 圖；文字標註優先於量圖"
              ],
              [
                "結構圖 (Structural)",
                "S 圖 (S1 基礎, S2 梁柱配筋, S3 版牆)",
                "柱梁斷面尺寸、鋼筋型號/間距/搭接長度/保護層",
                "結構安全與承重依 S 圖；與 A 圖衝突提送 RFI"
              ],
              [
                "機電設備圖 (MEP)",
                "M (空調風管), E (強弱電), P (給排水), F (消防)",
                "管線走向、坡度、預留穿梁套管 (SEM/CSD 套繪)",
                "重力排水管優先，冷熱給水與電纜橋架避讓繞行"
              ],
              [
                "圖說疑義處理 (RFI)",
                "Request for Information",
                "工程界面衝突、尺寸矛盾、索引遺漏時填單核覆",
                "嚴禁自行量圖施工，取得建築師核可書面方可作業"
              ]
            ]
          }
        },
      ...
      "worked_examples": [
        {
          ...
          "difficulty": "統測核心",
          "steps": [
            "⚠️ **統測陷阱 (Exam Trap)：** 考生常以為可以「依比例尺量測圖面推算尺寸」，但在正式工程中這是大忌！",
            "這是<span className=\"text-rose-600 font-bold\">跨圖索引不一致</span>，不能自行猜測尺寸。",
            "先查最新版次與修訂雲線，再<span className=\"text-indigo-600 font-bold\">提出圖說疑義 (RFI)</span>。"
          ],
      ...
      "practices": [
        {
          ...
          "difficulty": "統測核心",
          "steps": [
            "<span className=\"text-indigo-600 font-bold\">平面圖</span>確認梯段與洞口位置。",
            "<span className=\"text-rose-600 font-bold\">剖面圖</span>確認垂直高度；必要時再查樓梯詳圖。"
          ],
          "answer": "平面圖、剖面圖及樓梯詳圖",
          "hints": [
            "分析題目核心條件與建築製圖規範/定理",
        ...
        },
        {
          ...
          "difficulty": "進階",
          "steps": [
            "先比較<span className=\"text-indigo-600 font-bold\">圖號、版次與修訂日期</span>。",
            "以最新版圖說釐清，仍衝突則提出 RFI。"
          ],
        ...
        },
        {
          ...
          "difficulty": "觀念",
          "steps": [
            "辨識題目屬於**土木與建築製圖整合判讀**，先畫出<span className='text-indigo-600 font-bold'>自由體圖 (FBD)</span> 或整理已知量。",
            "確認 <span className='text-rose-600 font-bold'>平面、立面、剖面與詳圖的索引及版次一致</span> 成立後再代入公式。"
          ],
        ...
        },
        {
          ...
          "steps": [
            "逐項檢查輸入單位是否一致。",
            "結果應以 **圖面長度依標註用 mm 或 cm、高程用 m** 表達；不符時不可只改單位符號，須回推計算過程。"
          ],
    ...
    },
    {
      ...
      "examHitRate": 4,
      "step0Prerequisites": [
        "CNS 3 製圖線型分類（實線、虛線、鏈線）",
        "鉛筆筆芯硬度 (9H~9B) 與工程字書寫運筆姿態"
      ],
      "fatalTraps": [
        {
          "wrongThinking": "繪製隱蔽輪廓的虛線時，在與可見輪廓實線相交處留下空白間隙。",
          "correctThinking": "虛線與實線相交、或虛線與虛線相交時，交點處必須以「線段相接（實接）」，不可留下空白；只有當虛線為實線之延長線時，交點處才留空隙。",
          "trapDescription": "手繪製圖與電繪出圖線型相交節點規範常考細節。"
        }
      ],
      "eliteMentalModels": [
        {
          "technique": "CNS 線型墨線粗細層次對比模型",
          "explanation": "粗實線斷開結構空間輪廓、中實線描繪構件表面分界、細線輔助引出尺寸與剖面網底，虛線透視隱蔽結構，層次分明消除判讀歧義。"
        }
      ],
      "covered_question_ids": [
        "111-2-22",
      ...
      "concepts": [
        ...
        {
          "heading": "線條相交與畫法特別原則",
          "body": "依據 CNS 3 建築製圖規範，隱藏線（虛線）與可見輪廓線（粗實線）或中心線相交接時，必須嚴格遵循端點接觸與間隙斷開法則，以確保圖紙線條層次分明，防止工程施作人員產生空間幾何誤判或讀圖歧義。",
          "steps": [
    ...
    },
    {
      ...
      "step0Prerequisites": [
        "幾何相似形縮放比例定律",
        "工程三角比例尺三稜六種刻度 (1/100, 1/200, 1/300, 1/400, 1/500, 1/600) 使用方法"
      ],
      "fatalTraps": [
        {
          "wrongThinking": "圖紙由 1:100 縮小複印成 1:200 後，直接拿原比例尺在圖上量測並寫出錯誤尺寸。",
          "correctThinking": "工程圖紙尺寸永遠以「標註數字 (Dimension Text)」為準！比例尺量測僅供參考，若圖紙縮放複印產生變形，嚴禁用尺量讀數取代標註值。",
          "trapDescription": "忽略「字大於圖（標註文字優先於測量）」之工程法規核心原則。"
        }
      ],
      "eliteMentalModels": [
        {
          "technique": "尺標幾何比例尺換算模型",
          "explanation": "比例 1:N 代表圖上 1 單位等於實物 N 單位；面積縮放為 N² 倍、體積縮放為 N³ 倍，換算尺寸時先在圖上量測再乘上分母常數。"
        }
      ],
      "covered_question_ids": [
        "111-2-31",
    ...
    },
    {
      ...
      "step0Prerequisites": [
        "空間四個象限角幾何定義",
        "第一角投影法 (歐洲/CNS 部分) 與第三角投影法 (台灣/美日) 差異"
      ],
      "fatalTraps": [
        {
          "wrongThinking": "在第三角投影視圖中，將俯視圖（Top View）畫在正視圖（Front View）的下方。",
          "correctThinking": "第三角投影法遵循「眼-面-物」順序：俯視圖在上、正視圖在中央、仰視圖在下、右側視圖在右；第一角法才是俯視在下。",
          "trapDescription": "混淆第一角法與第三角法的投影箱展開排版方位。"
        }
      ],
      "eliteMentalModels": [
        {
          "technique": "透明投影玻璃箱折疊還原模型",
          "explanation": "第三角法想像物體置於透明箱內，視線透過箱面投射：正視箱在前、俯視箱在上、右側視箱在右，箱面展開即得標準三視圖排版位置。"
        }
      ],
      "covered_question_ids": [
        "111-2-28",
      ...
      "concepts": [
        ...
        },
        {
          ...
          "diagram": {
            "title": "CNS 11567 第三角投影三視圖展開對位關係",
            "caption": "長對正 (前視與俯視)、高平齊 (前視與側視)、寬相等 (45° 輔助線連接俯視與側視)",
            "svg": "<svg viewBox='0 0 540 190' className='w-full h-auto' fill='none' xmlns='http://www.w3.org/2000/svg'><rect x='80' y='15' width='100' height='55' fill='rgba(99,102,241,0.12)' stroke='#6366f1' stroke-width='1.5'/><text x='130' y='45' fill='#4338ca' font-size='9' font-family='sans-serif' font-weight='bold' text-anchor='middle'>俯視圖 (Top)</text><rect x='80' y='95' width='100' height='65' fill='rgba(37,99,235,0.15)' stroke='#2563eb' stroke-width='2'/><text x='130' y='132' fill='#1d4ed8' font-size='9' font-family='sans-serif' font-weight='bold' text-anchor='middle'>前視圖 (Front)</text><rect x='220' y='95' width='55' height='65' fill='rgba(16,185,129,0.12)' stroke='#10b981' stroke-width='1.5'/><text x='247' y='132' fill='#047857' font-size='9' font-family='sans-serif' font-weight='bold' text-anchor='middle'>右側視</text><line x1='80' y1='70' x2='80' y2='95' stroke='#94a3b8' stroke-width='1' stroke-dasharray='2 2'/><line x1='180' y1='70' x2='180' y2='95' stroke='#94a3b8' stroke-width='1' stroke-dasharray='2 2'/><text x='130' y='85' fill='#64748b' font-size='8' font-family='monospace' text-anchor='middle'>長對正</text><line x1='180' y1='127' x2='220' y2='127' stroke='#94a3b8' stroke-width='1' stroke-dasharray='2 2'/><text x='200' y='122' fill='#64748b' font-size='8' font-family='monospace' text-anchor='middle'>高平齊</text><line x1='180' y1='15' x2='275' y2='15' stroke='#f59e0b' stroke-width='1' stroke-dasharray='2 2'/><line x1='180' y1='70' x2='220' y2='70' stroke='#f59e0b' stroke-width='1' stroke-dasharray='2 2'/><line x1='220' y1='70' x2='275' y2='15' stroke='#d97706' stroke-width='1.5'/><line x1='220' y1='70' x2='220' y2='95' stroke='#f59e0b' stroke-width='1' stroke-dasharray='2 2'/><line x1='275' y1='15' x2='275' y2='95' stroke='#f59e0b' stroke-width='1' stroke-dasharray='2 2'/><text x='255' y='48' fill='#b45309' font-size='8' font-family='monospace' font-weight='bold'>45°轉折</text><text x='380' y='105' fill='#334155' font-size='9' font-family='monospace' font-weight='bold'>第三角投影符號：</text><circle cx='410' cy='135' r='10' stroke='#334155' stroke-width='1'/><circle cx='410' cy='135' r='18' stroke='#334155' stroke-width='1'/><polygon points='440,127 440,143 465,150 465,120' stroke='#334155' stroke-width='1'/></svg>"
          }
        },
        {
          "heading": "三視圖對齊原理與「長對正、高平齊、寬相等」",
          "body": "正投影三視圖是工程圖學的共通語言。為在二維圖紙上完整無誤地還原三維立體幾何空間，前視圖、俯視圖與側視圖之間必須嚴格遵守三大空間對應定律：長對正、高平齊、寬相等。",
        ...
        },
        {
          ...
          "body": "在 AutoCAD 數位製圖環境中，繪製正投影三視圖主要仰賴建構線 (XLINE)、正交模式 (F8) 與物件鎖點追蹤 (F11)。透過精確抓取前視圖端點向上延伸至俯視圖、向右延伸至側視圖，達成零誤差之三視圖投影幾何對齊。",
          "table": {
            "headers": [
              "功能說明",
              "快捷鍵 / 按鍵",
    ...
    },
    {
      ...
      "step0Prerequisites": [
        "剖切面切割位置線與視線箭頭方向標示",
        "CNS 常用建材剖面符號（混凝土、磚石、木材、鋼材、土壤）"
      ],
      "fatalTraps": [
        {
          "wrongThinking": "將剖面線 (Hatching) 畫在實體切過處後方的不可見隱蔽空間。",
          "correctThinking": "剖面線只能塗繪在「被切割面實體切過 (Cut Solid)」的實心材料剖斷面上，實體後方的中空背景與不可見處絕不畫剖面線。",
          "trapDescription": "剖面線填補範圍錯誤，將空洞或背景畫上剖面線導致材料誤判。"
        }
      ],
      "eliteMentalModels": [
        {
          "technique": "虛擬雷射切割刀剖面重構模型",
          "explanation": "想像雷射刀沿剖切符號割開建物，移除視線前方量體，遭實體切過處填滿剖面線 (Hatch)，實體切過後方可見輪廓繪中實線。"
        }
      ],
      "covered_question_ids": [
        "111-2-27",
    ...
    },
    {
      ...
      "step0Prerequisites": [
        "建築技術規則平面圖標準內容",
        "建築平面圖 1.0~1.2m 視高水平剖切概念"
      ],
      "fatalTraps": [
        {
          "wrongThinking": "在平面圖上繪製門扇符號時，僅畫一道直線，未標示門開啟之旋轉弧線。",
          "correctThinking": "平面圖上的門必須繪製「門扇線」與「开启旋轉 90° 弧線」，以明確指出向內開或向外開、以及門開啟軌跡是否會碰撞走道障礙物。",
          "trapDescription": "漏畫開啟弧線或將門開向畫反，違反無障礙與防火避難逃生動線規範。"
        }
      ],
      "eliteMentalModels": [
        {
          "technique": "1.2m 人眼視高地平剖面透視模型",
          "explanation": "剖切面穿越牆體與窗樘，窗台下方牆線繪細實線，剖切牆身繪粗實線，門扇弧線標明向內外開啟路徑與逃生淨寬。"
        }
      ],
      "covered_question_ids": [
        "111-2-25",
      ...
      "concepts": [
        ...
        },
        {
          ...
          "body": "建築平面圖中的牆體是界定室內空間與承載結構荷載的核心要素。製圖時必須依據構造材質（如鋼筋混凝土 RC 承重牆、1B 磚牆、1/2B 隔間牆及輕鋼架輕隔間）繪出標準厚度與專屬剖面填充圖例，嚴格區分結構耐震牆體與二次施工隔間。",
          "table": {
            "headers": [
              "牆體類型",
              "實際構造厚度 (cm)",
        ...
        },
        {
          ...
          "body": "建築平面圖需完整表達垂直動線與生活機能配置。樓梯必須繪製清晰之上下行箭頭、踏面級數與水平剖斷線（約在 1.2m 視高處切斷），並於地坪明確標註相對設計基準 (FL) 之絕對或相對高程符號，確保施工與垂直動線順暢。",
          "steps": [
    ...
    },
    {
      ...
      "examHitRate": 4,
      "step0Prerequisites": [
        "地盤線 (Ground Line, GL) 與建築立面輪廓線定義",
        "立面外觀材料符號與分格縫 (Joint) 標註"
      ],
      "fatalTraps": [
        {
          "wrongThinking": "建築立面圖地盤線 (GL) 畫成細實線，與室內地坪線混淆。",
          "correctThinking": "地盤線 (GL) 為大地與建築立面交界線，CNS 規範必須畫成「特粗實線（約 0.7~1.0 mm）」，且兩端超出建築物外牆，以突顯建築立於地面之穩定基底。",
          "trapDescription": "立面圖線型粗細層次顛倒，地盤線過細失去視覺支撐重心。"
        }
      ],
      "eliteMentalModels": [
        {
          "technique": "室外直角平行光陰影投影立面模型",
          "explanation": "以大地水平地盤線 (GL) 為基線，繪製建築正面完整外飾材與開口造型，標註各層地坪標高 (FL) 與屋頂女兒牆頂標高。"
        }
      ],
      "covered_question_ids": [
        "111-2-23",
      ...
      "concepts": [
        ...
        },
        {
          ...
          "body": "建築立面圖最關鍵的工程資訊即為建築垂直空間的控制尺寸。圖面左側或右側必須建立完整的高程系統，以戶外基地地平 (GL ±0.00) 為絕對基準，繪製黑白相間圓形高程符號或倒三角高程箭頭，逐層標註室內地坪完成面 (FL)、梁底高、窗台高、屋頂樓板 (RF) 及女兒牆 (PAR) 之垂直標高。",
          "table": {
            "headers": [
              "高程代號",
              "英文全稱",
        ...
        },
        {
          ...
          "body": "在 CAD 繪圖實務中，立面圖必須藉由平面圖直接引線對齊生成。利用建構線垂直模式 (XLINE V) 抓取平面圖之柱軸線、外牆轉角及門窗開口，配合樓層高程水平偏移線 (OFFSET)，即可確保平面與立面 100% 幾何對應無錯位。",
          "table": {
            "headers": [
              "指令名稱",
              "快捷鍵",
    ...
    },
    {
      ...
      "examHitRate": 4,
      "step0Prerequisites": [
        "尺寸界線、尺寸線、起訖點符號（箭頭/45°斜短線）與尺寸數字規則",
        "建築柱心軸線編號系統（橫向 1,2,3... / 縱向 A,B,C...）"
      ],
      "fatalTraps": [
        {
          "wrongThinking": "尺寸標註線互相交錯穿插，將建物總尺寸標在最內側靠近建築物處。",
          "correctThinking": "尺寸標註嚴禁交叉！必須按階層由內往外依序排列：第一道細部開口門窗尺寸（最內）、第二道柱心軸線結構跨距（中間）、第三道建築物總長寬（最外）。",
          "trapDescription": "尺寸線排列次序顛倒引發圖面嚴重交叉混亂，違反施工圖判讀標準。"
        }
      ],
      "eliteMentalModels": [
        {
          "technique": "建築三道尺寸標註標準階層模型",
          "explanation": "由建築物外緣往外依序排列：第一道細部開口尺寸、第二道柱心軸線跨距、第三道建物總長寬，各線平行等距不交叉。"
        }
      ],
      "covered_question_ids": [
        "111-2-21",
      ...
      "concepts": [
        ...
        },
        {
          ...
          "body": "建築平面施工圖的外部尺寸標註必須遵循 CNS 標準「由外而內三道尺寸線」原則：最外層為建築物總尺寸、中層為結構柱列軸線跨距、最內層為門窗開口與垛牆細部尺寸，由大至小排列整齊，杜絕尺寸界線交叉混亂。",
          "table": {
            "headers": [
              "標註階層",
              "相對位置 (由外向內)",
        ...
        },
        {
          ...
          "body": "工程圖頭（標題欄 Title Block）是整張圖紙的法定身分證明。依據 CNS 11567 建築製圖規定，標題欄固定繪製於圖面右下角，載明工程名稱、業主、建築師簽證欄、圖名、圖號、比例尺與最新繪製修訂日期，圖紙左緣並保留 25mm 裝訂留白邊。",
          "table": {
            "headers": [
              "圖紙規格",
              "裝訂邊留白 (Left Margin)",
        ...
        },
        {
          ...
          "body": "在 AutoCAD 專業製圖環境中，尺寸標註型式 (DIMSTYLE) 是控制圖面標準化輸出的樞紐。透過預先設定建築斜線標記 (Architectural Tick)、文字高度 (通常出圖 2.5~3.0mm)、延伸線起點偏移量及整體標註比例 (DIMSCALE)，確保跨圖紙比例輸出時尺寸符號大小一致。",
          "table": {
            "headers": [
              "CAD 指令 / 變數",
              "快捷鍵",
    ...
    },
    {
      ...
      "examHitRate": 4,
      "step0Prerequisites": [
        "AutoCAD 常用二維繪圖與編輯指令 (Line, Circle, Trim, Offset, Fillet)",
        "圖層 (Layer) 顏色、線型、線寬與出圖樣式表 (CTB) 設定"
      ],
      "fatalTraps": [
        {
          "wrongThinking": "直接修改物件個別性質 (Color/Lineweight)，而不透過「圖層 (ByLayer)」進行統一管理。",
          "correctThinking": "CAD 專業作業天條：所有構件的顏色、線型與線寬必須設定為「ByLayer（隨層）」！個別覆寫會導致出圖樣式混亂與協同出圖管理崩潰。",
          "trapDescription": "不良繪圖習慣導致他人無法透過圖層整批修改線型與筆寬。"
        }
      ],
      "eliteMentalModels": [
        {
          "technique": "數位圖層分類與顏色線寬對應矩陣",
          "explanation": "按專業構件分層（A-WALL, A-DOOR, A-DIM），利用圖層管理線型與出圖筆寬 (CTB)，確保圖紙輸出精準符合 CNS 墨線標準。"
        }
      ],
      "covered_question_ids": [],
      "worked_examples": [
      ...
      "concepts": [
        {
          ...
          "body": "AutoCAD 數位繪圖以笛卡兒直角坐標系為基礎。精確建立工程幾何形狀時，必須熟練掌握三種點輸入方式：絕對直角坐標 (X,Y)、相對直角坐標 (@ΔX,ΔY) 及相對極坐標 (@距離<角度)，靈活運用於定位基準原點、繪製矩形開口及傾斜構件。",
          "table": {
            "headers": [
              "座標輸入法",
              "語法格式",
        ...
        },
        {
          ...
          "body": "在電腦輔助製圖實務中，熟練掌握狀態列功能鍵（如 F3 物件鎖點、F8 正交約束、F10 極軸追蹤、F11 物件鎖點追蹤）是擺脫繁瑣滑鼠選單、達成盲打直覺操作與毫秒級快速精確鎖點的高效關鍵。",
          "table": {
            "headers": [
              "快捷鍵",
              "輔助功能名稱",
        ...
        {
          "heading": "CNS 11567 建築出圖線寬規範與技能檢定 180 分鐘防錯 SOP",
          "body": "依據經濟部 CNS 11567《建築製圖》與勞動部技能檢定規範，圖紙輸出嚴格要求維持粗中細線條比例 (4:2:1)。實務檢定計時 180 分鐘，繪圖者必須遵循開檔模板化、圖元一律 ByLayer、圖紙空間鎖定視埠比例尺及關閉自動縮放 (Fit to Paper) 之防呆紀律，杜絕 0 分出圖判定。",
          "table": {
            "headers": [
              "圖線層級",
              "CNS 11567 線寬 (A1~A2)",
            ...
            "rows": [
              [
                "粗實線 (剖面切線)",
                "0.50 ~ 0.70 mm",
                "WALL / COLUMN (Yellow/Red)",
                "剖切 RC 柱梁牆體外輪廓；漏畫或未閉合扣 5 分"
              ],
              [
                "中實線 (外觀輪廓)",
                "0.35 mm",
                "DOOR_WIN / STAIR (Green/Cyan)",
                "未切到之門窗、欄杆、踏階可見線；線條相交未修剪扣分"
              ],
              [
                "細實線 (標註與中心線)",
                "0.18 ~ 0.25 mm",
                "DIM / AXIS (Color 8/Cyan)",
                "三道連續標註與軸線；文字字高 2.5~3.5mm 嚴禁倒置"
              ],
              [
                "視埠比例尺防呆",
                "1:100 / 1:50 規範比例",
                "圖紙空間 (Layout 視埠)",
                "出圖嚴禁勾選 Fit to Paper，比例尺縮放錯誤直接 0 分判定"
              ],
              [
                "180 分鐘檢定排程",
                "3 小時極速通關",
                "環境15m+主體60m+標註45m+大樣30m+檢查30m",
                "時間到未出圖、主要圖面漏繪一項或超出圖框即不及格"
              ]
            ]
          }
        }
    ...
    },
    {
      ...
      "examHitRate": 4,
      "step0Prerequisites": [
        "製圖桌、丁字尺、平行尺、三角板 (45°-45° 與 30°-60°) 構造與使用法",
        "圓規、分規、消字板與壓克力曲線板操作要領"
      ],
      "fatalTraps": [
        {
          "wrongThinking": "使用平行尺或丁字尺時，以尺身作為美工刀裁切紙張的導板。",
          "correctThinking": "嚴禁使用壓克力平行尺或丁字尺導切美工刀！刀片會刮傷邊緣壓克力造成凹洞與毛邊，往後繪製水平線皆會產生波浪狀彎曲殘缺。裁紙必須使用金屬鋼尺。",
          "trapDescription": "製圖儀器保養與使用禁忌常識題。"
        }
      ],
      "eliteMentalModels": [
        {
          "technique": "機械手繪工具零游隙校準模型",
          "explanation": "圖板平行尺利用鋼索張力微調水平，三角板配合平行尺滑動畫垂直線與 15° 倍數斜角，鉛筆旋轉畫線確保線寬一致均勻。"
        }
      ],
      "covered_question_ids": [
        "110-2-1",
    ...
    },
    {
      ...
      "examHitRate": 4,
      "step0Prerequisites": [
        "尺規作圖公理（垂直平分線、角平分線、平行線）",
        "內切圓、外接圓、黃金分割與橢圓四心圓弧作圖法"
      ],
      "fatalTraps": [
        {
          "wrongThinking": "繪製兩互垂直線間的圓弧連接時，隨機選定圓心，未精確自切點引法線交出切心。",
          "correctThinking": "圓弧相切之幾何真理：切點、圓心與半徑永遠嚴格共線且法線正交！必須先由兩切線往內作距離 R 的平行線交出圓心 O，再自 O 作垂線決定切點 T1, T2，最後落筆畫弧。",
          "trapDescription": "圓弧連接處出現錯位折角或重疊筆觸，違反光滑相切之幾何連續性。"
        }
      ],
      "eliteMentalModels": [
        {
          "technique": "圓規直尺平面幾何作圖精確模型",
          "explanation": "以中垂線求圓心、角平分線求內切圓、斜率反垂線求切點，利用歐幾里得幾何原理以零刻度誤差完成精確弧線相接。"
        }
      ],
      "covered_question_ids": [
        "110-2-2",
    ...
    },
    {
      ...
      "examHitRate": 4,
      "step0Prerequisites": [
        "空間直線投影特性（實長 TL、縮短短長、縮成一點 Point View）",
        "單斜面 (Inclined Surface) 與複斜面 (Oblique Surface) 幾何特徵"
      ],
      "fatalTraps": [
        {
          "wrongThinking": "在基本三視圖上直接量取傾斜面的長寬尺寸作為實體真實尺寸。",
          "correctThinking": "傾斜面在正投影面上的投影必定產生「長度縮短 (Foreshortened)」失真；必須架設平行於該斜面的「輔助投影面 (AP)」，才能投射出 1:1 的「真實形狀 (True Shape)」。`",
          "trapDescription": "誤將失真的正投影長度當作傾斜構件的實際裁切備料尺寸。"
        }
      ],
      "eliteMentalModels": [
        {
          "technique": "斜面真形輔助投射箱模型",
          "explanation": "當物體表面與正投影面傾斜時，在其法線方向架設平行輔助投影面 (AP)，將傾斜特徵以 1:1 真實形狀與真實角度完全還原。"
        }
      ],
      "covered_question_ids": [
        "110-2-12",
    ...
    },
    {
      ...
      "examHitRate": 4,
      "step0Prerequisites": [
        "透視投影幾何名詞：視點 (SP)、畫面 (PP)、基線 (GL)、視平線 (HL)、消點 (VP)",
        "單消點透視（平行透視）與兩消點透視（成角透視）畫法"
      ],
      "fatalTraps": [
        {
          "wrongThinking": "繪製兩消點成角透視時，將兩個消點 (VPL, VPR) 標註在視平線 (HL) 以外的不同高度上。",
          "correctThinking": "建築物所有水平平行線的滅點（消點）必定嚴格落在同一條「水平視平線 (HL)」上！兩消點高度不同代表視線水平扭曲，透視幾何完全崩潰。",
          "trapDescription": "透視圖幾何原理題，誤將滅點畫在視平線上方或下方。"
        }
      ],
      "eliteMentalModels": [
        {
          "technique": "人眼單視點錐形透視光學模型",
          "explanation": "以視點 (SP) 發出視線穿透畫面 (PP) 投向物體，平行於畫面之水平線不變形，垂直或斜向水平均消失於視平線 (HL) 上的滅點 (VP)。"
        }
      ],
      "covered_question_ids": [
        "110-2-20",
