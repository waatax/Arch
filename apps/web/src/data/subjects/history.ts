  ...
  "topics": [
    {
      ...
      "fatalTraps": [
        {
          "wrongThinking": "時代背景錯置。",
          "correctThinking": "依據歷史時空脈絡定位事件。",
          "trapDescription": "時代年代錯置陷阱。"
        }
      ],
      ...
      "worked_examples": [
        {
          ...
          "difficulty": "基礎",
          "steps": [
            "步驟 1：回顧客家移民歷史背景。清代台灣族群械鬥頻繁，客家聚落極注重防衛堡壘化。 ｜為什麼：客家人常居於丘陵與邊界地帶，需抵禦各類外在民變與衝突威脅。",
            "步驟 2：識別建築防衛構件。外牆開口極小，外窄內寬，稱為「銃眼（槍孔）」。 ｜為什麼：外小內大幾何構造既能減少外界彈石射入機率，又能提供內部寬廣的射擊視野。",
            "步驟 3：總結建築功能與文化意涵。防範盜匪入侵，同時可由內部向外觀察與架槍射擊，為台灣傳統防禦型客家建築之典型構造。 ｜為什麼：反映移民社會在歷史生存競爭環境下的建築智慧與空間適應。"
          ],
          "answer": "稱為「銃眼 (槍孔)」，主要功能為防禦敵襲與內向外射擊。",
          "hints": [
            "分析題目時間背景、空間尺度與歷史核心制度/機制",
      ...
      "illustrations": [
        ...
        "comparison.webp",
        "step-by-step.webp",
        "history-real-world.webp",
        "history-infographic.webp"
      ],
      "concepts": [
        {
        ...
        },
        {
          ...
          "table": {
            ...
            "rows": [
              [
                "燕尾脊 (Swallowtail Roof)",
                "屋脊兩端昂揚起翹如燕尾分叉",
                "傳統官紳、科舉中舉者或重要寺廟專用，象徵尊貴地位"
              ],
              [
                "馬背 (Saddleback Wall)",
                "山牆頂端封火山牆曲線形制",
                "依金、木、水、火、土五行造型演變，常見於一般民居"
              ],
              [
                "抬梁式棟架 (Post-and-Beam)",
                "柱頂置大梁，大梁上立瓜柱支承短梁",
                "室內柱少、空間寬敞大氣，多用於寺廟正殿與大宅正廳"
              ],
              [
                "穿斗式棟架 (Column-and-Tie)",
                "落地柱密集，以穿枋橫向貫穿貫柱",
                "結構整體性強、抗震性佳、省材，廣泛應用於民居護龍"
              ],
              [
                "對場作 (Battle of Craftsmen)",
                "左右兩側由不同匠師獨立設計施工",
                "展現匠師技藝競爭，形成左右風格微殊的奇趣工藝現象"
              ]
            ]
          }
        },
          ...
          "table": {
            ...
            "rows": [
              [
                "初期 (1895-1907)",
                "木造擬洋風、木造洋風",
                "木造防震、熱帶陽台（Veranda Style）、疊蓆空間",
                "原台灣總督官邸（初期）、基隆港務合同廳舍"
              ],
              [
                "中期 (1908-1929)",
                "西洋歷史式樣、辰野風格",
                "紅磚造、鋼筋混凝土、白石飾帶、古典柱式、塔樓",
                "台灣總督府 (野村一郎/長野宇平治/森山松之助)、原台南地方法院 (森山松之助)"
              ],
              [
                "後期 (1930-1945)",
                "折衷主義、現代主義、帝國冠帽樣式",
                "鋼筋混凝土、國防色面磚（刮痕面磚）、簡化幾何裝飾、日式大屋頂",
                "台南林百貨 (梅澤捨次郎)、原高雄市役所 (井手薰設計帝國冠帽式樣)"
              ]
            ]
          }
        },
          ...
          "table": {
            ...
            "rows": [
              [
                ...
                "擺脫古典三段式繁複裝飾，簡化線條",
                "洗石子、面磚、幾何圖騰、簡化柱式",
                "台北郵局 (栗山俊一)、台南林百貨 (梅澤捨次郎)"
              ],
              [
                "帝國冠帽樣式 (Imperial Crown)",
                "日本帝國軍國主義強化東亞文化正統",
                "鋼筋混凝土主體 + 日式/東亞傳統大屋頂",
                "原高雄市役所 (井手薰)、原高雄驛 (清水組)"
              ],
          ...
          "table": {
            ...
            "rows": [
              ...
              [
                ...
                "西方現代主義構造 + 東方空間意意轉化",
                "RC懸臂梁、拋物線薄殼、簡化幾何線條",
                "王大閎 (國父紀念館)、貝聿銘/陳其寬 (路思義教堂)"
              ],
              [
                "前衛現代主義",
                "自由曲面、雕塑感造型與機能結合",
                "清水混凝土、塑形薄殼、有機曲線",
                "修澤蘭 (衛理女中、聖心女中)、陳仁和 (高雄高雄中學體育館)"
              ]
            ]
          }
        },
          ...
          "table": {
            ...
            "rows": [
              [
                "宜蘭厝運動",
                "探索台灣亞熱帶風土民居新樣式",
                "大斜屋頂防雨、深出簷遮陽、高床通風、本土洗石子/紅磚",
                "宜蘭厝一期與二期作品、黃聲遠作品"
              ],
              [
                "田中央工作群",
                "建築與自然地貌、都市公共生活無縫融合",
                "鋼構造、鋼筋混凝土、開放性半戶外廊道、景觀共生",
                "羅東文化工場、津梅棧道、宜蘭縣政府"
              ],
              [
                "永續當代綠建築",
                "國際現代主義 + 台灣EEWH九大指標",
                "雙層呼吸外牆、太陽能光電、雨水滯洪生態池",
                "台北市立圖書館北投分館 (九典聯合)、臺大社會科學院 (伊東豊雄)"
              ]
            ]
          }
        }
      ...
      "practices": [
        {
          ...
          "steps": [
            "**步驟一**：分析抬梁式（Post-and-Beam System）結構。柱上立梁，梁上疊置短柱與次梁，柱距較大，室內無落地柱，提供開闊之廳堂空間，適合用於寺廟大殿與正廳。 ｜為什麼：依據歷史核心脈絡與法理/空間邏輯推理。",
            "**步驟二**：分析穿斗式（Column-and-Tie System）結構。落地柱較密集，用穿枋穿過木柱形成檁木支承架構，用料較小且整體框架性極佳，具有良好抗震性，適合一般民居與護龍。 ｜為什麼：依據歷史核心脈絡與法理/空間邏輯推理。",
            "**步驟三**：綜合比較兩者適應性與空間效益。 ｜為什麼：依據歷史核心脈絡與法理/空間邏輯推理。"
          ],
        ...
        },
        {
          ...
          "steps": [
            "**步驟一**：指出空間規制影響。市區改正強制實施棋盤式街道拓寬與騎樓（亭仔腳）退縮留設，確定了街屋面寬狹窄、縱深極長的長條形格局。 ｜為什麼：依據歷史核心脈絡與法理/空間邏輯推理。",
            "**步驟二**：分析立面材料與風格轉型。立面由清代木構山牆轉變為日治中期洗石子、泥塑巴洛克山牆（如大溪、湖口老街），再演變為1930年代裝飾風藝術（Art Deco）幾何面磚。 ｜為什麼：依據歷史核心脈絡與法理/空間邏輯推理。",
            "**步驟三**：說明公共衛生與設施改善。導入下水道系統與防火牆規範，完成了台灣現代都市街廓的建立。 ｜為什麼：依據歷史核心脈絡與法理/空間邏輯推理。"
          ],
        ...
        },
        {
          ...
          "steps": [
            "**步驟一**：分析國父紀念館（王大閎）。採用鋼筋混凝土框架結構，以簡化的古典大屋頂飛簷意象轉化傳統宮殿，翹角處以現代懸臂樑與結構節點處理，空間保持極簡與嚴謹中軸對稱。 ｜為什麼：依據歷史核心脈絡與法理/空間邏輯推理。",
            "**步驟二**：分析路思義教堂（貝聿銘/陳其寬）。採用現代RC雙曲面薄殼（Hyperbolic Paraboloid Shell）結構，完全摒棄傳統屋頂與斗拱符號，卻透過四片薄殼分離交會產生的天窗光束與祈手姿態，深刻體現東方天人合一與宗教神聖意象。 ｜為什麼：依據歷史核心脈絡與法理/空間邏輯推理。",
            "**步驟三**：比較歸納兩者哲學。國父紀念館為「古典構件與符號之現代極簡抽象化」；路思義教堂則為「構造力學形體與傳統精神意境之隱喻昇華」。 ｜為什麼：依據歷史核心脈絡與法理/空間邏輯推理。"
          ],
        ...
        },
        {
          ...
          "steps": [
            "**步驟一**：材料檢視。兩者皆採用歐洲引進之熱帶紅磚、石灰、糯米汁與糖水混和之三合土，抵抗台灣高溫多濕與鹽霧侵蝕。 ｜為什麼：依據歷史核心脈絡與法理/空間邏輯推理。",
            "**步驟二**：防禦幾何。熱蘭遮城採用標準歐洲稜堡（Bastion Trace）幾何設計，設有外突四角稜堡以消除火槍射擊死角。 ｜為什麼：依據歷史核心脈絡與法理/空間邏輯推理。",
            "**步驟三**：熱帶適應。堡壘內部配置厚重磚石外牆與通風拱券，提供物資儲藏與防禦掩體機能。 ｜為什麼：依據歷史核心脈絡與法理/空間邏輯推理。"
          ],
        ...
        },
        {
          ...
          "steps": [
            "**步驟一**：分析雨水排除。大傾角斜屋頂能迅速導引宜蘭地區豐沛之冬季地形雨與夏季颱風暴雨。 ｜為什麼：依據歷史核心脈絡與法理/空間邏輯推理。",
            "**步驟二**：分析遮陽與壁面防護。大深度的出簷能避免陽光直射牆面，並防止豪雨濺濕牆體與開口。 ｜為什麼：依據歷史核心脈絡與法理/空間邏輯推理。",
            "**步驟三**：分析高床防潮通風。將建築底層架高（高床）使空氣於底層流動，隔絕地表濕氣並促進對流順暢。 ｜為什麼：依據歷史核心脈絡與法理/空間邏輯推理。"
          ],
        ...
        },
        {
          ...
          "steps": [
            "**步驟一**：觀察外牆材料與配色。主體採用紅磚外牆，搭配水平連續之白色石材飾帶（Red brick with white stone bands）。 ｜為什麼：依據歷史核心脈絡與法理/空間邏輯推理。",
            "**步驟二**：觀察頂層與屋頂。常用曼薩頂（Mansard Roof）或中央高聳塔樓以形塑公共權威感。 ｜為什麼：依據歷史核心脈絡與法理/空間邏輯推理。",
            "**步驟三**：觀察門口與窗框。入口處常設置古典柱式門廊與圓拱/幾何拱券。 ｜為什麼：依據歷史核心脈絡與法理/空間邏輯推理。"
          ],
    ...
    },
    {
      ...
      "worked_examples": [
        {
          ...
          "difficulty": "中等",
          "steps": [
            "步驟 1：理解「材」的定義。「材」為斗拱拱截面之高與厚，以此作為整座建築構件比例之模數 (Module)。 ｜為什麼：宋代營造法式確立材分制，以單一基準構件尺寸建立全面性建築比例網絡。",
            "步驟 2：分析材份制的作用。根據建築等級選擇材等（第一等至第八等），所有梁柱斗拱之尺寸均為「材」的倍數（分）。 ｜為什麼：透過嚴謹的數學模數化，不同工匠在不同地點皆能預先精準開料施工。",
            "步驟 3：總結歷史意義。實現了中國古代木結構建築之模數化、標準化與預製化設計，兼具禮制階級規範與工料預算控制。 ｜為什麼：材份制是中國古代營建體系高度成熟與工業化思維的巔峰代表。"
          ],
      ...
      "concepts": [
        ...
        },
        {
          ...
          "table": {
            ...
            "rows": [
              ...
              [
                "懸山頂 (Gable Roof with overhang)",
                "五脊二坡，屋頂挑出山牆之外",
                "中等級（一般官署/富商大宅）",
                "江南民居、文人住宅正廳"
              ],
              [
                "硬山頂 (Gable Roof inside wall)",
                "五脊二坡，山牆封頂擋住屋檐",
                "一般民居等級（防護防火）",
                "北方傳統四合院民居"
              ]
        ...
        },
        {
          ...
          "table": {
            "headers": [
              "造景手法 (Landscaping Method)",
              "工法機制與構件",
              "空間藝術效果與哲學視角"
            ],
            "rows": [
              [
                "借景 (Borrowing Scenery)",
                "引園外塔影、山峰或鄰園景物入視線",
                "擴大園林視覺深度，打破園牆空間封閉感"
              ],
              [
      ...
      "practices": [
        {
          ...
          "steps": [
            "**步驟一**：說明材之高寬比例。以「材」為標準模量，材高為 15 分，材厚（寬）為 10 分，高寬比固定為 3:2。 ｜為什麼：依據歷史核心脈絡與法理/空間邏輯推理。",
            "**步驟二**：說明八等材分類。依建築規模分為一等材至八等材，決定屋架、斗拱與梁柱尺寸。 ｜為什麼：依據歷史核心脈絡與法理/空間邏輯推理。",
            "**步驟三**：分析工料預算與預製價值。材分制度確立無單位之比例模數，使木構件可以在工場進行標準化預製生產，並使官方能精準預算木材消耗與人力工時。 ｜為什麼：依據歷史核心脈絡與法理/空間邏輯推理。"
          ],
        ...
        },
        {
          ...
          "steps": [
            "**步驟一**：幾何結構分析。庑殿頂為五脊四坡，四面斜坡落水；歇山頂為九脊殿，上半部為懸山（雙坡山牆），下半部為四坡庑殿檐。 ｜為什麼：依據歷史核心脈絡與法理/空間邏輯推理。",
            "**步驟二**：禮制等級比較。庑殿頂為皇權專用最高等級；歇山頂等級次之，常用於次要大殿、官署或重要門樓。 ｜為什麼：依據歷史核心脈絡與法理/空間邏輯推理。",
            "**步驟三**：代表作品舉例。紫禁城太和殿為重檐庑殿頂；保和殿與天安門則為重檐歇山頂。 ｜為什麼：依據歷史核心脈絡與法理/空間邏輯推理。"
          ],
        ...
        },
        {
          ...
          "steps": [
            "**步驟一**：借景。將園外之遠山、塔影或天空景致引入園內視線（如拙政園借景北寺塔），無限擴展有限空間之視覺深度。 ｜為什麼：依據歷史核心脈絡與法理/空間邏輯推理。",
            "**步驟二**：框景。利用月洞門、方形窗框或廊柱邊框，將自然庭園景色裁切框取為立體畫卷。 ｜為什麼：依據歷史核心脈絡與法理/空間邏輯推理。",
            "**步驟三**：障景。於園林入口處設置假山、照壁或曲廊，擋住直線視野，創造「曲徑通幽」、漸入佳境之空間懸念。 ｜為什麼：依據歷史核心脈絡與法理/空間邏輯推理。"
          ],
        ...
        },
        {
          ...
          "steps": [
            "**步驟一**：斗拱機能演變。唐代斗拱碩大（佔柱高1/3），具備極高之結構傳力與挑檐機能；清代斗拱比例顯著縮小，結構傳力作用減弱，裝飾符號性質增強。 ｜為什麼：依據歷史核心脈絡與法理/空間邏輯推理。",
            "**步驟二**：屋頂坡度演變。唐代屋頂坡度平緩（舉折平緩）、出檐深遠雄厚；清代屋頂坡度陡峭（舉架陡峭）、出檐相對較短。 ｜為什麼：依據歷史核心脈絡與法理/空間邏輯推理。",
            "**步驟三**：模組制度演變。唐宋採用「材分制」，清代演變為「斗口制」。 ｜為什麼：依據歷史核心脈絡與法理/空間邏輯推理。"
          ],
        ...
        },
        {
          ...
          "steps": [
            "**步驟一**：馬頭牆機能。徽派村落房屋密度極高，高出屋面之階梯狀馬頭牆能在鄰棟火災時有效阻隔火勢蔓延（封火牆），同時兼具防風機能。 ｜為什麼：依據歷史核心脈絡與法理/空間邏輯推理。",
            "**步驟二**：四水歸堂機能。四面屋頂斜坡向中央天井傾斜，雨水匯集流入天井下水槽，象徵「財不外流」；實務上提供室內採光、自然對流通風與雨水收集利用。 ｜為什麼：依據歷史核心脈絡與法理/空間邏輯推理。"
          ],
        ...
        },
        {
          ...
          "steps": [
            "**步驟一**：瘦 (Slenderness)。石體造型挺拔苗條、線條清秀。 ｜為什麼：依據歷史核心脈絡與法理/空間邏輯推理。",
            "**步驟二**：漏 (Leakage/Porosity)。石體內部溝槽通透，雨水穿流順暢。 ｜為什麼：依據歷史核心脈絡與法理/空間邏輯推理。",
            "**步驟三**：透 (Transparency)。石體透光通孔，具穿透感與空靈度。 ｜為什麼：依據歷史核心脈絡與法理/空間邏輯推理。",
            "**步驟四**：皺 (Wrinkling)。石體表面紋理褶皺豐富，富於歲月風化之質感變化。 ｜為什麼：依據歷史核心脈絡與法理/空間邏輯推理。"
          ],
      ...
      "worked_examples": [
        {
          ...
          "difficulty": "基礎",
          "steps": [
            "步驟 1：對比羅馬式建築結構侷限。羅馬式採用半圓拱與厚重實體牆承重，因側向推力龐大，開窗極小且室內陰暗。 ｜為什麼：半圓拱受自重與頂部載重時，會在拱腳產生向外的巨大水平分力。",
            "步驟 2：識別哥德式結構兩大關鍵突破。1.「尖拱 (Pointed Arch)」使力的傳遞更偏向垂直，大幅減小側向推力；2.「飛扶壁 (Flying Buttress)」將高聳穹頂側推力凌空引導至室外獨立厚重墩柱。 ｜為什麼：透過力流外引，原本封閉厚實的承重牆得以解放，轉換為大型彩繪鑲嵌玻璃花窗。",
            "步驟 3：總結力學與宗教空間意象。尖拱與飛扶壁之結合，創造出前所未有的高聳垂直向上空間感與神聖光影效果。 ｜為什麼：哥德式建築實現了力學平衡與宗教昇華精神的完美統一。"
          ],
      ...
      "concepts": [
        {
          ...
          "table": {
            ...
            "rows": [
              [
                "古希臘建築",
                "梁柱構造 (Post-and-Lintel)",
                "多立克、愛奧尼、柯林斯柱式",
                "追求外觀幾何比例和諧與雕塑感 (雅典帕德嫩神殿)"
              ],
              [
                "古羅馬建築",
                "拱券 + 混凝土構造",
                "疊柱式 (Tiered Orders)、拱頂、穹頂",
                "追求宏偉實用的內部大跨度公共空間 (萬神殿、羅馬競技場)"
              ]
            ]
          }
        },
          ...
          "table": {
            ...
            "rows": [
              [
                ...
                "靜態幾何對稱、正圓與正方形、柱式規範",
                "理性、勻稱、和諧清澈",
                "Brunelleschi (聖母百花穹頂)、Palladio (圓頂別墅)"
              ],
              [
                "巴洛克 (17世紀)",
                "動態曲面、橢圓形平面、波浪狀立面",
                "強烈明暗對比、戲劇性雕塑與天花壁畫",
                "Bernini (聖彼得廣場)、Borromini (四噴泉聖卡羅)"
              ],
              [
                "洛可可 (18世紀)",
                "室內細膩不對稱曲線、貝殼與花飾",
          ...
          "table": {
            ...
            "rows": [
              [
                "水晶宮 (1851)",
                "預製鑄鐵 + 模組化玻璃",
                "完全預制裝配式施工，僅數月完成大跨度展館",
                "工業化預製建築之始祖"
              ],
              [
                "艾菲爾鐵塔 (1889)",
                "鍛鐵格構梁 (Wrought Iron Truss)",
                "高度突破 300 公尺，極致展現金屬格構結構力學",
                "近代結構工程與鋼鐵建築地標"
              ],
              [
                "芝加哥學派高樓",
                "鋼骨框架 (Steel Frame) + 鋼筋混凝土",
                "配合升降機技術，實現高層商業辦公大樓發展",
                "提出「形隨機能」，奠定摩天大樓發展"
              ]
            ]
          }
          ...
          "table": {
            ...
            "rows": [
              [
                "Le Corbusier",
                "居住是居住的機器、新建築五點",
                "RC Dom-Ino 骨架、清水混凝土、底層架高",
                "薩伏伊別墅 (Villa Savoye)、廊香教堂"
              ],
              [
                "Mies van der Rohe",
                "Less is More (少即是多)、通用空間",
                "鋼骨結構、工字鋼外露細部、玻璃帷幕牆",
                "范斯沃斯住宅 (Farnsworth House)、西格拉姆大樓"
              ],
              [
                "Frank Lloyd Wright",
                "有機建築 (Organic Architecture)",
                "懸臂混凝土台階、自然石材、草原學派水平線",
                "落水山莊 (Fallingwater)、古根漢美術館"
              ],
              [
                "Walter Gropius (包浩斯)",
                "機能主義、工藝與工業技術結合",
                "鋼筋混凝土、玻璃轉角帷幕、無裝飾幾何體",
                "德紹包浩斯校舍 (Bauhaus Dessau)"
              ]
            ]
          }
        },
          ...
          "table": {
            ...
            "rows": [
              [
                ...
                "「少即是枯躁」、復興古典歷史符號與雙重解讀",
                "傳統混凝土與外牆飾板裝飾化",
                "Robert Venturi (母宅)、Philip Johnson (AT&T大樓)"
              ],
              [
                "解構主義 (Deconstructivism)",
                "打破正交幾何、碎片化、扭曲流體曲面",
                "CATIA/Rhino 3D 參數化數位設計與金屬鈦板",
                "Frank Gehry (畢爾包古根漢)、Zaha Hadid (羅馬MAXXI)"
              ],
              [
                "高科技/永續當代",
                "結構外露美學、自然對流通風、極致節能生態",
                "BIM 資訊模型、雙層呼吸帷幕牆、光電板整合",
                "Norman Foster (倫敦瑞士再保大樓)、BIG (CopenHill)"
              ]
            ]
          }
        }
      ...
      "practices": [
        {
          ...
          "steps": [
            "**步驟一**：底層架高 (Pilotis)。採用鋼筋混凝土柱將建築底層架空，將地面空間還給都市與行人通行。 ｜為什麼：依據歷史核心脈絡與法理/空間邏輯推理。",
            "**步驟二**：屋頂花園 (Roof Garden)。在平屋頂上設置景觀花園與空中活動空間，補償建築佔用之地表綠地。 ｜為什麼：依據歷史核心脈絡與法理/空間邏輯推理。",
            "**步驟三**：自由平面 (Free Plan)。因採用 RC 柱梁框架承重，牆體不再承重，可依機能自由劃分隔間。 ｜為什麼：依據歷史核心脈絡與法理/空間邏輯推理。",
            "**步驟四**：自由立面 (Free Facade)。外牆脫離承重機能，可依採光與視覺需求自由開窗設計。 ｜為什麼：依據歷史核心脈絡與法理/空間邏輯推理。",
            "**步驟五**：橫向長窗 (Ribbon Window)。開設水平連續之長條窗，使採光均勻深入室內深處。 ｜為什麼：依據歷史核心脈絡與法理/空間邏輯推理。"
          ],
        ...
        },
        {
          ...
          "steps": [
            "**步驟一**：分析尖拱 (Pointed Arch)。相較於半圓拱，尖拱能產生更向上之垂直力分量，顯著降低外推之水平側推力。 ｜為什麼：依據歷史核心脈絡與法理/空間邏輯推理。",
            "**步驟二**：分析肋骨拱頂 (Ribbed Vault)。將天花板重力集中於拱頂交叉之骨架肋條上，使拱頂夾角處可以做得極薄極輕。 ｜為什麼：依據歷史核心脈絡與法理/空間邏輯推理。",
            "**步驟三**：分析飛扶壁 (Flying Buttress)。將高聳中殿牆頂所承受之殘餘側向推力，透過戶外拱形飛扶壁引導傳遞至室外獨立之扶壁柱上。 ｜為什麼：依據歷史核心脈絡與法理/空間邏輯推理。",
            "**步驟四**：綜合效果。牆體不再需要作為厚重承重牆，因而能大量開鑿高聳之彩繪花窗。 ｜為什麼：依據歷史核心脈絡與法理/空間邏輯推理。"
          ],
        ...
        },
        {
          ...
          "steps": [
            "**步驟一**：幾何控制。文藝復興採用靜態、理性之正圓、正方形與完美幾何比例（如 Palladio 圓頂別墅）；巴洛克採用動態、不穩定之橢圓形、雙曲面與波浪狀幾何（如 Borromini 四噴泉教堂）。 ｜為什麼：依據歷史核心脈絡與法理/空間邏輯推理。",
            "**步驟二**：光影氛圍。文藝復興追求均勻、明亮、清晰理性之光線；巴洛克追求強烈明暗對比（Chiaroscuro）與頂光、隱藏光束引發之戲劇張力。 ｜為什麼：依據歷史核心脈絡與法理/空間邏輯推理。",
            "**步驟三**：裝飾態度。文藝復興裝飾嚴格遵守古典柱式規範與勻稱；巴洛克裝飾極盡富麗堂皇，將建築、繪畫與雕塑三者無縫融合。 ｜為什麼：依據歷史核心脈絡與法理/空間邏輯推理。"
          ],
        ...
        },
        {
          ...
          "steps": [
            "**步驟一**：Mies 機能主義態度。主張去除一切非必要之裝飾，追求結構與材料之純粹外露，創立通用空間與鋼骨玻璃極簡美學。 ｜為什麼：依據歷史核心脈絡與法理/空間邏輯推理。",
            "**步驟二**：Venturi 後現代主義態度。批判現代主義之單調枯燥與冷漠，主張復興古典歷史符號、隱喻、雙重解讀與建築之複雜性與矛盾性。 ｜為什麼：依據歷史核心脈絡與法理/空間邏輯推理。",
            "**步驟三**：總結對立本質。Mies 追求「抽象純粹與幾何秩序」；Venturi 追求「多元包容與符號象徵」。 ｜為什麼：依據歷史核心脈絡與法理/空間邏輯推理。"
          ],
        ...
        },
        {
          ...
          "steps": [
            "**步驟一**：骨材漸輕化。自穹頂基座向上至頂部，混凝土骨材由重質之玄武岩、碎磚演變為極輕之浮石（Pumice）。 ｜為什麼：依據歷史核心脈絡與法理/空間邏輯推理。",
            "**步驟二**：牆體與頂部厚度漸薄。基座牆厚達 6.2 公尺，向上漸薄至頂部僅約 1.5 公尺。 ｜為什麼：依據歷史核心脈絡與法理/空間邏輯推理。",
            "**步驟三**：天花陷窩 (Coffers)。於穹頂內壁設置 5 層凹陷之幾何陷窩（格天井），大幅減輕軀體自重。 ｜為什麼：依據歷史核心脈絡與法理/空間邏輯推理。",
            "**步驟四**：頂部圓洞 (Oculus)。頂部開設直徑 9 公尺之中央頂光圓洞，消除了頂部應力集中區並提供採光。 ｜為什麼：依據歷史核心脈絡與法理/空間邏輯推理。"
          ],
        ...
        },
        {
          ...
          "steps": [
            "**步驟一**：突破幾何限制。透過參數化演算法（Algorithmic Modeling）精準生成複雜之雙曲面、流體與非正交幾何體。 ｜為什麼：依據歷史核心脈絡與法理/空間邏輯推理。",
            "**步驟二**：數位製造整合 (CAM)。將 3D 模型數據直接傳輸至 CNC 數控機床與工業機器人，進行金屬鈦板或雙曲面混凝土面板之精準預製裁切。 ｜為什麼：依據歷史核心脈絡與法理/空間邏輯推理。",
            "**步驟三**：衝突檢測與構造施工。利用數位模型解決自由曲面結構節點之複雜受力與管線衝突。 ｜為什麼：依據歷史核心脈絡與法理/空間邏輯推理。"
          ],
      ...
      "worked_examples": [
        {
          ...
          "difficulty": "基礎",
          "steps": [
            "步驟 1：回顧新建築五點核心主張。1. Pilotis (底層架空柱), 2. Roof Garden (屋頂花園), 3. Free Plan (自由平面), 4. Free Facade (自由立面)。 ｜為什麼：科比意在薩伏伊別墅 (Villa Savoye) 中完整實踐這五大現代建築宣言。",
            "步驟 2：識別第五點「橫向帶狀長窗」。英文為 Ribbon Window 或 Horizontal Window，打破傳統承重牆垂直開窗的限制。 ｜為什麼：水平帶狀開窗能為室內提供連續全景視野與均勻充足之自然採光。",
            "步驟 3：分析帶狀長窗成立之力學前提。得益於鋼筋混凝土 (RC) 框架柱梁結構，外牆不再承擔上部樓板自重，外皮因而成為自由構件。 ｜為什麼：現代結構力學技術的進步直接催生了新建築形式的解放。"
          ],
      ...
      "concepts": [
        ...
        },
        {
          ...
          "table": {
            ...
            "rows": [
              [
                "Louis Sullivan",
                "Form Follows Function (形隨機能)",
                "建築造型與立面應直接反映內部空間與結構機能",
                "奠定芝加哥學派與高樓摩天大樓發展基石"
              ],
              [
                "Adolf Loos",
                "Ornament and Crime (裝飾即罪惡)",
                "裝飾是文化落後的表現，浪費勞動力與材料",
                "推動純粹幾何體與白牆無裝飾現代主義"
              ],
              [
                ...
                "建築為高效率之生活單元，應貫徹標準化與工業化",
                "啟發社會住宅、模組化建築與都市計畫集約化"
              ]
            ]
          }
        },
          ...
          "table": {
            ...
            "rows": [
              [
                "土地與景觀融和",
                "順應山坡與溪流地形配置量體，避免大開挖",
                "落水山莊 (Fallingwater)：懸臂台階跨越熊溪瀑布"
              ],
              [
                "流動空間 (Flowing Space)",
                "打破傳統房間盒子封閉感，客餐廳連續貫通",
                "羅比宅 (Robie House)：巨型出簷與水平流動空間"
              ],
              [
                "材料真實性 (Nature of Materials)",
                "外露當地野石、紅磚與天然木材，不加覆蓋飾面",
                "西塔里埃森 (Taliesin West)：當地沙漠岩石與木架"
              ]
            ]
          }
        },
        {
          ...
          "table": {
            "headers": [
              "理論比較",
              "全球樣式 (International Style)",
              "傳統鄉土 (Vernacular)",
              "批判地域主義 (Critical Regionalism)"
            ],
            "rows": [
              [
                "技術與材料",
              ...
              [
                ...
                "忽略當地氣候文脈、依賴空調",
                "完全受限當地風土材料與氣候",
                "以現代構造批判性地回應當地氣候光影與地貌"
              ],
              [
                "代表作品",
                "紐約西格拉姆大樓",
                "傳統閩南三合院民居",
                "安藤忠雄光之教堂、Utzon 悉尼歌劇院"
              ]
            ]
          }
        },
          ...
          "table": {
            ...
            "rows": [
              [
                "Norberg-Schulz",
                "Genius Loci (場所精神)",
                "建築旨在將抽象空間轉化為具備認同感之「場所」",
                "傳統聚落與歷史城鎮紋理保存"
              ],
              [
                "Juhani Pallasmaa",
                "The Eyes of the Skin (皮膚的眼睛)",
                "批判視覺至上，倡導身體、觸覺與聲學多感官沉浸",
                "瓦爾斯溫泉浴室 (Peter Zumthor)：片岩觸感與水聲"
              ],
              [
                "Steven Holl",
                "Anchoring (錨定)",
                "建築應錨定於特定基地之地質、歷史與光線現象",
                "麻省理工學院奇斯格宿舍 (Simmons Hall)"
              ]
            ]
          }
        },
          ...
          "table": {
            ...
            "rows": [
              [
                "永續生態建築",
                "氣候變遷因應、淨零碳排、資源循環",
                "BIM 能源模擬、雙層外牆自然通風、太陽能光電",
                "倫敦市政廳 (Foster + Partners)"
              ],
              [
                "數位參數主義",
                "電腦演算、流體幾何、非線性組構",
                "Rhino + Grasshopper 參數化建模、CNC 數位製造",
                "北京麗澤 SOHO (Zaha Hadid Architects)"
              ]
            ]
          }
        }
      ...
      "practices": [
        {
          ...
          "steps": [
            "**步驟一**：解釋「形隨機能」意涵。主張建築之外部造型、立面分割與空間組構，必須完全由其內部之實際機能需求與結構傳力機制決定，而非盲目套用傳統古典歷史裝飾。 ｜為什麼：依據歷史核心脈絡與法理/空間邏輯推理。",
            "**步驟二**：分析對現代主義之影響。成為20世紀初芝加哥學派與包浩斯機能主義之核心綱領，促使建築師摒棄繁複歷史裝飾，轉向極簡、實用與結構外露之現代設計。 ｜為什麼：依據歷史核心脈絡與法理/空間邏輯推理。"
          ],
        ...
        },
        {
          ...
          "steps": [
            "**步驟一**：分析文化演化視角。Loos 認為隨著文化與文明進步，人體與物件表面擺脫紋身與冗餘裝飾是必然趨勢，裝飾是文化低落之表現。 ｜為什麼：依據歷史核心脈絡與法理/空間邏輯推理。",
            "**步驟二**：分析經濟與勞動視角。在工業化時代，製作無機能之手藝裝飾是對勞動力、時間與材料之巨大浪費。 ｜為什麼：依據歷史核心脈絡與法理/空間邏輯推理。",
            "**步驟三**：對建築形體之影響。倡導純粹幾何體、光滑白牆與注重內部空間品質（Raumplan 立體空間計畫）。 ｜為什麼：依據歷史核心脈絡與法理/空間邏輯推理。"
          ],
        ...
        },
        {
          ...
          "steps": [
            "**步驟一**：全球樣式態度。強調普遍適用性、鋼骨玻璃帷幕與正交幾何，忽視建築所在基地之特定氣候、地形與歷史脈絡，高度依賴人工空調與機械照明。 ｜為什麼：依據歷史核心脈絡與法理/空間邏輯推理。",
            "**步驟二**：批判地域主義態度。反對全球樣式之冷漠同質化，主張運用現代結構技術，深度回應當地的太陽角度、盛行風向、風土石材木料與歷史紋理。 ｜為什麼：依據歷史核心脈絡與法理/空間邏輯推理。",
            "**步驟三**：總結兩者差異。全球樣式為「去文脈化與普世標準化」；批判地域主義為「風土文脈與現代構造之批判性融合」。 ｜為什麼：依據歷史核心脈絡與法理/空間邏輯推理。"
          ],
        ...
        },
        {
          ...
          "steps": [
            "**步驟一**：材料與觸感。大量運用當地切片片麻岩（Vals Gneiss）堆疊牆體，提供溫潤粗糙之石材觸覺體驗。 ｜為什麼：依據歷史核心脈絡與法理/空間邏輯推理。",
            "**步驟二**：聲學與水聲。天花頂光與暗沉石室放大水滴聲與水流聲，形塑沉靜神聖之聲學場域。 ｜為什麼：依據歷史核心脈絡與法理/空間邏輯推理。",
            "**步驟三**：光影與水溫。結合縫隙頂光反射水面光斑，搭配不同溫度的泉水池，帶來極致之全身心感知沉浸。 ｜為什麼：依據歷史核心脈絡與法理/空間邏輯推理。"
          ],
        ...
        },
        {
          ...
          "steps": [
            "**步驟一**：地形與景觀契合。將建築量體直接錨定於天然瀑布岩石之上，使懸臂混凝土陽台延伸於熊溪之上。 ｜為什麼：依據歷史核心脈絡與法理/空間邏輯推理。",
            "**步驟二**：材料本真。室內壁爐直接採用基地天然露頭岩石，牆面使用當地野石砌築，展現材料天然質感。 ｜為什麼：依據歷史核心脈絡與法理/空間邏輯推理。",
            "**步驟三**：水平延伸。採用巨型懸臂混凝土梁，形塑與自然山林地平線平行之水平延伸視覺。 ｜為什麼：依據歷史核心脈絡與法理/空間邏輯推理。"
          ],
        ...
        },
        {
          ...
          "steps": [
            "**步驟一**：資材生產階段（蘊含碳 A1-A3）。評估建材（如水泥、鋼筋）採掘、運輸與製造過程之二氧化碳排放。 ｜為什麼：依據歷史核心脈絡與法理/空間邏輯推理。",
            "**步驟二**：施工興建階段（A4-A5）。評估工地機具運轉、運輸與施工廢棄物處理之碳排放。 ｜為什麼：依據歷史核心脈絡與法理/空間邏輯推理。",
            "**步驟三**：營運使用階段（B1-B7）。評估建築數十年使用期間之照明、空調、水資源與維護更換之營運碳。 ｜為什麼：依據歷史核心脈絡與法理/空間邏輯推理。",
            "**步驟四**：拆除回收階段（C1-D）。評估拆除處置與材料循環再利用（如廢鋼回收）之減碳效益。 ｜為什麼：依據歷史核心脈絡與法理/空間邏輯推理。"
          ],
      ...
      "worked_examples": [
        {
          ...
          "difficulty": "中等",
          "steps": [
            "步驟 1：瞭解文化資產保存核心哲學。強調「真實性 (Authenticity)」與「可逆性 (Reversibility)」，尊重不同歷史分期的疊加痕跡。 ｜為什麼：古蹟是歷史見證物，過度修繕或造假仿古會徹底抹殺文物的真正歷史價值。",
            "步驟 2：規範新舊構件識別原則。新添加之結構補強構件應與古蹟原物「可清晰識別（不可偽造古貌）」，避免後人誤認為歷史原創。 ｜為什麼：威尼斯憲章要求任何不可避免的現代工程干預皆必須打上當代印記。",
            "步驟 3：落實可逆性與最小干預原則。新構件之安裝在未來科技更發達時應可安全拆除，且拆除過程絕不破壞古蹟本體結構與原有材料。 ｜為什麼：確保對歷史遺產之干預降至最低，保留未來世代重新研究與修復之可能性。"
          ],
      ...
      "concepts": [
        ...
        },
        {
          ...
          "table": {
            ...
            "rows": [
              [
                "真實性 (Authenticity)",
                "保存古蹟歷經時代疊加之真實材料與施工痕跡",
                "優先修補舊構件，嚴禁無依據之憑空重建或仿古裝飾"
              ],
              [
                "可辨識性 (Recognizability)",
                "新添加之結構或修補構件必須能被辨識",
                "新舊交接處標註修復年份，或採用現代材料清晰區隔"
              ],
              [
                "可逆性 (Reversibility)",
                "新工法與加固材料未來可被安全移除",
                "使用螺栓連接鋼結構加固而非不可逆之焊接或粘死"
              ],
              [
                "最小干預 (Minimum Intervention)",
                "以維護結構安全所需之最小程度干預古蹟",
                "僅對結構損壞危及安全處進行加固，保留歲月質感"
              ]
            ]
          }
        },
        {
          ...
          "table": {
            ...
            "rows": [
              [
                "三維雷射掃描 (3D Laser Scanning)",
                "雷射光束點雲 (Point Cloud) 反射紀錄",
                "全區古蹟幾何形體、屋頂脊線、傾斜度",
                "高精度毫米級三維點雲模型、自動生成現況圖"
              ],
              [
                "抵抗波檢測儀 (Resistograph)",
                "微細鑽針旋轉推進阻力紀錄",
                "大木作梁柱、大木棟架內部",
                "檢測木材內部是否有白蟻蛀蝕或深層空洞腐朽"
              ],
              [
                "紅外線熱熱影像 (Thermography)",
                "檢測物體表面紅外線熱輻射差異",
                "古蹟磚石牆面、剪黏外牆、牆體內部",
                "精準定位外牆內部空鼓、水氣滲漏與壁癌發育區"
              ]
            ]
          }
        },
          ...
          "table": {
            ...
            "rows": [
              [
                ...
                "傳統大木作落地柱",
                "柱腳墩接工法 (榫卯拼接 + 石柱礎隔潮)",
                "嚴禁直接注入水泥砂漿包裹（會加速木材腐爛）"
              ],
              [
                "梁枋木材縱向裂縫",
                "大木作承重梁",
                "環氧樹脂 (Epoxy) 灌縫 + 嵌木條 + 環套加固",
                "嚴禁直接截斷替換（破壞歷史古意與墨書落款）"
              ],
              [
                "古磚牆灰漿脫落",
                "清代紅磚牆/三合土牆",
                "剔縫後重新勾縫 (採用糯米石灰灰漿)",
                "嚴禁使用純水泥砂漿（水泥硬度過高會壓碎古磚）"
              ]
            ]
          }
        },
        ...
        },
        {
          ...
          "table": {
            ...
            "rows": [
              [
                "木棟架耐震拉結",
                "安裝不鏽鋼拉桿 (Tie-rod) 與隱蔽式鋼節點加固",
                "提高整體結構抗震扭轉剛度，滿足《威尼斯憲章》可逆性"
              ],
              [
                "地基差異沉陷加固",
                "打設微型樁 (Micro-piles) 與高壓注漿加固",
                "不干擾地面古蹟本體，有效提升地基承載力"
              ],
              [
                "古蹟火災防護",
                "裝設極早期煙霧警報 (VESDA) 與細水霧滅火系統",
                "細水霧迅速滅火且水損極低，防止彩繪與木材水破壞"
              ]
            ]
          }
        }
      ...
      "practices": [
        {
          ...
          "steps": [
            "**步驟一**：說明真實性意涵。修復必須保存古蹟歷經不同歷史時期積澱之真實構構材料、工藝與歷史痕跡，嚴禁無依據之憑空偽造或仿古新建。 ｜為什麼：依據歷史核心脈絡與法理/空間邏輯推理。",
            "**步驟二**：說明可逆性意涵。所有新加入之結構加固工法（如鋼構拉桿、微型樁），未來若有更先進技術時，必須能夠被安全拆除並恢復古蹟原狀。 ｜為什麼：依據歷史核心脈絡與法理/空間邏輯推理。"
          ],
        ...
        },
        {
          ...
          "steps": [
            "**步驟一**：說明墩接工法步驟。先以臨時支撐架托換梁枋載重，將木柱腐朽段切除；選用相同木種進行透榫榫卯拼接修補，並於柱底設置防潮石柱礎（柱珠）。 ｜為什麼：依據歷史核心脈絡與法理/空間邏輯推理。",
            "**步驟二**：解釋禁用水泥原因。水泥封閉性極高且含鹼性水氣，直接包裹會使木材殘餘濕氣無法散逸，進一步加速木材內部二次腐爛與真菌滋生。 ｜為什麼：依據歷史核心脈絡與法理/空間邏輯推理。"
          ],
        ...
        },
        {
          ...
          "steps": [
            "**步驟一**：定義 Box in a Box。於歷史建築內部空間中，獨立興建一套自主承重之現代鋼結構或木結構空間單元。 ｜為什麼：依據歷史核心脈絡與法理/空間邏輯推理。",
            "**步驟二**：結構傳力優點。新建結構自成獨立傳力體系，將載重直接傳至地基，完全不施加額外載重於舊有歷史牆體之上。 ｜為什麼：依據歷史核心脈絡與法理/空間邏輯推理。",
            "**步驟三**：新舊界面處理。新舊結構間保留緩衝縫隙，滿足可逆性與最小干預原則，展現新舊空間之歷史對比。 ｜為什麼：依據歷史核心脈絡與法理/空間邏輯推理。"
          ],
        ...
        },
        {
          ...
          "steps": [
            "**步驟一**：三維雷射掃描應用。用於全區古蹟現況高精度測繪，發射數百萬點雷射點雲生成毫米級 3D 模型，獲取屋頂歪斜、牆體傾斜與結構變形數據。 ｜為什麼：依據歷史核心脈絡與法理/空間邏輯推理。",
            "**步驟二**：抵抗波檢測儀應用。用於大木作梁柱內部健康檢測，以細微針頭穿透木材，透過旋轉阻力曲線圖精準判定木材內部是否有空洞或白蟻蛀蝕。 ｜為什麼：依據歷史核心脈絡與法理/空間邏輯推理。",
            "**步驟三**：綜合優勢。兩者皆屬非破壞或微破壞檢測，能在不破壞古蹟本體前提下獲取精準科學數據。 ｜為什麼：依據歷史核心脈絡與法理/空間邏輯推理。"
          ],
        ...
        },
        {
          ...
          "steps": [
            "**步驟一**：指出補償機制。得依據《古蹟土地容積移轉辦法》申請「古蹟容積移轉」。 ｜為什麼：依據歷史核心脈絡與法理/空間邏輯推理。",
            "**步驟二**：運作機制說明。將古蹟保存區內因受法律限制而無法建築之基準容積（送出基地容積），經專業估價換算後，移轉至同都市計畫區內之其他可建築基地（接受基地）建築使用。 ｜為什麼：依據歷史核心脈絡與法理/空間邏輯推理。",
            "**步驟三**：效益分析。兼顧文化資產永久保存與人民財產權補償。 ｜為什麼：依據歷史核心脈絡與法理/空間邏輯推理。"
          ],
        ...
        },
        {
          ...
          "steps": [
            "**步驟一**：水損防護 (Water Damage)。細水霧噴出極微小水滴（粒徑 < 400 μm），用水量僅為傳統噴水系統之 10% 至 20%，能避免大量積水毀損古蹟木構與彩繪壁畫。 ｜為什麼：依據歷史核心脈絡與法理/空間邏輯推理。",
            "**步驟二**：滅火效率 (Extinction Efficiency)。細水霧受熱迅速汽化吸收巨量熱能，並排除氧氣形成窒息效應，滅火速度極快。 ｜為什麼：依據歷史核心脈絡與法理/空間邏輯推理。",
            "**步驟三**：管線隱蔽性。細水霧管徑小，易於古蹟內部進行隱蔽敷設，減少對古蹟視覺景觀之破壞。 ｜為什麼：依據歷史核心脈絡與法理/空間邏輯推理。"
          ],
      ...
      "worked_examples": [
        {
          ...
          "difficulty": "基礎",
          "steps": [
            "步驟 1：分析水晶宮設計者與材料突破。由園藝師約瑟夫·帕克斯頓 (Joseph Paxton) 設計，大膽採用工業革命產物：鑄鐵 (Cast Iron) 框架與平板玻璃。 ｜為什麼：傳統磚石拱券工法沉重緩慢，無法在短短 9 個月內建造出覆蓋 7 萬多平方公尺的宏大展館。",
            "步驟 2：解析模數化與乾式組裝工法。所有鐵件與玻璃尺度全面模數化，於工廠大量預製 (Pre-fabrication)，現場以螺栓卡榫快速組裝 (Dry Assembly)。 ｜為什麼：工廠標準化生產大幅縮減工期，並在世博會結束後能夠迅速拆卸並於他處異地重建。",
            "步驟 3：總結建築史與營建工藝革命。水晶宮的誕生宣告了建築告別純手工作坊，正式跨入工廠預製構件、工業化生產與空間大跨度的現代建築新紀元。 ｜為什麼：工業革命帶來的材料與工法變革，是推動現代建築運動萌芽的最根本動力。"
          ],
        ...
        },
        {
          ...
          "table": {
            ...
            "rows": [
              ...
              [
                "綠帶管制",
                "外圍劃定永久農業綠帶 (Greenbelt)，禁止擴張",
                "成為現代都市成長邊界 (UGB) 與綠帶法規先驅"
              ],
              [
                "自給自足",
                "包含住宅、工作、商業與農業，非單純臥房城市",
                "啟發當代新市鎮開發與 15 分鐘生活圈理念"
              ]
            ]
          }
        },
          ...
          "table": {
            ...
            "rows": [
              [
                ...
                "結構受損、耐震能力不足之老舊建物",
                "透過權利變換機制重構產權，享有容積獎勵",
                "大幅提升建物耐震與防災安全，提供公共開放空間"
              ],
              [
                "整建 (Rehabilitation)",
                "結構尚安全但立面老舊、無電梯之建物",
                "外牆拉皮、加裝無障礙電梯、耐震補強",
                "施工期短、經費低，快速改善老舊社區高齡可及性"
              ],
              [
                "維護 (Maintenance)",
                "歷史街區、整體風貌完好之社區",
        ...
        },
        {
          ...
          "table": {
            ...
            "rows": [
              ...
              [
                "都市熱島減緩",
                "留設都市風廊 (Wind Corridor)、綠屋頂、高反射率鋪面",
                "引導海風與山風吹入市區，帶走蓄熱",
                "降低都市中心區域平均氣溫 1.5-2.0°C"
              ],
              [
                "智慧數位治理",
                "都市數位雙生 (Digital Twin) + IoT 微氣候感測器",
                "即時數據分析，自動調控智慧照明與水防淹警報",
                "提升都市能源使用效率與應變決策速度"
              ]
            ]
          }
      ...
      "practices": [
        {
          ...
          "steps": [
            "**步驟一**：分析欲解決之問題。欲解決工業革命後城市環境惡化、擁擠污染，以及鄉村人口流失、經濟衰退之雙重危機。 ｜為什麼：依據歷史核心脈絡與法理/空間邏輯推理。",
            "**步驟二**：解釋三磁鐵意涵。將「城市磁鐵」（就業與社交優點）與「鄉村磁鐵」（自然環境優點）結合為「城鄉-花園城市磁鐵」。 ｜為什麼：依據歷史核心脈絡與法理/空間邏輯推理。",
            "**步驟三**：說明空間配置特徵。採用圓形圈層規劃，中央為公共公園，外圍為住宅與產業區，最外圍由永久農業綠帶（Greenbelt）環繞，土地歸社區公有。 ｜為什麼：依據歷史核心脈絡與法理/空間邏輯推理。"
          ],
        ...
        },
        {
          ...
          "steps": [
            "**步驟一**：街道網絡改造。拆除舊中世紀擁擠街區，闢建寬廣放射狀林蔭大道（Boulevards）與圓環廣場，改善交通並利於軍事控管。 ｜為什麼：依據歷史核心脈絡與法理/空間邏輯推理。",
            "**步驟二**：立面規制。強制規定沿街建築採用統一高度、古典石材立面與曼薩頂，塑造尊貴都市形貌。 ｜為什麼：依據歷史核心脈絡與法理/空間邏輯推理。",
            "**步驟三**：基礎設施建設。興建龐大之地下下水道網路與供水系統，解決公共衛生與傳染病危機。 ｜為什麼：依據歷史核心脈絡與法理/空間邏輯推理。"
          ],
        ...
        },
        {
          ...
          "steps": [
            "**步驟一**：定義權利變換。權利變換為一種立體土地重劃機制。 ｜為什麼：依據歷史核心脈絡與法理/空間邏輯推理。",
            "**步驟二**：成本與價值計算。由專業估價師評估更新前原地主土地建物價值，以及更新後總房地價值。實施者投入之重建工程費、權利變換費、融資利息等稱為「共同負擔」。 ｜為什麼：依據歷史核心脈絡與法理/空間邏輯推理。",
            "**步驟三**：分配邏輯。更新後房地價值先扣除實施者之「共同負擔」折價抵付後，其餘剩餘價值依原地主更新前之權利價值比例進行配售分配。 ｜為什麼：依據歷史核心脈絡與法理/空間邏輯推理。"
          ],
        ...
        },
        {
          ...
          "steps": [
            "**步驟一**：核心理念。主張將都市重新組織為多中心鄰里，使居民在步行或單車 15 分鐘內即可滿足工作、生活、購物、醫療與休閒五大機能。 ｜為什麼：依據歷史核心脈絡與法理/空間邏輯推理。",
            "**步驟二**：應對高齡化。減少長者長途交通奔波，提供完善之鄰里步行無障礙環境與在地日照照護。 ｜為什麼：依據歷史核心脈絡與法理/空間邏輯推理。",
            "**步驟三**：應對氣候變遷。大幅降低私人汽機車使用，減少都市交通碳排放，促進微移動與綠色運輸。 ｜為什麼：依據歷史核心脈絡與法理/空間邏輯推理。"
          ],
        ...
        },
        {
          ...
          "steps": [
            "**步驟一**：透水鋪面。替代傳統不透水瀝青，使雨水能直接滲入地下補給地下水，降低地表逕流量。 ｜為什麼：依據歷史核心脈絡與法理/空間邏輯推理。",
            "**步驟二**：雨水花園。利用窪地植被與下滲過濾土層，滯留並淨化初期雨水。 ｜為什麼：依據歷史核心脈絡與法理/空間邏輯推理。",
            "**步驟三**：生態滯洪池。於暴雨時作為暫時蓄水池吸納洪峰流量，平時作為社區生態公園與微氣候降溫場域。 ｜為什麼：依據歷史核心脈絡與法理/空間邏輯推理。"
          ],
        ...
        },
        {
          ...
          "steps": [
            "**步驟一**：日治市區改正影響。著重於道路拓寬、騎樓留設與公共衛生基礎設施，屬於線狀與點狀之空間改造。 ｜為什麼：依據歷史核心脈絡與法理/空間邏輯推理。",
            "**步驟二**：戰後分區管制影響。劃分住宅區、商業區、工業區等，並導入「建蔽率」與「容積率」雙重指標。 ｜為什麼：依據歷史核心脈絡與法理/空間邏輯推理。",
            "**步驟三**：綜合效益。有效控制建築開發總密度、確保空地率與日照採光，防止不同機能用地相互干擾。 ｜為什麼：依據歷史核心脈絡與法理/空間邏輯推理。"
          ],
