  ...
  topics: [
    {
      ...
      concepts: [
        ...
        },
        {
          ...
          body: '戰後初期，政府倡導「中國宮殿式樣」（如圓山大飯店、國立歷史博物館、中正紀念堂），以鋼筋混凝土模擬古典木構大屋頂與斗拱彩繪，展現政治正統意象。1960年代起，王大閎、陳其寬、貝聿銘、修澤蘭等建築師將西方現代主義結構概念與中國傳統空間精神融合，創作了國父紀念館、東海大學路思義教堂與陽明山中山樓等經典作品。',
          steps: [
        ...
        },
        {
          ...
          body: '1980年代後，地域性現代主義（Regional Modernism）興起，如「宜蘭厝運動」探索亞熱帶氣候適應、本土磚石構造與綠建築設計，黃聲遠與田中央工作群更深化了建築與自然景觀的共生關係。當代台灣建築注重永續綠建築、氣候韌性與在地歷史紋理重組。',
          steps: [
            '地域現代主義：宜蘭厝、田中央工作群（宜蘭津梅棧道、羅東文化工場），強調在地脈絡、防雨遮陽與環境融和。',
            '當代綠建築與再生：結合太陽能、雨水回收、木構造與舊建築再利用。'
          ],
          table: {
      ...
      concepts: [
        {
          ...
          body: '中國傳統建築以木構造為核心骨幹。先秦與秦漢時期，盛行「夯土高台建築」，將建築基座築成巨大的夯土台塊，台上興建木構樓閣。隋唐時期，木構技術達到巔峰，以山西五台山佛光寺大殿（857年）與南禪寺大殿為代表。唐代建築特徵為：斗拱雄大碩巨、出檐深遠、柱子具傾斜之「側腳」與「生起」、屋頂坡度平緩舒展，呈現大氣磅礡之雄渾風格。',
          steps: [
            '先秦漢代：夯土台基、高台樓閣、半穴居與干欄式建築演變。',
            '隋唐大木作：斗拱高大（斗拱高度可達柱高1/2~1/3）、出檐達3-4公尺、屋頂坡度平緩（舉折較平）。'
          ],
          table: {
        ...
        },
        {
          ...
          body: '北宋崇寧二年（1103年），李誡編纂出版《營造法式》，為中國古代官方頒布規範建築設計、工料預算與施工標準之集大成專著。其核心創舉為確立「材分制度」（模組化/Modularity）。將大木作木材斷面標準分為一等材至八等材，以「材」之高度分為15「分」，寬度為10「分」（高寬比 3:2），所有建築構件之比例大小皆以「材分」為基準進行級數放大或縮小。',
          steps: [
            '一等材：最高等級，用於九間以上宮殿或大殿。',
            '材分控制：材高15分、材厚10分；以「分分」作為無單位之比例模數，實現預製化與工料控管。'
          ],
          table: {
        ...
        },
        {
          ...
          body: '明清時期，建築技術趨向高度規範化與符號化。清工部頒布《工程做法則例》，將宋代的材分制轉化為「斗口制」（以斗口寬度為模數）。宮殿建築嚴格遵循封建禮制，空間採嚴謹中軸對稱。屋頂形式劃分為明確的等級體系：庑殿頂 > 歇山頂 > 懸山頂 > 硬山頂。太和殿採用最高等級之「重檐庑殿頂」，搭配黃琉璃瓦、十隻脊獸與九五之尊間數。',
          steps: [
            '屋頂等級：重檐庑殿頂 > 重檐歇山頂 > 單檐庑殿頂 > 單檐歇山頂 > 懸山頂 > 硬山頂。',
            '色彩等級：黃琉璃瓦（皇帝專用） > 青綠琉璃瓦（王府/宗教） > 灰瓦（庶民）。'
          ],
          table: {
        ...
        },
        {
          ...
          body: '相對於北方皇園之宏偉對稱，江南文人私家園林（如蘇州拙政園、留園、網師園）強調「師法自然」、「雖由人作，宛自天開」之意境。園林設計融合詩情畫意，打破嚴謹中軸對稱，運用巧於因借、精在體宜之手法。造景工藝核心包含：疊石（運用太湖石、黃石堆疊假山）、理水（曲折池岸、聚分有致）、漏窗框景與借景（將園外景物引入園內）。',
          steps: [
            '借景 (Borrowing Scenery)：將園外遠山（如遠香堂借景北寺塔）或天空景物引入視線。',
            '對景與框景：利用門洞（月洞門）、漏窗、廊道形成畫框，隨步移景異。',
            '疊石理水：太湖石講究「瘦、漏、透、皺」四大審美標準。'
          ],
          table: {
        ...
        },
        {
          ...
          body: '中國廣袤土地因氣候、地形與文化差異，孕育出極具地域特色的民居形態。北方四合院強調日照與防風防沙；客家土樓（福建土樓）強調禦敵聚族而居；徽派建築以馬頭牆防火與白牆黑瓦為標誌；黃土高原窯洞則利用土層熱阻實現冬暖夏涼。',
          steps: [
            '北方四合院：坐北朝南、中軸對稱、坎宅巽門、注重私密性與冬日日照。',
            '徽派馬頭牆：階梯狀封火山牆，密集的村落中有效防止火災蔓延。'
          ],
          table: {
        ...
        },
        {
          ...
          body: '官式建築色彩受到五行學說與等級制度嚴格約束。黃色屬土位於中央代表帝王；紅色象徵尊貴與吉祥；青綠色代表陰涼與木育。彩繪工藝分為和璽彩繪（最高等級，金龍金鳳）、旋子彩繪（官署大殿，幾何旋花）與蘇式彩繪（江南園林，山水花鳥圖案）。',
          steps: [
            '和璽彩繪：枋心與箍頭全用金箔繪製金龍金鳳，專用於皇家主要大殿。',
            '旋子彩繪：以帶漩渦狀之幾何花紋為特徵，適用於一般官署與副殿。'
          ],
          table: {
      ...
      concepts: [
        {
          ...
          body: '古希臘建築確立了西洋古典建築之基石，創立三大柱式（Order）：多立克（Doric，雄渾樸素）、愛奧尼（Ionic，優雅捲渦）與柯林斯（Corinthian，華麗毛茛葉）。希臘建築以梁柱結構（Post-and-Lintel）為主，強調完美的幾何黃金比例與人體尺度（如帕德嫩神殿）。古羅馬則發明了「拱券結構（Arch & Vault）」與天然混凝土（PoZZolana），創造出萬神殿（Pantheon，43.3米無筋混凝土穹頂）與羅馬競技場（Colosseum），實現了大跨度內部空間之革命。',
          steps: [
            '希臘梁柱系統：黃金分割比 (1:1.618)、柱身微凸（Entasis）修正視覺錯覺。',
            '羅馬拱券體系：筒形拱（Barrel Vault）、交叉拱（Groin Vault）與穹頂（Dome）。'
          ],
          table: {
        ...
        },
        {
          ...
          body: '拜占庭建築發明了「帆拱（Pendentive）」技術，成功將圓形穹頂架設於方形平面之上（代表作：聖索菲亞大教堂）。12世紀起源於法國的哥德式建築（Gothic Architecture），則實現了結構力學與宗教精神之巔峰結合。哥德建築三大核心構件為：尖拱（Pointed Arch）、肋骨拱頂（Ribbed Vault）與外挑之飛扶壁（Flying Buttress）。這使外牆得以解脫承重機能，開設高聳彩繪鑲嵌玻璃窗（Rose Window），營造聖光降臨之神聖氛圍。',
          steps: [
            '帆拱技術：轉接方形基座與圓形穹頂之三角曲面轉角構造。',
            '哥德力學三要素：尖拱降低側推力 + 肋骨拱頂集體傳力 + 飛扶壁將側向推力引至室外扶壁柱。'
          ],
          table: {
        ...
        },
        {
          ...
          body: '15世紀義大利文藝復興（Renaissance）復興古典希臘羅馬理性，Brunelleschi 建造佛羅倫斯大教堂聖母百花大教堂穹頂，Alberti 與 Palladio 確立數學幾何比例與透視學規範（如帕拉底歐 Villa Rotonda）。17世紀巴洛克（Baroque）則打破文藝復興之靜態平衡，強調橢圓形平面、波浪狀曲面外牆、強烈明暗對比（Chiaroscuro）與戲劇性空間張力（如 Bernini 設計之聖彼得大教堂前廣場、Borromini 之四噴泉聖卡羅教堂）。',
          steps: [
            '文藝復興：靜態幾何（圓形、正方形）、古典柱式復興、人本理性。',
            '巴洛克：動態幾何（橢圓、雙曲面）、富麗堂皇裝飾、光影戲劇張力。'
          ],
          table: {
        ...
        },
        {
          ...
          body: '19世紀工業革命引爆材料與建造技術革命。鑄鐵（Cast Iron）、鍛鐵（Wrought Iron）、平板玻璃與鋼筋混凝土（RC）相繼問世。1851年倫敦萬國博覽會「水晶宮」（Crystal Palace，Joseph Paxton 設計）採用預製鐵骨與玻璃構造，開啟工業預製化建築新頁。1889年巴黎世博會艾菲爾鐵塔（Eiffel Tower）與機械館展示了鋼鐵之極限張力與大跨度空間力學。',
          steps: [
        ...
        },
        {
          ...
          body: '20世紀初，現代主義建築（Modernism）全面爆發，包浩斯（Bauhaus，Walter Gropius 創立）確立「藝術與技術統一」、「機能至上」之教學體系。現代主義四位大師各領風騷：Le Corbusier 提出「新建築五點」（五點包含底層架高、屋頂花園、自由平面、橫向長窗、自由立面）與「居住機器論」；Mies van der Rohe 倡導「Less is More（少即是多）」與鋼骨玻璃帷幕大樓；Frank Lloyd Wright 主張「有機建築（Organic Architecture）」與落水山莊；Alvar Aalto 則融合芬蘭木材工藝與人文溫情。',
          steps: [
        ...
        },
        {
          ...
          body: '1970年代，後現代主義（Postmodernism，Robert Venturi 提出「Less is a Bore」）反對現代主義之枯燥單調，復興古典符號與隱喻（如 Michael Graves、Philip Johnson）。1980年代末，解構主義（Deconstructivism）受到 Derrida 解構哲學影響，打破幾何正交秩序，展現傾斜、扭曲、碎片化與重力反叛（如 Frank Gehry、Zaha Hadid）。21世紀當代建築則全面導入 3D 參數化設計（Parametricism）、BIM 與永續生態低碳技術（如 Norman Foster、Bjarke Ingels BIG）。',
          steps: [
      ...
      concepts: [
        {
          ...
          body: '19世紀伴隨著工業革命與民族國家崛起，建築學界掀起了「歷史主義（Historicism）」與「折衷主義（Eclecticism）」風潮。建築師重新發掘歷史風格，產生新古典主義（Neoclassicism，強調羅馬希臘莊嚴）、哥德復興（Gothic Revival，強調中世紀宗教虔誠與手藝）與浪漫主義。當時建築學界陷入「樣式論爭（Battle of the Styles）」，即爭論何種歷史樣式最適合現代社會。',
          steps: [
        ...
        },
        {
          ...
          body: '20世紀初，Louis Sullivan 提出著名口號「形隨機能（Form Follows Function）」，宣告建築外形應由其內部實用機能與結構傳力決定。隨後 Adolf Loos 發表《裝飾與罪惡》（Ornament and Crime），極力批判冗餘裝飾。以 Bauhaus 與 CIAM（國際現代建築協會）為核心之機能主義者，將建築歸納為可量化之機能空間，推動全球樣式（International Style）發展。',
          steps: [
        ...
        },
        {
          ...
          body: '法蘭克·洛伊·萊特（Frank Lloyd Wright）提出「有機建築（Organic Architecture）」理論。他主張建築不應強加於自然之上，而應如植物般從土地中自然生長出來。建築材料應展現其本真本質（Nature of Materials），室內外空間應融為一體，強調水平延伸之「草原學派（Prairie School）」與懸臂樑空間組合。',
          steps: [
        ...
        },
        {
          ...
          body: 'Kenneth Frampton 於1983年提出「批判地域主義（Critical Regionalism）」，反對全球樣式（International Style）之冷漠同質化與文脈斷裂，同時反對盲目模仿傳統歷史符號。批判地域主義主張利用現代結構與施工技術，結合當地的光線、氣候、地形、風土材料與感知經驗，創造具備場所感之現代建築（如 Jørn Utzon、Alvar Aalto、Tadao Ando 安藤忠雄）。',
          steps: [
        ...
        },
        {
          ...
          body: 'Christian Norberg-Schulz 引入哲學現象學，發表《場所精神》（Genius Loci: Towards a Phenomenology of Architecture），主張建築不僅是幾何與機能，更是「場所（Place）」之締造。Juhani Pallasmaa 發表《皮膚的眼睛》（The Eyes of the Skin），批判當代建築過度傾於「視覺中心主義」，倡導結合觸覺、聲學、氣味與溫度之多感官身體體驗建築（如 Peter Zumthor 瓦爾斯溫泉浴室）。',
          steps: [
        ...
        },
        {
          ...
          body: '21世紀建築思潮呈現雙軌演進：一軌為「永續生態建築（Sustainable Architecture）」，強調碳足跡、零碳建築、綠建築評估與氣候韌性；另一軌為 Patrick Schumacher 宣稱之「參數主義（Parametricism）」，將所有建築要素（構造、光照、動線）設為可變參數，透過演算法生成連續流動之幾何造型。',
          steps: [
      ...
      concepts: [
        {
          ...
          body: '台灣依據《文化資產保存法》（文資法），將有形文化資產劃分為：古蹟（國定、直轄市定、縣市定）、歷史建築、紀念建築、聚落建築群、考古遺址、史蹟與文化景觀。主管機關經法定的指定或登錄審議程序後，給予法定身分與容積移轉（容積獎勵）補償，保護其不被非法拆除。',
          steps: [
        ...
        },
        {
          ...
          body: '國際古蹟遺址理事會（ICOMOS）於1964年頒布《威尼斯憲章》（Venice Charter），確立現代古蹟保存核心原則：真實性（Authenticity）、完整性（Integrity）、可辨識性（Recognizability）與可逆性（Reversibility）。新加構件必須可與歷史構件識別，且修復工法應可被拆除恢復原狀。1994年《奈良真實性文件》（Nara Document）則強調文化多樣性，承認東方木造建築定期的拆卸重組修復亦符合真實性。',
          steps: [
        ...
        },
        {
          ...
          body: '古蹟修復前必須進行嚴謹之「調查研究」與「修復設計」。調查包含文獻考證、傳統匠師口述歷史、3D雷射掃描現況測繪以及非破壞檢測（Non-Destructive Testing, NDT）。非破壞檢測利用超音波、抵抗波打擊穿透儀（Resistograph）檢測木構件內部腐朽，或利用紅外線熱影像儀檢測外牆剝落與壁癌水氣。',
          steps: [
        ...
        },
        {
          ...
          body: '傳統木構古蹟修復強調「抽樑換柱」與「榫卯修補」。當柱腳腐朽時，採用「筓補」或「墩接（柱腳接柱）」工法；大梁裂縫則採用「嵌入木條」與「碳纖維布（CFRP）」包覆加固。磚石古蹟修復則需採用傳統灰漿（生石灰、白華、糯米汁、烏糖水）進行填縫與砌築，嚴禁盲目使用高強度卜特蘭水泥，避免水泥硬化強壓破壞古磚。',
          steps: [
        ...
        },
        {
          ...
          body: '歷史建築活化再利用（Adaptive Reuse）旨在賦予舊建築現代機能（如文創園區、展覽館、圖書館），延續其生命力。設計上常採用「插入式結構（Box in a Box）」或「殘跡保存與玻璃帷幕增建」，使新舊結構獨立傳力，達到歷史紋理與現代機能之的和諧共生。',
          steps: [
        ...
        },
        {
          ...
          body: '台灣地處地震與颱風頻繁帶，古蹟結構補強與防災至關重要。耐震加固應隱蔽進行，如採用「微型樁基礎加固」、「隱蔽式鋼纜拉結（Tie-rod）」與「壁體黏貼碳纖維網」。防災方面需制定「古蹟整體防災計畫」，設置隱蔽式細水霧滅火系統與獨立火災警報器，避免水害或火災毀損古蹟。',
          steps: [
      ...
      concepts: [
        {
          ...
          body: '19世紀工業革命引發大規模鄉村人口湧入城市，造成人口過剩、貧民窟蔓延與霍亂傳染病肆虐。1850年代，法國拿破崙三世委任奧斯曼男爵（Baron Haussmann）推行巴黎大改造（Haussmannization）。劃破舊中世紀擁擠巷弄，闢建放射狀寬廣林蔭大道（Boulevards）、建立統一立面之幾何街廓住宅、劃設城市公園綠地，並導入現代下水道與瓦斯供氣網，奠定現代都市改造之範式。',
          steps: [
        ...
        },
        {
          ...
          body: '面對工業城市之惡劣環境，英國埃貝尼澤·霍華德（Ebenezer Howard）於1898年發表《明日：條條道路通往真正改革》（后改名《明日的花園城市》），提出「花園城市（Garden City）」理論。他設計著名的「三磁鐵（Three Magnets）」圖解，結合城鄉優點（城市之就業機會 + 鄉村之自然環境）。花園城市採圓形圈層規劃，中央為公園，外圍為住宅與產業區，最外圍由永久農藝綠帶（Greenbelt）環繞，土地歸社區公有，限制人口規模（約 32,000 人）。',
          steps: [
        ...
        },
        {
          ...
          body: '台灣現代都市計畫起源於日治初期之「市區改正」。1900年頒布《台北市區改正計畫》，拆除台北府城牆闢建三線路，引進正交棋盤式道路與公園圓環。1936年頒布《台灣都市計畫令》，導入土地使用分區管制（Zone）與風致地區概念。戰後1964年修正頒布《都市計畫法》，確立市鎮計畫、鄉街計畫與特定區計畫三大類別，規範建蔽率與容積率。',
          steps: [
        ...
        },
        {
          ...
          body: '隨著老舊城區建物老化，政府推動《都市更新條例》，採取重建、整建與維護三種方式。核心機制為「權利變換（Rights Exchange）」，如同立體土地重劃。原屋主提供土地與舊建物折價，更新實施者（開發商）負擔重建費用，更新後依據鑑價比例分配新建物與土地持份。都更過程中必須嚴格保障少數異議戶之居住權與個案爭議處置。',
          steps: [
        ...
        },
        {
          ...
          body: '面對高齡化與少子化雙重人口衝擊，都市空間需進行深層重構。推行「通用設計都市（Universal City）」與「15分鐘城市（15-Minute City）」，確保居民在步行或單車 15 分鐘距離內即可滿足購物、醫療、教育與休閒需求。同時，結合社會住宅推動「青銀共居（Intergenerational Housing）」社區，促進跨世代交流與互助。',
          steps: [
        ...
        },
        {
          ...
          body: '當代都市形貌正邁向「智慧與氣候韌性都市（Smart & Resilient City）」。結合 IoT物聯網感測器、BIM/GIS 數位雙生（Digital Twin）與大數據分析，即時監控都市水文、交通、空氣品質與能耗。面對極端氣候，都市設計採取「海綿城市（Sponge City）」策略，以自然解方（Nature-based Solutions, NbS）提升都市防洪韌性。',
          steps: [
