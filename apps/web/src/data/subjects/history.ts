      ...
      "worked_examples": [
        {
          ...
          "difficulty": "基礎",
          "steps": [
            "\"步驟 1：回顧客家移民歷史背景。清代台灣族群械鬥頻繁，客家聚落極注重防衛堡壘化。\", \"步驟 2：識別建築防衛構件。外牆開口極小，外寬內窄，稱為「銃眼（槍孔）」。\", \"步驟 3：總結功能。防範盜匪入侵，同時可由內部向外觀察與架槍射擊。\" ｜為什麼：依據歷史核心脈絡與法理/空間邏輯推理。"
          ],
      ...
      "worked_examples": [
        {
          ...
          "difficulty": "中等",
          "steps": [
            "\"步驟 1：理解「材」的定義。「材」為斗拱拱截面之高與厚，以此作為整座建築構件比例之模數 (Module)。\", \"步驟 2：分析材份制的作用。根據建築等級選擇材等，所有梁柱斗拱之尺寸均為「材」的倍數（分）。\", \"步驟 3：總結歷史意義。實現了中國古代木結構建築之模數化、標準化與預製化設計。\" ｜為什麼：依據歷史核心脈絡與法理/空間邏輯推理。"
          ],
      ...
      "worked_examples": [
        {
          ...
          "difficulty": "基礎",
          "steps": [
            "\"步驟 1：對比羅馬式建築。羅馬式採用半圓拱與厚重牆體，開窗極小。\", \"步驟 2：識別哥德式結構突破。1. 尖拱 (Pointed Arch) 減少側向推力；2. 飛扶壁 (Flying Buttress) 將穹頂側推力引導至室外獨立墩柱。\", \"步驟 3：得出結論。尖拱與飛扶壁。\" ｜為什麼：依據歷史核心脈絡與法理/空間邏輯推理。"
          ],
      ...
      "worked_examples": [
        {
          ...
          "difficulty": "基礎",
          "steps": [
            "\"步驟 1：回顧新建築五點英文與中文名稱：1. Pilotis (底層架空柱), 2. Roof Garden (屋頂花園), 3. Free Plan (自由平面), 4. Free Facade (自由立面)。\", \"步驟 2：識別第五點。Ribbon Window / Horizontal Window（橫向帶狀長窗）。\", \"步驟 3：分析帶狀長窗力學前提。得益於 RC 框架結構，牆體不再承重，故可開全橫向長窗採光。\" ｜為什麼：依據歷史核心脈絡與法理/空間邏輯推理。"
          ],
      ...
      "worked_examples": [
        {
          ...
          "difficulty": "中等",
          "steps": [
            "\"步驟 1：瞭解文化資產保存核心哲學。強調「真實性 (Authenticity)」與「可逆性 (Reversibility)」。\", \"步驟 2：規範新舊構件識別。新添加之補強構件應與古蹟原物「可識別（不可偽造古貌）」，且未來可安全拆卸（可逆性）。\", \"步驟 3：總結原則。遵循「最小干預、可識別性與可逆性原則」。\" ｜為什麼：依據歷史核心脈絡與法理/空間邏輯推理。"
          ],
      ...
      "worked_examples": [
        {
          ...
          "difficulty": "基礎",
          "steps": [
            "\"步驟 1：分析水晶宮設計者與材料。由約瑟夫·帕克斯頓 (Joseph Paxton) 設計，大量採用鑄鐵 (Cast Iron) 與玻璃。\", \"步驟 2：解析施工工法。採用工廠預製構件（Pre-fabrication），現場快速組裝（Dry Assembly）。\", \"步驟 3：總結建築史意義。開啟了預製構件與鐵骨玻璃預製建築之新時代。\" ｜為什麼：依據歷史核心脈絡與法理/空間邏輯推理。"
          ],
