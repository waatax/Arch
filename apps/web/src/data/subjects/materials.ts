...
export const materialsData: SubjectData = {
  ...
  "topics": [
      ...
      "concepts": [
        {
          ...
          "table": {
            ...
            "rows": [
              [
                "生態綠建材 (Ecological)",
                "採用天然竹木、天然石材或無匱乏危機之可再生資源",
                "減少加工能耗、無化學防腐劑二次污染",
                "無毒未防腐台灣杉、竹材地磚、天然軟木"
              ],
              [
                "健康綠建材 (Healthy)",
                "經小型釋放腔檢測，控制室內化學污染物揮發速率",
                "TVOC ≤ 0.19 mg/(m²·h)、甲醛 HCHO ≤ 0.05 mg/(m²·h)",
                "低逸散水性乳膠漆、綠建材合板、無石棉矽酸鈣板"
              ],
              [
                "高性能綠建材 (High Performance)",
                "具備防音隔熱、降低噪音能耗或提升基地透水之機能",
                "隔音 Rw ≥ 45dB、樓板衝擊音 ΔLw ≥ 17dB、透水係數 0.01 cm/s",
                "節能 Low-E 複層中空玻璃、透水高壓混凝土磚、隔音吸音棉"
              ],
              [
                "再生綠建材 (Recycled)",
                "利用營建廢棄物或工廠副產物回收製造，促進循環經濟",
                "再生材料重量摻配率達到法定標準 (通常 ≥ 30%~50%)",
                "高爐水泥 (GGBS)、飛灰磚、高壓再生透水磚、再生木屑板"
              ]
            ]
          }
        },
    ...
    },
    {
      ...
      "step0Prerequisites": [
        "材料質量與體積基本物理量測方法",
        "阿基米德浮力原理與排液法 (Archimedes Principle)",
        "有效數字運算與 CNS 單位制"
      ],
      "fatalTraps": [
        {
          "wrongThinking": "混淆材料的「真密度」、「外觀體積密度」與「堆積密度」，代入錯誤體積。",
          "correctThinking": "真密度只計實體骨架體積（扣除所有孔隙）；外觀體積密度計入內部孔隙；堆積密度額外計入顆粒間空隙。",
          "trapDescription": "計算孔隙率時若將堆積體積或外觀體積混淆，將導致孔隙率超過 100% 或得出荒謬負值。"
        }
      ],
      "eliteMentalModels": [
        {
          "technique": "材料三相比例質量體積模型",
          "explanation": "將材料抽象化為固體骨架、內部封閉/連通孔隙、外部水分三相體積；畫出三相方塊圖即可直觀導出真密度、體積密度、吸水率與孔隙率。"
        }
      ],
      "covered_question_ids": [
        "111-1-23",
    ...
    },
    {
      ...
      "examHitRate": 4,
      "step0Prerequisites": [
        "高溫鍛燒石灰石與黏土化學反應 (CaCO3 -> CaO + CO2)",
        "無機鹽類結晶水化熱熱力學基本概念"
      ],
      "fatalTraps": [
        {
          "wrongThinking": "以為矽酸三鈣 (C3S) 與矽酸二鈣 (C2S) 的水化速度相同，兩者皆負責早期強度。",
          "correctThinking": "C3S 反應快且水化熱高，提供 1~7 天早期強度；C2S 反應慢且熱量低，負責 28 天至數年的長期穩定增長。",
          "trapDescription": "工程現場需要早拆模時若誤用高 C2S 水泥，將引發早期強度不足之嚴重坍塌風險。"
        }
      ],
      "eliteMentalModels": [
        {
          "technique": "熟料四大成分活性演化模型",
          "explanation": "C3S-衝鋒早強、C2S-續航後強、C3A-暴躁高熱快凝、C4AF-平穩調和耐硫，快速鎖定反應速率與放熱順序。"
        }
      ],
      "covered_question_ids": [],
      "worked_examples": [
      ...
      "concepts": [
        {
          ...
          "diagram": {
            "title": "水泥熟料四大化合物水化強度演變與水化放熱對比圖",
            "caption": "C3S (早期強度 1~7天)、C2S (長期強度 28天~1年)、C3A (高熱快凝閃凝)",
            "svg": "<svg viewBox='0 0 540 180' className='w-full h-auto' fill='none' xmlns='http://www.w3.org/2000/svg'><line x1='50' y1='140' x2='480' y2='140' stroke='#64748b' stroke-width='1.5'/><line x1='50' y1='140' x2='50' y2='20' stroke='#64748b' stroke-width='1.5'/><text x='485' y='144' fill='#475569' font-size='9' font-family='monospace'>時間 (天/月)</text><text x='50' y='14' fill='#475569' font-size='9' font-family='monospace'>強度/水化度</text><path d='M 50 140 Q 90 40 180 50 T 450 45' stroke='#f43f5e' stroke-width='2.5' fill='none'/><text x='190' y='42' fill='#e11d48' font-size='9' font-family='monospace' font-weight='bold'>C3S (早強主幹 1~28天)</text><path d='M 50 140 Q 150 135 250 80 T 450 35' stroke='#3b82f6' stroke-width='2.5' fill='none'/><text x='380' y='32' fill='#1d4ed8' font-size='9' font-family='monospace' font-weight='bold'>C2S (後強續航 28天~1年)</text><path d='M 50 140 Q 65 30 90 90 T 150 130' stroke='#f59e0b' stroke-width='2' stroke-dasharray='3 2' fill='none'/><text x='95' y='65' fill='#d97706' font-size='8' font-family='monospace' font-weight='bold'>C3A (暴衝高熱/易閃凝)</text><line x1='180' y1='20' x2='180' y2='140' stroke='#94a3b8' stroke-width='1' stroke-dasharray='2 2'/><text x='180' y='155' fill='#64748b' font-size='9' font-family='monospace' text-anchor='middle'>28 天標準齡期</text></svg>"
          }
        },
        {
          "heading": "**水化熱**與體積變化控制",
    ...
    },
    {
      ...
      "examHitRate": 4,
      "step0Prerequisites": [
        "CNS 61 卜特蘭水泥五大類型分類基準",
        "大壩巨積工程與沿海水港工程環境差異"
      ],
      "fatalTraps": [
        {
          "wrongThinking": "在大型水壩或大體積筏基工程中選用第 III 型早強水泥以加快工期。",
          "correctThinking": "巨積工程嚴禁使用第 III 型水泥！其劇烈水化熱會使中心溫度破 70°C，內外溫差超標造成嚴重貫穿裂縫；應選第 IV 型低熱水泥或第 II 型中熱水泥。",
          "trapDescription": "忽略巨積混凝土的水化溫升效應，誤把搶工期的早強水泥用於大斷面結構。"
        }
      ],
      "eliteMentalModels": [
        {
          "technique": "工程環境逆向水泥選用模型",
          "explanation": "巨積選 IV 型低熱、海港選 V 型抗硫、寒冬緊急搶工選 III 型早強、中度硫酸鹽地下選 II 型、一般建築選 I 型。"
        }
      ],
      "covered_question_ids": [
        "111-1-22",
    ...
    },
    {
      ...
      "step0Prerequisites": [
        "CNS 788 水泥膏標準稠度檢驗方法",
        "維卡儀 (Vicat) 試針與試桿規格 (10mm 稠度桿 vs 1mm 初凝針)"
      ],
      "fatalTraps": [
        {
          "wrongThinking": "進行維卡儀初凝試驗前，未先完成標準稠度加水量檢定，隨意加水拌合。",
          "correctThinking": "初凝與終凝時間試驗必須「嚴格採用標準稠度用水量」製成之水泥膏，水加太多會假性延緩凝結，水太少則提早凝結。",
          "trapDescription": "違反 CNS 試驗標準流程，導致凝結時間測定結果無可比性與法律效力。"
        }
      ],
      "eliteMentalModels": [
        {
          "technique": "水化膠體毛細凝結連續態模型",
          "explanation": "C-S-H 晶針逐漸搭接阻礙試針下沉：試針沉至底板上方 25mm 處為初凝 (>= 45min)，完全不下沉 (針端環形附件無印痕) 為終凝 (<= 375min)。"
        }
      ],
      "covered_question_ids": [
        "111-1-29",
      ...
      "concepts": [
        {
          ...
          "table": {
            ...
            "rows": [
              [
                "標準稠度水膏 (CNS 788)",
                "10 mm 直徑柱狀試針，放鬆 30 秒",
                "沉入停於底板上方 10 ± 1 mm 處",
                "凝結時間之前置預備試驗，精確決定標準加水量"
              ],
              [
                "初凝時間測定 (CNS 786)",
                "1 mm 直徑平頭試針，每隔 15 分鐘測定",
                "針頭停於底板上方 25 mm 處 (加水起算)",
                "Type I 需 ≥ 45 分鐘，確保混凝土運輸與澆置工作性"
              ],
              [
                "終凝時間測定 (CNS 786)",
                "1 mm 帶環針頭 (環狀金屬附件)",
                "針痕可見但環狀附件不再留下圓形印痕",
                "Type I 需 ≤ 375 分鐘 (約 6.25h)，確保如期拆模硬化"
              ],
              [
                "工地超時處置 SOP",
                "預拌混凝土車因塞車超過初凝時間",
                "嚴禁工地現場二次加水強行拌合澆置",
                "破壞 C-S-H 水化晶網，水灰比暴增使抗壓強度暴跌 >50% 退貨"
              ]
            ]
          },
          "steps": [
    ...
    },
    {
      ...
      "examHitRate": 4,
      "step0Prerequisites": [
        "CNS 1010 水泥水化熱與砂漿抗壓試驗規範",
        "50mm (2 inch) 立方體試模組裝與油壓試驗機操作"
      ],
      "fatalTraps": [
        {
          "wrongThinking": "誤以為水泥砂漿抗壓強度試體是採用 15×30 cm 圓柱試體。",
          "correctThinking": "混凝土抗壓試體標準為 15×30 cm 圓柱體；而水泥砂漿 (Mortar) 抗壓強度依 CNS 1010 採用 50×50×50 mm 立方體試體。",
          "trapDescription": "混淆混凝土試體（圓柱體）與水泥砂漿試體（立方體）的幾何形狀與受壓面積計算公式。"
        }
      ],
      "eliteMentalModels": [
        {
          "technique": "水灰比強度雙曲線法則 (Abrams Law)",
          "explanation": "強度主要由水灰比決定：每立方公尺拌合水量愈少、毛細孔愈緻密、強度愈高；超出反應所需的水分蒸發後全轉化為有害孔隙。"
        }
      ],
      "covered_question_ids": [
        "111-1-26",
      ...
      "concepts": [
        {
          ...
          "table": {
            ...
            "rows": [
              [
                "標準試體規格",
                "50 mm × 50 mm × 50 mm (5 cm 立方體)",
                "受壓截面積 A = 2500 mm² = 25 cm²",
                "注意：混凝土試體為 15×30 cm 圓柱體，砂漿為 5 cm 立方體"
              ],
              [
                "標準配比基準",
                "水泥 : 標準渥太華砂 = 1 : 2.75",
                "固定水灰比 W/C = 0.485 (卜特蘭水泥)",
                "使用標準砂可排除骨材變異，純粹評估水泥膠體強度發展"
              ],
              [
                "鑄造與標準養護",
                "分 2 層每層搗實 32 次；24h 拆模",
                "23 ± 2°C 飽和石灰水槽中養護至規定齡期",
                "標準養護齡期：3 天、7 天、28 天"
              ],
              [
                "抗壓加載與強度換算",
                "加壓速率 900 ~ 1800 N/s 連續無衝擊",
                "f_c = P_max / A (1 N/mm² = 1 MPa)",
                "單位換算必考：若破壞載重 75 kN = 75000 N，f_c = 75000/2500 = 30 MPa"
              ]
            ]
          },
          "steps": [
    ...
    },
    {
      ...
      "step0Prerequisites": [
        "水泥吸濕硬化物理特性",
        "工地倉庫防潮地坪架高 (30cm) 與庫存先進先出管理"
      ],
      "fatalTraps": [
        {
          "wrongThinking": "遇到水泥假凝 (False Set) 現象時，直接加入大量拌合水稀釋。",
          "correctThinking": "假凝是石膏高溫脫水結晶所致之物理假象，並未真正釋放水化熱；只需經劇烈二次攪拌即可破壞弱晶網恢復塑性，嚴禁加水（加水會劇烈提高水灰比並削弱 50% 強度）。",
          "trapDescription": "將假凝 (False Set) 誤判為快凝 (Flash Set)，以加水手段破壞混凝土力學品質。"
        }
      ],
      "eliteMentalModels": [
        {
          "technique": "氣硬還原與假凝晶體解離模型",
          "explanation": "假凝為弱晶網、不放熱、攪拌可解；快凝為 C3A 劇烈放熱、不可逆。分辨兩者以決定攪拌或報廢。"
        }
      ],
      "covered_question_ids": [],
      "worked_examples": [
    ...
    },
    {
      ...
      "examHitRate": 4,
      "step0Prerequisites": [
        "骨材篩分析與最大粒徑、細度模數 (F.M.) 定義",
        "混凝土坍度試驗 (Slump Test) 與圓柱試體抗壓試驗流程"
      ],
      "fatalTraps": [
        {
          "wrongThinking": "工地現場發現坍度不足、泵送困難時，現場直接加水 (Retempering) 調稀。",
          "correctThinking": "工地現場絕對嚴禁任意加水！增加水量會直接破壞設計水灰比 (W/C)，導致強度暴跌、乾縮裂縫暴增；若需增加流動性，應使用合格高性能減水劑 (強塑劑)。",
          "trapDescription": "違反工程查核第一大天條，任意加水導致結構抗壓強度未達設計強度。"
        }
      ],
      "eliteMentalModels": [
        {
          "technique": "骨材堆疊骨架與水泥漿包裹填充模型",
          "explanation": "粗細骨材緊密堆疊形成骨架，水泥漿填滿骨架間隙並提供流動潤滑；級配越連續，空隙越少，所需水泥漿越節省、收縮裂縫越小。"
        }
      ],
      "covered_question_ids": [
        "111-1-38",
    ...
    },
    {
      ...
      "examHitRate": 4,
      "step0Prerequisites": [
        "火成岩、沉積岩、變質岩三大岩類礦物硬度與耐候性",
        "陶瓷磚吸水率分級 (CNS 3299) 與安全玻璃加工規範"
      ],
      "fatalTraps": [
        {
          "wrongThinking": "在大理石 (變質岩) 外牆乾掛工程中，使用未經耐酸保護的大理石於酸雨嚴重之工業區。",
          "correctThinking": "大理石主成分為碳酸鈣 (CaCO3)，極易受酸雨侵蝕失光起粉；室外及高污染環境應優先採用抗酸耐磨的花崗岩 (火成岩)。",
          "trapDescription": "忽略大理石易受酸侵蝕之化學特性，造成外牆飾面嚴重風化褪色。"
        }
      ],
      "eliteMentalModels": [
        {
          "technique": "無機非金屬材料晶體緻密性矩陣",
          "explanation": "花崗岩緻密耐酸抗凍；陶質磚多孔吸水適合室內；強化玻璃表面具高壓應力層，自爆風險需藉熱浸處理 (HST) 排除。"
        }
      ],
      "covered_question_ids": [
        "112-1-25",
    ...
    },
    {
      ...
      "step0Prerequisites": [
        "木材年輪（春材/夏材）、心材與邊材構造",
        "纖維飽和點 (Fiber Saturation Point, FSP ~30%) 定義"
      ],
      "fatalTraps": [
        {
          "wrongThinking": "認為生木自砍伐起（含水率從 100% 降至 40% 時）就開始發生體積乾縮變形。",
          "correctThinking": "木材自由水蒸發（含水率 > 30%）時體積「完全不變」；只有當含水率降至纖維飽和點 (FSP ~30%) 以下、細胞壁結合水開始散失時，木材才會劇烈乾縮！",
          "trapDescription": "誤以為自由水散失會引發尺寸縮小，混淆自由水與結合水的作用分界點。"
        }
      ],
      "eliteMentalModels": [
        {
          "technique": "木材管胞水分三態與異向性模型",
          "explanation": "含水率 > 30% 尺寸不變；< 30% 乾縮啟動。乾縮異向性順序：弦向 (最大，約徑向2倍) > 徑向 > 縱向 (沿木理最小，幾乎忽略)。"
        }
      ],
      "covered_question_ids": [
        "111-1-25",
    ...
    },
    {
      ...
      "examHitRate": 4,
      "step0Prerequisites": [
        "高分子熱塑性 (Thermoplastic) 與熱固性 (Thermosetting) 分子鏈差異",
        "瀝青針入度 (Penetration)、軟化點與延性三大指標"
      ],
      "fatalTraps": [
        {
          "wrongThinking": "高溫酷暑地區路面選用針入度數值很大的軟質瀝青。",
          "correctThinking": "針入度數值越大表示瀝青越軟；炎熱氣候區路面受高溫易車轍變形，應選用針入度較小、軟化點較高的「硬質瀝青」；寒冷地區方選較軟瀝青防低溫脆裂。",
          "trapDescription": "混淆針入度數值大小與瀝青軟硬、耐溫性的反比關係。"
        }
      ],
      "eliteMentalModels": [
        {
          "technique": "高分子交聯網與瀝青感溫流變模型",
          "explanation": "線型分子受熱軟化可塑（熱塑性 PE/PVC）；立體網狀分子受熱不熔炭化（熱固性環氧樹脂/酚醛樹脂）。瀝青具溫度敏感性，依季節氣候選配黏稠度。"
        }
      ],
      "covered_question_ids": [
        "111-1-30",
    ...
    },
    {
      ...
      "examHitRate": 4,
      "step0Prerequisites": [
        "碳鋼含碳量 (0.02% ~ 2.14%) 對強度、延性與可焊性之影響",
        "低碳鋼標準單軸拉伸應力-應變曲線（彈性區、降伏平台、硬化區、頸縮）"
      ],
      "fatalTraps": [
        {
          "wrongThinking": "為了追求最高抗拉強度，在抗震建築結構梁柱鋼材中盲目增加含碳量至高碳鋼。",
          "correctThinking": "鋼材含碳量愈高雖然強度提升，但延性、衝擊韌性與「可焊性」會急遽惡化，且易發生致命的低應力脆性斷裂；耐震鋼結構必須選用低碳或微合金鋼（如 SN 建築結構用鋼），確保高延展吸收地震能量。",
          "trapDescription": "誤將「高強度」等同於「耐震安全性」，忽略延性與韌性才是防倒塌關鍵。"
        }
      ],
      "eliteMentalModels": [
        {
          "technique": "金屬晶格滑移與電化學腐蝕電池模型",
          "explanation": "降伏平台為晶格位錯滑移，提供變形吸能裕度；電位序中鋅 (-0.76V) 比鐵 (-0.44V) 活潑，鍍鋅層破裂時鋅充當陽極犧牲，保護內部鐵骨架。"
        }
      ],
      "covered_question_ids": [
        "111-1-21",
    ...
    },
    {
      ...
      "step0Prerequisites": [
        "內政部建築研究所綠建材標章評定機制",
        "健康綠建材 TVOC 與甲醛逸散率門檻、綠建材使用率法規計算"
      ],
      "fatalTraps": [
        {
          "wrongThinking": "室內裝修只要採購的單項板材皆取得健康綠建材標章，完工後密閉空間空氣品質就絕對安全合格。",
          "correctThinking": "單項材料逸散率達標不代表累積總量安全！大面積鋪設複數建材會產生「容積負荷疊加效應」；施工完成後必須強制通風換氣 72 小時以上（烘房 flush-out），排除殘留揮發性有機物。",
          "trapDescription": "忽略室內密閉空間容積疊加效應，誤以為取得綠建材標章即可免除通風換氣程序。"
        }
      ],
      "eliteMentalModels": [
        {
          "technique": "室內空氣品質 IAQ 與建材逸散通風疊加模型",
          "explanation": "逸散率 × 鋪設面積 × 時間 = 空間污染累積量。控制裝修總量、結合強制連續機械通風，才能徹底達成綠色健康居住環境。"
        }
      ],
      "covered_question_ids": [
        "111-1-37",
