...
export const materialsData: SubjectData = {
  ...
  topics: [
    ...
    },
    {
      slug: 'cement',
      title: '2. 水泥材料與性質試驗',
      desc: '卜特蘭水泥水化反應機制 (C3S, C2S, C3A, C4AF)、CNS 61 五大類水泥、維卡儀凝結時間試驗、水泥砂漿抗壓強度試驗與石膏閃凝控制。',
      status: 'done',
      concepts: [
        {
          heading: '卜特蘭水泥水化化學成分 (Mineral Compositions)',
          body: '水泥熟料經高溫 1450°C 燒結而成，主要四大部分為：矽酸三鈣 (C3S，水化快，提供早期強度)、矽酸二鈣 (C2S，水化慢，提供後期強度)、鋁酸三鈣 (C3A，水化極快，釋放高水化熱)、鐵鋁酸四鈣 (C4AF，提供抗硫與抗腐蝕能力)。石膏 (CaSO₄·2H₂O) 之添加旨在調節 C3A 之反應，避免發生「閃凝 (Flash Set)」。',
          table: {
        ...
        },
        {
          ...
          body: '中華民國國家標準 CNS 61 劃分之五種基本卜特蘭水泥特性與應用。',
          table: {
        ...
        },
        {
          ...
          body: '測定水泥水化過程初凝 (Initial Set) 與終凝 (Final Set) 時間之國家標準步驟。',
          steps: [
        ...
        },
        {
          ...
          body: '評估水泥品質之標準砂漿試體 (5 × 5 × 5 cm 立方體) 製作與壓碎測試。',
          steps: [
            '配比拌合：水泥與標準砂 (Standard Ottawa Sand) 重量比為 1 : 2.75，水灰比 W/C = 0.485。',
        ...
        {
          heading: '水泥包裝、儲存與假凝 (False Set) 現象',
          body: '水泥包裝每袋標準重量為 50 kg。現場儲存需墊高離地 30 cm 以上，堆疊高度不宜超過 10 包以防壓結。「假凝」係因水泥研磨時溫度過高導致石膏脫水形成半水石膏，加水後快速再結晶產生假硬化，稍加拌合即可恢復塑性，與真正的「閃凝」有本質區別。'
        }
      ],
      practices: [
        {
        ...
        {
          difficulty: '進階',
          question: '某港灣工程需打設深海碼頭鋼管樁外包混凝土，且工程位於高鹽鹼土壤區。試解答：\n(1) 應優先選用 CNS 61 何種水泥？其化學成分有何特別限制？\n(2) 進行 CNS 1010 水泥砂漿試驗時，試體尺寸與水泥對標準砂之重量比為何？若 28 天破壞載重 P = 100 kN，其抗壓強度為多少 MPa？',
          steps: [
            '(1) 應選用 Type V (高抗硫水泥)，化學成分特別限制鋁酸三鈣 C3A ≤ 5%，以防硫酸鹽化學侵蝕膨脹破壞。',
            '(2) 試驗規格與強度計算：',
            '試體尺寸為 5 × 5 × 5 cm (50 × 50 × 50 mm) 立方體；水泥 : 標準砂 = 1 : 2.75。',
            '試體受壓面積 A = 50 mm × 50 mm = 2,500 mm²。',
            '抗壓強度 fc = P / A = 100,000 N / 2,500 mm² = 40 MPa。'
          ],
          answer: '(1) Type V 高抗硫水泥，限制 C3A ≤ 5%；(2) 試體 5×5×5 cm，重量比 1:2.75，抗壓強度 = 40 MPa。'
        }
      ]
    },
    {
