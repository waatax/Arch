    ...
    >
        ...
        <div className="flex flex-col">
          ...
          <div className="flex gap-2 mt-1">
            <button 
              ...
              className="p-1.5 rounded-full bg-slate-100 hover:bg-slate-200 dark:bg-slate-800 dark:hover:bg-slate-700 transition-colors text-slate-600 dark:text-slate-300 active:scale-90"
            ...
            <button 
              ...
              className="text-xs font-medium px-2 py-1 rounded-full bg-slate-100 hover:bg-slate-200 dark:bg-slate-800 dark:hover:bg-slate-700 transition-colors text-slate-600 dark:text-slate-300 ml-2 active:scale-95"
      ...
      <GlassCard className="flex items-center gap-2 border-emerald-500/40 px-2.5 py-2 shadow-lg sm:hidden">
        <button 
          ...
          className="flex size-9 items-center justify-center rounded-full bg-emerald-600 text-white active:scale-90 transition-transform" 
          aria-label={isActive ? '暫停番茄鐘' : '開始番茄鐘'}
        >
        ...
        <button 
          ...
          className="flex size-8 items-center justify-center rounded-full text-slate-500 hover:bg-slate-100 dark:hover:bg-slate-800 active:scale-90 transition-transform" 
          aria-label="重設番茄鐘"
        >
          <RotateCcw size={14} />
        </button>
