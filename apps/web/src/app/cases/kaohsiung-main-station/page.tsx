...
export default function KaohsiungStationPage() {
  return <CaseStudyPage
    hero={{ title: '高雄車站新站', location: '高雄市三民區', architect: 'Mecanoo', year: '2025 年新風貌亮相', category: '交通建築與城市縫合', question: '一座地下車站如何把曾被鐵路切開的城市重新縫合？', description: '高雄車站以大型無柱雲朵天棚、下沉式廣場與屋頂綠之丘整合臺鐵、捷運與地面城市空間，將交通設施轉化為可停留的城市地景。' }}
