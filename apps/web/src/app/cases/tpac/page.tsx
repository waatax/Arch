...
export default function TpacPage() {
  return <CaseStudyPage
    hero={{ title: '臺北表演藝術中心', location: '台北市士林區', architect: 'OMA／Rem Koolhaas + David Gianotten', year: '2022 年開幕', category: '空間組合與動線', question: '三座劇場如何獨立運作，又能合併成超級大劇場？', description: '北藝中心把三個形狀各異的劇場插入中央舞台立方體，共享後台製作核心；外部公共迴路則讓沒有買票的人也能看見劇場如何運作。', imageSrc: `${process.env.NEXT_PUBLIC_BASE_PATH ?? ''}/cases/tpac/hero-v2.webp`, imageAlt: '臺北表演藝術中心中央方盒、球形劇場與兩側劇場量體的建築主視覺' }}
