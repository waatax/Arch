...
export default function BeitouLibraryPage() {
  return <CaseStudyPage
    hero={{ title: '臺北市立圖書館北投分館', location: '台北市北投區', architect: '九典聯合建築師事務所', year: '2006 年開館', category: '木構造與綠建築', question: '木格柵、深陽台與綠屋頂如何一起降低環境負荷？', description: '北投分館以木構表情、層層退縮的陽台、深遮陽與雨水回收回應公園微氣候，將綠建築策略直接變成可閱讀的立面。', imageSrc: `${process.env.NEXT_PUBLIC_BASE_PATH ?? ''}/cases/beitou-library/hero-v2.webp`, imageAlt: '北投分館臨水木構立面、深陽台、水平格柵與綠屋頂的建築主視覺' }}
