...
export default function Taipei101Page() {
  return <CaseStudyPage
    hero={{ title: '台北 101', location: '台北市信義區', architect: '李祖原聯合建築師事務所', year: '2004 年完工', category: '風與結構 · 超高層建築', question: '508 公尺高樓如何同時抵抗颱風與地震？', description: '台北 101 以巨型柱、核心筒、外伸桁架與調諧質量阻尼器共同工作，是理解超高層建築側向力控制的代表案例。' }}
