...
const checks = [
  ...
  ['version check', (goals.includes('版本 V7.3') || goals.includes('版本 V8.01') || goals.includes('版本 V8.02') || goals.includes('版本 V9.00')) && (nav.includes('V7.3') || nav.includes('V8.01') || nav.includes('V8.02') || nav.includes('V9.00')) && (footer.includes('V7.3') || footer.includes('V8.01') || footer.includes('V8.02') || footer.includes('V9.00'))],
